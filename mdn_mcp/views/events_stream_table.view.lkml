...
view: events_stream_table {
  ...
  dimension: extras__quantity__result_count {
    sql: ${TABLE}.extras.quantity.result_count ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Extras: Quantity"
    group_item_label: "Result Count"
  }

  dimension: extras__quantity__top_score {
    sql: ${TABLE}.extras.quantity.top_score ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Extras: Quantity"
    group_item_label: "Top Score"
  }
  ...
  dimension: extras__string__key {
    sql: ${TABLE}.extras.string.key ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
  ...
  dimension: extras__string__tool {
    sql: ${TABLE}.extras.string.tool ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
    group_item_label: "Tool"
  }

  dimension: extras__string__top_path {
    sql: ${TABLE}.extras.string.top_path ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
    group_item_label: "Top Path"
  }
  ...
  dimension: extras__string__user_agent {
    sql: ${TABLE}.extras.string.user_agent ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
  ...
  sql_table_name: `mozdata.mdn_mcp.events_stream` ;;
}