...
view: regret_details_table {
  ...
  dimension: metrics__string__regret_details_page_view_id {
    sql: ${TABLE}.metrics.string.regret_details_page_view_id ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Regret Details Page View ID"
  }

  dimension: metrics__string__regret_details_regret_id {
    sql: ${TABLE}.metrics.string.regret_details_regret_id ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Regret Details Regret ID"
  }
  ...
  dimension: metrics__string__regret_details_video_data_id {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Regret Details Video Data ID"
  }

  dimension: metrics__text__regret_details_feedback_text {
    sql: ${TABLE}.metrics.text.regret_details_feedback_text ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Text"
    group_item_label: "Regret Details Feedback Text"
  }
  ...
  sql_table_name: `mozdata.viu_politica.regret_details` ;;
}

view: regret_details_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: regret_details_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: regret_details_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: regret_details_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: regret_details_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
