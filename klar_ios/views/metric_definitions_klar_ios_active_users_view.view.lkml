...
view: metric_definitions_klar_ios_active_users_view {
  derived_table: {
    sql: SELECT
                COUNTIF(is_dau) AS client_level_daily_active_users_v1,
...
looker_base_fields.user_agent.version AS looker_base_fields_user_agent__version,
  ...
  FROM
    ...
    ON 
    klar_ios_active_users_view.client_id =
        looker_base_fields.client_id AND
        klar_ios_active_users_view.submission_date =
...
looker_base_fields_user_agent__version,
  ...
  dimension: client_level_daily_active_users_v1 {
    group_label: "Metrics"
    label: "Klar iOS Client-Level DAU"
...
"
  ...
  set: metrics {
    fields: [client_level_daily_active_users_v1]
  }
