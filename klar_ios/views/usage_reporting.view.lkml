...
view: usage_reporting {
  dimension: metrics__uuid__usage_profile_id {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/klar_ios/metrics/usage_profile_id"
...
"
  ...
  sql_table_name: `mozdata.org_mozilla_ios_klar.usage_reporting` ;;
}
...
view: suggest__usage_reporting__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.org_mozilla_ios_klar.usage_reporting as t,
