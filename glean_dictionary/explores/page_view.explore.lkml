...
include: "/looker-hub/glean_dictionary/views/page_view.view.lkml"

explore: page_view {
  sql_always_where: ${page_view.submission_date} >= '2010-01-01' ;;
  view_label: " Page_View"
  description: "Explore for the page_view ping. A ping that will be sent everytime a new page is visited."
  view_name: page_view
