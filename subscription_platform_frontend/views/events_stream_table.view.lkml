...
view: events_stream_table {
  ...
  dimension: extras__string__eligibility_status {
    sql: ${TABLE}.extras.string.eligibility_status ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
    group_item_label: "Eligibility Status"
  }
  ...
  dimension: extras__string__interval {
    sql: ${TABLE}.extras.string.interval ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
  ...
  dimension: extras__string__offering_id {
    sql: ${TABLE}.extras.string.offering_id ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
    group_item_label: "Offering ID"
  }
  ...
  dimension: extras__string__page_name {
    sql: ${TABLE}.extras.string.page_name ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
  ...
  sql_table_name: `mozdata.subscription_platform_frontend.events_stream` ;;
}