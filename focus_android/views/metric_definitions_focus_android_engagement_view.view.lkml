...
focus_android_engagement_view_first_seen,
...
focus_android_engagement_view.first_seen_date AS focus_android_engagement_view_first_seen,
...
"
  ...
  dimension_group: first_seen {
    sql: ${TABLE}.focus_android_engagement_view_first_seen ;;
    type: time
    suggest_persist_for: "24 hours"
    timeframes: [
      raw,
