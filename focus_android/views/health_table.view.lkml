...
view: health_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.focus_android.health"

    allowed_value: {
      label: "Release"
      value: "mozdata.focus_android.health"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_focus_beta.health"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_focus_nightly.health"
    }
  }
