...
view: use_counters_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.focus_android.use_counters"

    allowed_value: {
      label: "Release"
      value: "mozdata.focus_android.use_counters"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_focus_beta.use_counters"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_focus_nightly.use_counters"
    }
  }
