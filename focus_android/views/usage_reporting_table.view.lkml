...
view: usage_reporting_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.focus_android.usage_reporting"

    allowed_value: {
      label: "Release"
      value: "mozdata.focus_android.usage_reporting"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_focus_beta.usage_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_focus_nightly.usage_reporting"
    }
  }
