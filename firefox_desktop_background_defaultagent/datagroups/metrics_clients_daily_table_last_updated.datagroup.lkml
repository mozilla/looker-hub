...
datagroup: metrics_clients_daily_table_last_updated {
  ...
  description: "Updates for metrics_clients_daily_table when moz-fx-data-shared-prod.firefox_desktop_background_defaultagent_derived.metrics_clients_daily_v1 is modified."
