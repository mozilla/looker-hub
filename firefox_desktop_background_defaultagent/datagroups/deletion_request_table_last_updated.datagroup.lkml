...
datagroup: deletion_request_table_last_updated {
  ...
  description: "Updates for deletion_request_table when moz-fx-data-shared-prod.firefox_desktop_background_defaultagent_stable.deletion_request_v1 is modified."
