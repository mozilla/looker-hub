...
"
  ...
  dimension_group: metrics__datetime__provider_request_request {
    ...
    description: "The UTC timestamp of the request to the ad provider. Should not be null."
  }
  ...
  dimension_group: metrics__datetime__provider_request_response {
    ...
    description: "The UTC timestamp of the response from the ad provider. Should not be null."
  }
