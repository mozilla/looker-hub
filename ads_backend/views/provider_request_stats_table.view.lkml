...
view: provider_request_stats_table {
  ...
  dimension: metrics__datetime__raw_provider_request_request_timestamp {
    sql: ${TABLE}.metrics.datetime.raw_provider_request_request_timestamp ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Datetime"
    group_item_label: "Raw Provider Request Request Timestamp"
  }

  dimension: metrics__datetime__raw_provider_request_response_timestamp {
    sql: ${TABLE}.metrics.datetime.raw_provider_request_response_timestamp ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Datetime"
    group_item_label: "Raw Provider Request Response Timestamp"
  }
  ...
  dimension: metrics__quantity__provider_request_count_requested {
    ...
    group_item_label: "Provider Request Count Requested"
  }
  ...
  dimension: metrics__quantity__provider_request_count_returned {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "Provider Request Count Returned"
  }
  ...
  dimension: metrics__string__ad_client_form_factor {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Ad Client Form Factor"
  }
  ...
  dimension: metrics__string__provider_request_provider {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Provider Request Provider"
  }
  ...
  dimension_group: metrics__datetime__provider_request_request {
    sql: ${TABLE}.metrics.datetime.provider_request_request_timestamp ;;
    type: time
    timeframes: [
      raw,
      time,
    ...
    label: "Metrics: Datetime: Provider Request Request Timestamp"
  }

  dimension_group: metrics__datetime__provider_request_response {
    sql: ${TABLE}.metrics.datetime.provider_request_response_timestamp ;;
    type: time
    timeframes: [
      raw,
      time,
    ...
    label: "Metrics: Datetime: Provider Request Response Timestamp"
  }
  ...
  sql_table_name: `mozdata.ads_backend.provider_request_stats` ;;
}

view: provider_request_stats_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: provider_request_stats_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: provider_request_stats_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: provider_request_stats_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: provider_request_stats_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
