...
view: request_stats_table {
  ...
  dimension: metrics__quantity__technical_operations_count_filtered {
    ...
    group_item_label: "Technical Operations Count Filtered"
  }
  ...
  dimension: metrics__quantity__technical_operations_count_requested {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "Technical Operations Count Requested"
  }
  ...
  dimension: metrics__quantity__technical_operations_count_returned {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "Technical Operations Count Returned"
  }
  ...
  sql_table_name: `mozdata.ads_backend.request_stats` ;;
}

view: request_stats_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: request_stats_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
