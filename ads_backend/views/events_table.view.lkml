...
view: events_table {
  ...
  dimension: metrics__datetime__raw_technical_operations_fetched_timestamp {
    sql: ${TABLE}.metrics.datetime.raw_technical_operations_fetched_timestamp ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Datetime"
    group_item_label: "Raw Technical Operations Fetched Timestamp"
  }

  dimension: metrics__datetime__raw_technical_operations_served_timestamp {
    sql: ${TABLE}.metrics.datetime.raw_technical_operations_served_timestamp ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Datetime"
  ...
  dimension: metrics__string__ad_client_context_id {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Ad Client Context ID"
  }
  ...
  dimension: metrics__string__ad_client_placement {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Ad Client Placement"
  }

  dimension: metrics__string__ad_client_placement_id {
    sql: ${TABLE}.metrics.string.ad_client_placement_id ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Ad Client Placement ID"
  }
  ...
  dimension: metrics__string__ad_client_position {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Ad Client Position"
  }
  ...
  dimension_group: metrics__datetime__technical_operations_fetched {
    ...
    label: "Metrics: Datetime: Technical Operations Fetched Timestamp"
  }
  ...
  dimension_group: metrics__datetime__technical_operations_served {
    ...
    label: "Metrics: Datetime: Technical Operations Served Timestamp"
  }
  ...
  sql_table_name: `mozdata.ads_backend.events` ;;
}
