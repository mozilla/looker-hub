...
explore: provider_request_stats {
  ...
  join: provider_request_stats__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${provider_request_stats.ping_info__server_knobs_config__metrics_enabled}) AS provider_request_stats__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: provider_request_stats__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${provider_request_stats.ping_info__server_knobs_config__pings_enabled}) AS provider_request_stats__ping_info__server_knobs_config__pings_enabled ;;
  }
