...
datagroup: account_settings_page_engagement_last_updated {
  ...
  description: "Updates for account_settings_page_engagement when moz-fx-data-shared-prod.accounts_frontend_derived.accounts_pref_engagement_v1 is modified."
