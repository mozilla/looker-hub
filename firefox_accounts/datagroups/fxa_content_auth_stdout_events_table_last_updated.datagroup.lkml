...
datagroup: fxa_content_auth_stdout_events_table_last_updated {
  label: "fxa_content_auth_stdout_events_table Last Updated"
 ...
 UNION ALL 
  ...
  description: "Updates for fxa_content_auth_stdout_events_table when referenced tables are modified."
