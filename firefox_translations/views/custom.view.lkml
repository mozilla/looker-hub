...
"
  ...
  dimension: metrics__boolean__infobar_auto_translate_enabled {
    ...
    description: "\"Automatically translate as browse\" is enabled.
"
  }
...
"
  ...
  dimension: metrics__string__metadata_channel {
    ...
    description: "Firefox distribution channel
"
  }
...
"
  ...
  dimension: metrics__boolean__quality_is_supervised {
    ...
    description: "Indicates whether a supervised model was used for quality estimation.
"
  }
  ...
  dimension: metrics__quantity__quality_sent_90th {
    ...
    description: "90th percentile of quality estimation of translation for sentences
multiplied by 1000.
"
  }
  ...
  dimension: metrics__quantity__quality_sent_avg {
    ...
    description: "Average quality estimation of translation for sentences
multiplied by 1000.
"
  }
  ...
  dimension: metrics__quantity__quality_sent_median {
    ...
    description: "Median quality estimation of translation for sentences
multiplied by 1000.
"
  }
  ...
  dimension: metrics__string__quality_summary {
    ...
    description: "Summary of quality estimation of translation.
...
"
  ...
  dimension: metrics__quantity__quality_word_90th {
    ...
    description: "90th percentile of quality estimation of translation for words
multiplied by 1000.
"
  }
  ...
  dimension: metrics__quantity__quality_word_avg {
    ...
    description: "Average quality estimation of translation for words
multiplied by 1000.
"
  }
  ...
  dimension: metrics__quantity__quality_word_median {
    ...
    description: "Median quality estimation of translation for words
multiplied by 1000.
"
  }
...
"
  ...
  dimension: metrics__string__glean_client_annotation_experimentation_id {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_translations/metrics/glean_client_annotation_experimentation_id"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__labeled_counter__glean_error_invalid_type {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_translations/metrics/glean_error_invalid_type"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: custom__metrics__labeled_counter__glean_error_invalid_type {
  label: "Glean Error: Invalid Type"
...
view: custom__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: custom__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
