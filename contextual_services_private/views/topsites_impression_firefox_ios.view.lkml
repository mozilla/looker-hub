...
view: topsites_impression_firefox_ios {
  ...
  sql_table_name: `mozdata.org_mozilla_ios_firefox.topsites_impression` ;;
}
...
view: topsites_impression_firefox_ios__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: topsites_impression_firefox_ios__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
