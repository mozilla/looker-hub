...
include: "/looker-hub/operational_monitoring/views/tab_unloading_on_low_memory_for_macos_scalar.view.lkml"
...
explore: tab_unloading_on_low_memory_for_macos_scalar {
  ...
  aggregate_table: rollup_gpu_crashes {
    query: {
      ...
      filters: [
        tab_unloading_on_low_memory_for_macos_scalar.branch: "memory-pressure-warning, tab-unloading-and-memory-pressure-warning, memory-pressure-critical, tab-unloading-and-memory-pressure-critical, tab-unloading-and-memory-pressure-disabled",
        tab_unloading_on_low_memory_for_macos_scalar.percentile_conf: "50",
