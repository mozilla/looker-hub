...
include: "/looker-hub/operational_monitoring/views/tab_unloading_on_low_memory_for_linux_scalar.view.lkml"
...
explore: tab_unloading_on_low_memory_for_linux_scalar {
  ...
  aggregate_table: rollup_content_shutdown_crashes {
    query: {
      ...
      filters: [
        tab_unloading_on_low_memory_for_linux_scalar.branch: "tab-unloading-enabled, tab-unloading-disabled",
        tab_unloading_on_low_memory_for_linux_scalar.percentile_conf: "50",
