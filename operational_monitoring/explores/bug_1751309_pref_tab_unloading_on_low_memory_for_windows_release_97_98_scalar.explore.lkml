...
explore: bug_1751309_pref_tab_unloading_on_low_memory_for_windows_release_97_98_scalar {
  ...
  aggregate_table: rollup_concurrent_opened_tab_count {
    query: {
      ...
      filters: [
        bug_1751309_pref_tab_unloading_on_low_memory_for_windows_release_97_98_scalar.branch: "tab-unloading-enabled, tab-unloading-disabled",
        bug_1751309_pref_tab_unloading_on_low_memory_for_windows_release_97_98_scalar.percentile_conf: "50",
