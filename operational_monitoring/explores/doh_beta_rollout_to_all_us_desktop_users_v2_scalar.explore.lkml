...
include: "/looker-hub/operational_monitoring/views/doh_beta_rollout_to_all_us_desktop_users_v2_scalar.view.lkml"
  ...
  aggregate_table: rollup_gmplugin_crashes {
    query: {
      ...
      filters: [
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.branch: "enabled, disabled",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.percentile_conf: "50",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.probe: "gmplugin_crashes",
      ]
    }
  ...
  aggregate_table: rollup_content_shutdown_crashes {
    query: {
      ...
      filters: [
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.branch: "enabled, disabled",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.percentile_conf: "50",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.probe: "content_shutdown_crashes",
      ]
    }
  ...
  aggregate_table: rollup_plugin_crashes {
    query: {
      ...
      filters: [
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.branch: "enabled, disabled",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.percentile_conf: "50",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.probe: "plugin_crashes",
      ]
    }
  ...
  aggregate_table: rollup_gpu_crashes {
    query: {
      ...
      filters: [
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.branch: "enabled, disabled",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.percentile_conf: "50",
        doh_beta_rollout_to_all_us_desktop_users_v2_scalar.probe: "gpu_crashes",
      ]
    }
