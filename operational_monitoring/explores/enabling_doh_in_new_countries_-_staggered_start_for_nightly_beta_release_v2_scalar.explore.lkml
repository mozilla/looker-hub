...
include: "/looker-hub/operational_monitoring/views/enabling_doh_in_new_countries_-_staggered_start_for_nightly_beta_release_v2_scalar.view.lkml"
...
explore: enabling_doh_in_new_countries_-_staggered_start_for_nightly_beta_release_v2_scalar {
  ...
  aggregate_table: rollup_content_crashes {
    query: {
      ...
      filters: [
        enabling_doh_in_new_countries_-_staggered_start_for_nightly_beta_release_v2_scalar.branch: "active",
        enabling_doh_in_new_countries_-_staggered_start_for_nightly_beta_release_v2_scalar.percentile_conf: "50",
