...
include: "/looker-hub/operational_monitoring/views/https_rr_rollout_histogram.view.lkml"
...
explore: https_rr_rollout_histogram {
  ...
  aggregate_table: rollup_gc_ms {
    query: {
      ...
      filters: [
        https_rr_rollout_histogram.branch: "active",
        https_rr_rollout_histogram.percentile_conf: "50",
