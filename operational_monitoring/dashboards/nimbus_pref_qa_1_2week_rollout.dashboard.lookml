...
- dashboard: nimbus_pref_qa_1_2week_rollout
  title: Nimbus Pref Qa 1 2Week Rollout
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'retained'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 0
    col: 0
    width: 12
    height: 8
  ...
  - title: Qualified Cumulative Days Of Use
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'qualified_cumulative_days_of_use'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'search_count'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Days Of Use
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'days_of_use'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - title: Uri Count
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'uri_count'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 20
    col: 12
    width: 12
  ...
  - title: Ad Clicks
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'ad_clicks'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - title: Active Hours
    ...
    filters:
      nimbus_pref_qa_1_2week_rollout.metric: 'active_hours'
      nimbus_pref_qa_1_2week_rollout.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: nimbus_pref_qa_1_2week_rollout
    listens_to_filters: []
    field: nimbus_pref_qa_1_2week_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: nimbus_pref_qa_1_2week_rollout
    listens_to_filters: []
    field: nimbus_pref_qa_1_2week_rollout.parameter
