...
- dashboard: shortcuts_and_stories_v2
  title: Shortcuts And Stories V2
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      shortcuts_and_stories_v2.metric: 'retained'
      shortcuts_and_stories_v2.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: shortcuts_and_stories_v2
    listens_to_filters: []
    field: shortcuts_and_stories_v2.submission_date
  ...
  - name: Percentile
    ...
    explore: shortcuts_and_stories_v2
    listens_to_filters: []
    field: shortcuts_and_stories_v2.parameter
