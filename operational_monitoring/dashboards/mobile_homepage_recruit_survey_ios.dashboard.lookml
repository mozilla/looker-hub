...
- dashboard: mobile_homepage_recruit_survey_ios
  title: Mobile Homepage Recruit Survey Ios
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      mobile_homepage_recruit_survey_ios.metric: 'search_count'
      mobile_homepage_recruit_survey_ios.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: mobile_homepage_recruit_survey_ios
    listens_to_filters: []
    field: mobile_homepage_recruit_survey_ios.submission_date
  ...
  - name: Percentile
    ...
    explore: mobile_homepage_recruit_survey_ios
    listens_to_filters: []
    field: mobile_homepage_recruit_survey_ios.parameter
