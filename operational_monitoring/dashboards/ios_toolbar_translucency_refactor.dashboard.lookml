...
- dashboard: ios_toolbar_translucency_refactor
  title: Ios Toolbar Translucency Refactor
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      ios_toolbar_translucency_refactor.metric: 'retained'
      ios_toolbar_translucency_refactor.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: ios_toolbar_translucency_refactor
    listens_to_filters: []
    field: ios_toolbar_translucency_refactor.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_toolbar_translucency_refactor
    listens_to_filters: []
    field: ios_toolbar_translucency_refactor.parameter
