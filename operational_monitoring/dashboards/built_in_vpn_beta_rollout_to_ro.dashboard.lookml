...
- dashboard: built_in_vpn_beta_rollout_to_ro
  title: Built In Vpn Beta Rollout To Ro
  layout: newspaper
  ...
  - name: Date
    ...
    explore: built_in_vpn_beta_rollout_to_ro
    listens_to_filters: []
    field: built_in_vpn_beta_rollout_to_ro.submission_date
  ...
  - name: Percentile
    ...
    explore: built_in_vpn_beta_rollout_to_ro
    listens_to_filters: []
    field: built_in_vpn_beta_rollout_to_ro.parameter
