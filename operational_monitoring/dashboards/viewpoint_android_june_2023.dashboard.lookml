...
- dashboard: viewpoint_android_june_2023
  title: Viewpoint Android June 2023
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      viewpoint_android_june_2023.metric: 'ad_clicks'
      viewpoint_android_june_2023.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: viewpoint_android_june_2023
    listens_to_filters: []
    field: viewpoint_android_june_2023.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_android_june_2023
    listens_to_filters: []
    field: viewpoint_android_june_2023.parameter
