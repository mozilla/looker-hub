...
- dashboard: backgroundupdate_enable_unelevated_installations_rollout
  title: Backgroundupdate Enable Unelevated Installations Rollout
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      backgroundupdate_enable_unelevated_installations_rollout.metric: 'search_count'
      backgroundupdate_enable_unelevated_installations_rollout.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: backgroundupdate_enable_unelevated_installations_rollout
    listens_to_filters: []
    field: backgroundupdate_enable_unelevated_installations_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: backgroundupdate_enable_unelevated_installations_rollout
    listens_to_filters: []
    field: backgroundupdate_enable_unelevated_installations_rollout.parameter
