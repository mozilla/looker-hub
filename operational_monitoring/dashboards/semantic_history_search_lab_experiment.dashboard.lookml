...
- dashboard: semantic_history_search_lab_experiment
  title: Semantic History Search Lab Experiment
  layout: newspaper
  ...
  - name: Date
    ...
    explore: semantic_history_search_lab_experiment
    listens_to_filters: []
    field: semantic_history_search_lab_experiment.submission_date
  ...
  - name: Percentile
    ...
    explore: semantic_history_search_lab_experiment
    listens_to_filters: []
    field: semantic_history_search_lab_experiment.parameter
