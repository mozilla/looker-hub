...
- dashboard: needs_reload_selected_tab_refactor_release_experiment_v2
  title: Needs Reload Selected Tab Refactor Release Experiment V2
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      needs_reload_selected_tab_refactor_release_experiment_v2.metric: 'active_hours'
  ...
  - title: Search Count
    ...
    filters:
      needs_reload_selected_tab_refactor_release_experiment_v2.metric: 'search_count'
      needs_reload_selected_tab_refactor_release_experiment_v2.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: needs_reload_selected_tab_refactor_release_experiment_v2
    listens_to_filters: []
    field: needs_reload_selected_tab_refactor_release_experiment_v2.submission_date
  ...
  - name: Percentile
    ...
    explore: needs_reload_selected_tab_refactor_release_experiment_v2
    listens_to_filters: []
    field: needs_reload_selected_tab_refactor_release_experiment_v2.parameter
