...
- dashboard: viewpoint_ios_may_2024_launch
  title: Viewpoint Ios May 2024 Launch
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      viewpoint_ios_may_2024_launch.metric: 'search_count'
  ...
  - title: Retained
    ...
    filters:
      viewpoint_ios_may_2024_launch.metric: 'retained'
      viewpoint_ios_may_2024_launch.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Ad Clicks
    ...
    filters:
      viewpoint_ios_may_2024_launch.metric: 'ad_clicks'
      viewpoint_ios_may_2024_launch.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: viewpoint_ios_may_2024_launch
    listens_to_filters: []
    field: viewpoint_ios_may_2024_launch.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_ios_may_2024_launch
    listens_to_filters: []
    field: viewpoint_ios_may_2024_launch.parameter
