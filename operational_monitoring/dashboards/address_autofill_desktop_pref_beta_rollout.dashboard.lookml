...
- dashboard: address_autofill_desktop_pref_beta_rollout
  title: Address Autofill Desktop Pref Beta Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: address_autofill_desktop_pref_beta_rollout
    listens_to_filters: []
    field: address_autofill_desktop_pref_beta_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: address_autofill_desktop_pref_beta_rollout
    listens_to_filters: []
    field: address_autofill_desktop_pref_beta_rollout.parameter
