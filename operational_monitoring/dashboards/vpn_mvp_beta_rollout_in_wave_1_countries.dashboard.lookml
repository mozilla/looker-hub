...
- dashboard: vpn_mvp_beta_rollout_in_wave_1_countries
  title: Vpn Mvp Beta Rollout In Wave 1 Countries
  layout: newspaper
  ...
  - title: Qualified Cumulative Days Of Use
    ...
    filters:
      vpn_mvp_beta_rollout_in_wave_1_countries.metric: 'qualified_cumulative_days_of_use'
      vpn_mvp_beta_rollout_in_wave_1_countries.statistic: mean
    row: 20
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: vpn_mvp_beta_rollout_in_wave_1_countries
    listens_to_filters: []
    field: vpn_mvp_beta_rollout_in_wave_1_countries.submission_date
  ...
  - name: Percentile
    ...
    explore: vpn_mvp_beta_rollout_in_wave_1_countries
    listens_to_filters: []
    field: vpn_mvp_beta_rollout_in_wave_1_countries.parameter
