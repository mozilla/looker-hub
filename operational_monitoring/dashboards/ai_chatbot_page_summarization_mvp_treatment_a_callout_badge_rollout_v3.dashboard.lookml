...
- dashboard: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3
  title: Ai Chatbot Page Summarization Mvp Treatment A Callout Badge Rollout V3
  layout: newspaper
  ...
  - title: URI Count
    ...
    filters:
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.metric: 'uri_count'
  ...
  - title: Active Hours
    ...
    filters:
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.metric: 'active_hours'
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Retained
    ...
    filters:
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.metric: 'retained'
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Memory Total
    ...
    fields: [
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.submission_date,
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.branch,
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.upper,
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.lower,
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.point
    ]
    pivots: [
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.branch
  ...
  - title: Days Of Use
    ...
    filters:
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.metric: 'days_of_use'
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3
    listens_to_filters: []
    field: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.submission_date
  ...
  - name: Percentile
    ...
    explore: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3
    listens_to_filters: []
    field: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v3.parameter
