...
- dashboard: desktop_address_autofill_india_beta_rollout
  title: Desktop Address Autofill India Beta Rollout
  layout: newspaper
  ...
  - title: URI Count
    ...
    filters:
      desktop_address_autofill_india_beta_rollout.metric: 'uri_count'
      desktop_address_autofill_india_beta_rollout.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Qualified Cumulative Days Of Use
    ...
    filters:
      desktop_address_autofill_india_beta_rollout.metric: 'qualified_cumulative_days_of_use'
      desktop_address_autofill_india_beta_rollout.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      desktop_address_autofill_india_beta_rollout.metric: 'search_count'
      desktop_address_autofill_india_beta_rollout.statistic: mean
    row: 20
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: desktop_address_autofill_india_beta_rollout
    listens_to_filters: []
    field: desktop_address_autofill_india_beta_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: desktop_address_autofill_india_beta_rollout
    listens_to_filters: []
    field: desktop_address_autofill_india_beta_rollout.parameter
