...
- dashboard: local_network_access_rollout_151_all_users
  title: Local Network Access Rollout 151 All Users
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      ...
      local_network_access_rollout_151_all_users.upper,
      local_network_access_rollout_151_all_users.lower,
    ...
    filters:
      local_network_access_rollout_151_all_users.metric: 'memory_total'
      local_network_access_rollout_151_all_users.statistic: percentile
    row: 0
    col: 0
    width: 12
    height: 8
    ...
    listen:
      ...
      Percentile: local_network_access_rollout_151_all_users.parameter
  ...
  - title: URI Count
    ...
    filters:
      local_network_access_rollout_151_all_users.metric: 'uri_count'
  ...
  - name: Date
    ...
    explore: local_network_access_rollout_151_all_users
    listens_to_filters: []
    field: local_network_access_rollout_151_all_users.submission_date
  ...
  - name: Percentile
    ...
    explore: local_network_access_rollout_151_all_users
    listens_to_filters: []
    field: local_network_access_rollout_151_all_users.parameter
