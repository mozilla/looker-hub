...
- dashboard: sections_rollout_us_beta_and_nightly
  title: Sections Rollout Us Beta And Nightly
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      sections_rollout_us_beta_and_nightly.metric: 'ad_clicks'
      sections_rollout_us_beta_and_nightly.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: URI Count
    ...
    filters:
      sections_rollout_us_beta_and_nightly.metric: 'uri_count'
      sections_rollout_us_beta_and_nightly.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Memory Total
    ...
    fields: [
      sections_rollout_us_beta_and_nightly.submission_date,
      sections_rollout_us_beta_and_nightly.branch,
      sections_rollout_us_beta_and_nightly.upper,
      sections_rollout_us_beta_and_nightly.lower,
      sections_rollout_us_beta_and_nightly.point
    ]
    pivots: [
      sections_rollout_us_beta_and_nightly.branch
    ...
    listen:
      Date: sections_rollout_us_beta_and_nightly.submission_date
      Percentile: sections_rollout_us_beta_and_nightly.parameter
  ...
  - title: Retained
    ...
    filters:
      sections_rollout_us_beta_and_nightly.metric: 'retained'
      sections_rollout_us_beta_and_nightly.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: sections_rollout_us_beta_and_nightly
    listens_to_filters: []
    field: sections_rollout_us_beta_and_nightly.submission_date
  ...
  - name: Percentile
    ...
    explore: sections_rollout_us_beta_and_nightly
    listens_to_filters: []
    field: sections_rollout_us_beta_and_nightly.parameter
