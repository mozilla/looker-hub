...
- dashboard: hnt_weather_opt_in_nightly_and_beta
  title: Hnt Weather Opt In Nightly And Beta
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      hnt_weather_opt_in_nightly_and_beta.metric: 'ad_clicks'
      hnt_weather_opt_in_nightly_and_beta.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: hnt_weather_opt_in_nightly_and_beta
    listens_to_filters: []
    field: hnt_weather_opt_in_nightly_and_beta.submission_date
  ...
  - name: Percentile
    ...
    explore: hnt_weather_opt_in_nightly_and_beta
    listens_to_filters: []
    field: hnt_weather_opt_in_nightly_and_beta.parameter
