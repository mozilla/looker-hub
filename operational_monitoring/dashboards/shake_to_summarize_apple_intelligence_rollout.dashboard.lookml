...
- dashboard: shake_to_summarize_apple_intelligence_rollout
  title: Shake To Summarize Apple Intelligence Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: shake_to_summarize_apple_intelligence_rollout
    listens_to_filters: []
    field: shake_to_summarize_apple_intelligence_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: shake_to_summarize_apple_intelligence_rollout
    listens_to_filters: []
    field: shake_to_summarize_apple_intelligence_rollout.parameter
