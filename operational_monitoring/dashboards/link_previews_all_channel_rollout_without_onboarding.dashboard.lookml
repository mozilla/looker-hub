...
- dashboard: link_previews_all_channel_rollout_without_onboarding
  title: Link Previews All Channel Rollout Without Onboarding
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      link_previews_all_channel_rollout_without_onboarding.metric: 'ad_clicks'
      link_previews_all_channel_rollout_without_onboarding.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: link_previews_all_channel_rollout_without_onboarding
    listens_to_filters: []
    field: link_previews_all_channel_rollout_without_onboarding.submission_date
  ...
  - name: Percentile
    ...
    explore: link_previews_all_channel_rollout_without_onboarding
    listens_to_filters: []
    field: link_previews_all_channel_rollout_without_onboarding.parameter
