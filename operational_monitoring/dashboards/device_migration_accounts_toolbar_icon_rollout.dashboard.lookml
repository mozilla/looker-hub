...
- dashboard: device_migration_accounts_toolbar_icon_rollout
  title: Device Migration Accounts Toolbar Icon Rollout
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      device_migration_accounts_toolbar_icon_rollout.submission_date,
      device_migration_accounts_toolbar_icon_rollout.branch,
      device_migration_accounts_toolbar_icon_rollout.upper,
      device_migration_accounts_toolbar_icon_rollout.lower,
      device_migration_accounts_toolbar_icon_rollout.point
    ]
    pivots: [
      device_migration_accounts_toolbar_icon_rollout.branch
    ...
    listen:
      Date: device_migration_accounts_toolbar_icon_rollout.submission_date
      Percentile: device_migration_accounts_toolbar_icon_rollout.parameter
  ...
  - name: Date
    ...
    explore: device_migration_accounts_toolbar_icon_rollout
    listens_to_filters: []
    field: device_migration_accounts_toolbar_icon_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: device_migration_accounts_toolbar_icon_rollout
    listens_to_filters: []
    field: device_migration_accounts_toolbar_icon_rollout.parameter
