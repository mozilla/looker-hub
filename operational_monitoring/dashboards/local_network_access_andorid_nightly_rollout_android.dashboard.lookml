...
- dashboard: local_network_access_andorid_nightly_rollout_android
  title: Local Network Access Andorid Nightly Rollout Android
  layout: newspaper
  ...
  - name: Date
    ...
    explore: local_network_access_andorid_nightly_rollout_android
    listens_to_filters: []
    field: local_network_access_andorid_nightly_rollout_android.submission_date
  ...
  - name: Percentile
    ...
    explore: local_network_access_andorid_nightly_rollout_android
    listens_to_filters: []
    field: local_network_access_andorid_nightly_rollout_android.parameter
