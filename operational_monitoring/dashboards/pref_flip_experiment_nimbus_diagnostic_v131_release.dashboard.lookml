...
- dashboard: pref_flip_experiment_nimbus_diagnostic_v131_release
  title: Pref Flip Experiment Nimbus Diagnostic V131 Release
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      pref_flip_experiment_nimbus_diagnostic_v131_release.submission_date,
      pref_flip_experiment_nimbus_diagnostic_v131_release.branch,
      pref_flip_experiment_nimbus_diagnostic_v131_release.upper,
      pref_flip_experiment_nimbus_diagnostic_v131_release.lower,
      pref_flip_experiment_nimbus_diagnostic_v131_release.point
    ]
    pivots: [
      pref_flip_experiment_nimbus_diagnostic_v131_release.branch
    ...
    listen:
      Date: pref_flip_experiment_nimbus_diagnostic_v131_release.submission_date
      Percentile: pref_flip_experiment_nimbus_diagnostic_v131_release.parameter
  ...
  - name: Date
    ...
    explore: pref_flip_experiment_nimbus_diagnostic_v131_release
    listens_to_filters: []
    field: pref_flip_experiment_nimbus_diagnostic_v131_release.submission_date
  ...
  - name: Percentile
    ...
    explore: pref_flip_experiment_nimbus_diagnostic_v131_release
    listens_to_filters: []
    field: pref_flip_experiment_nimbus_diagnostic_v131_release.parameter
