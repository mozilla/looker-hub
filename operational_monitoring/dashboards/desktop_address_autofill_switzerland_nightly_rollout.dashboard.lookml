...
- dashboard: desktop_address_autofill_switzerland_nightly_rollout
  title: Desktop Address Autofill Switzerland Nightly Rollout
  layout: newspaper
  ...
  - title: Qualified Cumulative Days Of Use
    ...
    filters:
      desktop_address_autofill_switzerland_nightly_rollout.metric: 'qualified_cumulative_days_of_use'
      desktop_address_autofill_switzerland_nightly_rollout.statistic: mean
    row: 0
    col: 0
    width: 12
    height: 8
    field_x: desktop_address_autofill_switzerland_nightly_rollout.submission_date
    field_y: desktop_address_autofill_switzerland_nightly_rollout.point
    log_scale: false
    ci_lower: desktop_address_autofill_switzerland_nightly_rollout.lower
    ci_upper: desktop_address_autofill_switzerland_nightly_rollout.upper
    show_grid: true
    listen:
  ...
  - title: Ad Clicks
    ...
    filters:
      desktop_address_autofill_switzerland_nightly_rollout.metric: 'ad_clicks'
      desktop_address_autofill_switzerland_nightly_rollout.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: desktop_address_autofill_switzerland_nightly_rollout
    listens_to_filters: []
    field: desktop_address_autofill_switzerland_nightly_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: desktop_address_autofill_switzerland_nightly_rollout
    listens_to_filters: []
    field: desktop_address_autofill_switzerland_nightly_rollout.parameter
