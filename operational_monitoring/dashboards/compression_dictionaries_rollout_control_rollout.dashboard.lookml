...
- dashboard: compression_dictionaries_rollout_control_rollout
  title: Compression Dictionaries Rollout Control Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: compression_dictionaries_rollout_control_rollout
    listens_to_filters: []
    field: compression_dictionaries_rollout_control_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: compression_dictionaries_rollout_control_rollout
    listens_to_filters: []
    field: compression_dictionaries_rollout_control_rollout.parameter
