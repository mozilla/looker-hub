...
- dashboard: account_adoption_callout_passwords_rollout
  title: Account Adoption Callout Passwords Rollout
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      account_adoption_callout_passwords_rollout.submission_date,
      account_adoption_callout_passwords_rollout.branch,
      account_adoption_callout_passwords_rollout.upper,
      account_adoption_callout_passwords_rollout.lower,
      account_adoption_callout_passwords_rollout.point
    ]
    pivots: [
      account_adoption_callout_passwords_rollout.branch
    ...
    listen:
      Date: account_adoption_callout_passwords_rollout.submission_date
      Percentile: account_adoption_callout_passwords_rollout.parameter
  ...
  - title: Search Count
    ...
    filters:
      account_adoption_callout_passwords_rollout.metric: 'search_count'
      account_adoption_callout_passwords_rollout.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: account_adoption_callout_passwords_rollout
    listens_to_filters: []
    field: account_adoption_callout_passwords_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: account_adoption_callout_passwords_rollout
    listens_to_filters: []
    field: account_adoption_callout_passwords_rollout.parameter
