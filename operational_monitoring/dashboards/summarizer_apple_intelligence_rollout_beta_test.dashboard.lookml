...
- dashboard: summarizer_apple_intelligence_rollout_beta_test
  title: Summarizer Apple Intelligence Rollout Beta Test
  layout: newspaper
  ...
  - name: Date
    ...
    explore: summarizer_apple_intelligence_rollout_beta_test
    listens_to_filters: []
    field: summarizer_apple_intelligence_rollout_beta_test.submission_date
  ...
  - name: Percentile
    ...
    explore: summarizer_apple_intelligence_rollout_beta_test
    listens_to_filters: []
    field: summarizer_apple_intelligence_rollout_beta_test.parameter
