...
- dashboard: upgraded_sidebar_138_broad_rollout
  title: Upgraded Sidebar 138 Broad Rollout
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      upgraded_sidebar_138_broad_rollout.metric: 'search_count'
      upgraded_sidebar_138_broad_rollout.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: upgraded_sidebar_138_broad_rollout
    listens_to_filters: []
    field: upgraded_sidebar_138_broad_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: upgraded_sidebar_138_broad_rollout
    listens_to_filters: []
    field: upgraded_sidebar_138_broad_rollout.parameter
