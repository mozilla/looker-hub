...
- dashboard: sample_uptakeremotecontent_events_glean_feature
  title: Sample Uptakeremotecontent Events Glean Feature
  layout: newspaper
  ...
  - name: Date
    ...
    explore: sample_uptakeremotecontent_events_glean_feature
    listens_to_filters: []
    field: sample_uptakeremotecontent_events_glean_feature.submission_date
  ...
  - name: Percentile
    ...
    explore: sample_uptakeremotecontent_events_glean_feature
    listens_to_filters: []
    field: sample_uptakeremotecontent_events_glean_feature.parameter
