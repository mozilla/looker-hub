...
- dashboard: tab_groups_android_rollout
  title: Tab Groups Android Rollout
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      tab_groups_android_rollout.metric: 'active_hours'
      tab_groups_android_rollout.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Tagged Sap Searches
    ...
    filters:
      tab_groups_android_rollout.metric: 'tagged_sap_searches'
      tab_groups_android_rollout.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: tab_groups_android_rollout
    listens_to_filters: []
    field: tab_groups_android_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: tab_groups_android_rollout
    listens_to_filters: []
    field: tab_groups_android_rollout.parameter
