...
- dashboard: ios_snapkit_removal_re_run
  title: Ios Snapkit Removal Re Run
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      ios_snapkit_removal_re_run.metric: 'ad_clicks'
      ios_snapkit_removal_re_run.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      ios_snapkit_removal_re_run.metric: 'search_count'
      ios_snapkit_removal_re_run.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: ios_snapkit_removal_re_run
    listens_to_filters: []
    field: ios_snapkit_removal_re_run.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_snapkit_removal_re_run
    listens_to_filters: []
    field: ios_snapkit_removal_re_run.parameter
