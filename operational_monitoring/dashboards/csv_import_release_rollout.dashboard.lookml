...
- dashboard: csv_import_release_rollout
  title: Csv Import Release Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: csv_import_release_rollout
    listens_to_filters: []
    field: csv_import_release_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: csv_import_release_rollout
    listens_to_filters: []
    field: csv_import_release_rollout.parameter
