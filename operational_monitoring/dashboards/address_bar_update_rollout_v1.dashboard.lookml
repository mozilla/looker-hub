...
- dashboard: address_bar_update_rollout_v1
  title: Address Bar Update Rollout V1
  layout: newspaper
  ...
  - title: Days Of Use
    ...
    filters:
      address_bar_update_rollout_v1.metric: 'days_of_use'
      address_bar_update_rollout_v1.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: URI Count
    ...
    filters:
      address_bar_update_rollout_v1.metric: 'uri_count'
      address_bar_update_rollout_v1.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: address_bar_update_rollout_v1
    listens_to_filters: []
    field: address_bar_update_rollout_v1.submission_date
  ...
  - name: Percentile
    ...
    explore: address_bar_update_rollout_v1
    listens_to_filters: []
    field: address_bar_update_rollout_v1.parameter
