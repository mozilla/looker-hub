...
- dashboard: email_pin_tab_taskbar_tab_prompts_treatment_b_rollout
  title: Email Pin Tab Taskbar Tab Prompts Treatment B Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: email_pin_tab_taskbar_tab_prompts_treatment_b_rollout
    listens_to_filters: []
    field: email_pin_tab_taskbar_tab_prompts_treatment_b_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: email_pin_tab_taskbar_tab_prompts_treatment_b_rollout
    listens_to_filters: []
    field: email_pin_tab_taskbar_tab_prompts_treatment_b_rollout.parameter
