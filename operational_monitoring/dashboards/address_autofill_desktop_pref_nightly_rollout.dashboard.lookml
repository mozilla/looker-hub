...
- dashboard: address_autofill_desktop_pref_nightly_rollout
  title: Address Autofill Desktop Pref Nightly Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: address_autofill_desktop_pref_nightly_rollout
    listens_to_filters: []
    field: address_autofill_desktop_pref_nightly_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: address_autofill_desktop_pref_nightly_rollout
    listens_to_filters: []
    field: address_autofill_desktop_pref_nightly_rollout.parameter
