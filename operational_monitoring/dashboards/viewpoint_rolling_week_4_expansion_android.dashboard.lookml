...
- dashboard: viewpoint_rolling_week_4_expansion_android
  title: Viewpoint Rolling Week 4 Expansion Android
  layout: newspaper
  ...
  - title: Tagged Sap Searches
    ...
    filters:
      viewpoint_rolling_week_4_expansion_android.metric: 'tagged_sap_searches'
      viewpoint_rolling_week_4_expansion_android.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Memory Total
    ...
    fields: [
      viewpoint_rolling_week_4_expansion_android.submission_date,
      viewpoint_rolling_week_4_expansion_android.branch,
      viewpoint_rolling_week_4_expansion_android.upper,
      viewpoint_rolling_week_4_expansion_android.lower,
      viewpoint_rolling_week_4_expansion_android.point
    ]
    pivots: [
      viewpoint_rolling_week_4_expansion_android.branch
  ...
  - name: Date
    ...
    explore: viewpoint_rolling_week_4_expansion_android
    listens_to_filters: []
    field: viewpoint_rolling_week_4_expansion_android.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_rolling_week_4_expansion_android
    listens_to_filters: []
    field: viewpoint_rolling_week_4_expansion_android.parameter
