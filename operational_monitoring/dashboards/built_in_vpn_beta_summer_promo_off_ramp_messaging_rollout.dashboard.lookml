...
- dashboard: built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout
  title: Built In Vpn Beta Summer Promo Off Ramp Messaging Rollout
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.submission_date,
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.branch,
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.upper,
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.lower,
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.point
    ]
    pivots: [
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.branch
  ...
  - title: URI Count
    ...
    filters:
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.metric: 'uri_count'
      built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout
    listens_to_filters: []
    field: built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout
    listens_to_filters: []
    field: built_in_vpn_beta_summer_promo_off_ramp_messaging_rollout.parameter
