...
- dashboard: nimbus_pref_qa_2_2week_rollout
  ...
  - title: Shutdown Hangs
    ...
    filters:
      nimbus_pref_qa_2_2week_rollout.metric: 'shutdown_hangs'
      nimbus_pref_qa_2_2week_rollout.statistic: sum
    row: 0
    col: 0
    width: 12
    height: 8
  ...
  - title: Content Crashes
    ...
    filters:
      nimbus_pref_qa_2_2week_rollout.metric: 'content_crashes'
      nimbus_pref_qa_2_2week_rollout.statistic: sum
    row: 0
    col: 12
    width: 12
  ...
  - title: Main Crashes
    ...
    filters:
      nimbus_pref_qa_2_2week_rollout.metric: 'main_crashes'
      nimbus_pref_qa_2_2week_rollout.statistic: sum
    row: 10
    col: 0
    width: 12
  ...
  - title: Startup Crashes
    ...
    filters:
      nimbus_pref_qa_2_2week_rollout.metric: 'startup_crashes'
      nimbus_pref_qa_2_2week_rollout.statistic: sum
    row: 10
    col: 12
    width: 12
  ...
  - title: Oom Crashes
    ...
    filters:
      nimbus_pref_qa_2_2week_rollout.metric: 'oom_crashes'
      nimbus_pref_qa_2_2week_rollout.statistic: sum
    row: 20
    col: 12
    width: 12
