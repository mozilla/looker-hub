...
- dashboard: hnt_wattle_picture_of_the_day_rollout_nightly
  title: Hnt Wattle Picture Of The Day Rollout Nightly
  layout: newspaper
  ...
  - name: Date
    ...
    explore: hnt_wattle_picture_of_the_day_rollout_nightly
    listens_to_filters: []
    field: hnt_wattle_picture_of_the_day_rollout_nightly.submission_date
  ...
  - name: Percentile
    ...
    explore: hnt_wattle_picture_of_the_day_rollout_nightly
    listens_to_filters: []
    field: hnt_wattle_picture_of_the_day_rollout_nightly.parameter
