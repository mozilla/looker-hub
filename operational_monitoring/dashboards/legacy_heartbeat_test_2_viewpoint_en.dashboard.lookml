...
- dashboard: legacy_heartbeat_test_2_viewpoint_en
  title: Legacy Heartbeat Test 2 Viewpoint En
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      legacy_heartbeat_test_2_viewpoint_en.metric: 'retained'
      legacy_heartbeat_test_2_viewpoint_en.statistic: mean
    row: 20
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: legacy_heartbeat_test_2_viewpoint_en
    listens_to_filters: []
    field: legacy_heartbeat_test_2_viewpoint_en.submission_date
  ...
  - name: Percentile
    ...
    explore: legacy_heartbeat_test_2_viewpoint_en
    listens_to_filters: []
    field: legacy_heartbeat_test_2_viewpoint_en.parameter
