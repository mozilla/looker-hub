...
- dashboard: viewpoint_ios_jul_2025_rolling_test
  title: Viewpoint Ios Jul 2025 Rolling Test
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      viewpoint_ios_jul_2025_rolling_test.metric: 'active_hours'
      viewpoint_ios_jul_2025_rolling_test.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      viewpoint_ios_jul_2025_rolling_test.metric: 'search_count'
      viewpoint_ios_jul_2025_rolling_test.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: viewpoint_ios_jul_2025_rolling_test
    listens_to_filters: []
    field: viewpoint_ios_jul_2025_rolling_test.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_ios_jul_2025_rolling_test
    listens_to_filters: []
    field: viewpoint_ios_jul_2025_rolling_test.parameter
