...
- dashboard: desktop_address_autofill_holdback_uk_nightly
  title: Desktop Address Autofill Holdback Uk Nightly
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      desktop_address_autofill_holdback_uk_nightly.metric: 'search_count'
      desktop_address_autofill_holdback_uk_nightly.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Retained
    ...
    filters:
      desktop_address_autofill_holdback_uk_nightly.metric: 'retained'
      desktop_address_autofill_holdback_uk_nightly.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: desktop_address_autofill_holdback_uk_nightly
    listens_to_filters: []
    field: desktop_address_autofill_holdback_uk_nightly.submission_date
  ...
  - name: Percentile
    ...
    explore: desktop_address_autofill_holdback_uk_nightly
    listens_to_filters: []
    field: desktop_address_autofill_holdback_uk_nightly.parameter
