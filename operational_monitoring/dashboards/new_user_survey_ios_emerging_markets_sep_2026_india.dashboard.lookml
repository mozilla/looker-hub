...
- dashboard: new_user_survey_ios_emerging_markets_sep_2026_india
  title: New User Survey Ios Emerging Markets Sep 2026 India
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      new_user_survey_ios_emerging_markets_sep_2026_india.metric: 'active_hours'
      new_user_survey_ios_emerging_markets_sep_2026_india.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: new_user_survey_ios_emerging_markets_sep_2026_india
    listens_to_filters: []
    field: new_user_survey_ios_emerging_markets_sep_2026_india.submission_date
  ...
  - name: Percentile
    ...
    explore: new_user_survey_ios_emerging_markets_sep_2026_india
    listens_to_filters: []
    field: new_user_survey_ios_emerging_markets_sep_2026_india.parameter
