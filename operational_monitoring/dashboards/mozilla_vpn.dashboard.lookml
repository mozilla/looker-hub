...
- dashboard: mozilla_vpn
  ...
  - title: App
    name: App
    type: string_filter
    default_value: 'Android - daemon,Android - vpn,Android - vpnsession,Darwin - vpn,Desktop - vpnsession,iOS - daemon,iOS - vpn,iPhone - daemon,iPhone - vpnsession,Linux - vpn'
    allow_multiple_values: true
    required: true
    ui_config:
      type: advanced
