...
- dashboard: ios_translations_phase_2
  title: Ios Translations Phase 2
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      ios_translations_phase_2.metric: 'ad_clicks'
      ios_translations_phase_2.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Active Hours
    ...
    filters:
      ios_translations_phase_2.metric: 'active_hours'
      ios_translations_phase_2.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: ios_translations_phase_2
    listens_to_filters: []
    field: ios_translations_phase_2.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_translations_phase_2
    listens_to_filters: []
    field: ios_translations_phase_2.parameter
