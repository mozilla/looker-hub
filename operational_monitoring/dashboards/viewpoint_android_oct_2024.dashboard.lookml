...
- dashboard: viewpoint_android_oct_2024
  title: Viewpoint Android Oct 2024
  layout: newspaper
  ...
  - title: Uri Count
    ...
    filters:
      viewpoint_android_oct_2024.metric: 'uri_count'
      viewpoint_android_oct_2024.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Retained
    ...
    filters:
      viewpoint_android_oct_2024.metric: 'retained'
      viewpoint_android_oct_2024.statistic: mean
    row: 20
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: viewpoint_android_oct_2024
    listens_to_filters: []
    field: viewpoint_android_oct_2024.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_android_oct_2024
    listens_to_filters: []
    field: viewpoint_android_oct_2024.parameter
