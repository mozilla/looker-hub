...
- dashboard: tab_groups_android_rollout1
  title: Tab Groups Android Rollout1
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      tab_groups_android_rollout1.metric: 'active_hours'
      tab_groups_android_rollout1.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: tab_groups_android_rollout1
    listens_to_filters: []
    field: tab_groups_android_rollout1.submission_date
  ...
  - name: Percentile
    ...
    explore: tab_groups_android_rollout1
    listens_to_filters: []
    field: tab_groups_android_rollout1.parameter
