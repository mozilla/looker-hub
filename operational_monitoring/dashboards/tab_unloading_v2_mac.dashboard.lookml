...
- dashboard: tab_unloading_v2_mac
  title: Tab Unloading V2 Mac
  layout: newspaper
  ...
  - title: Content Process Count
    ...
    filters:
      tab_unloading_v2_mac_histogram.probe: content_process_count
    row: 110
    col: 12
    width: 12
    height: 8
  ...
  - title: Gmplugin Crashes
    ...
    filters:
      tab_unloading_v2_mac_scalar.probe: gmplugin_crashes
    row: 160
    col: 0
    width: 12
    height: 8
  ...
  - title: Plugin Crashes
    ...
    filters:
      tab_unloading_v2_mac_scalar.probe: plugin_crashes
    row: 190
    col: 0
    width: 12
    height: 8
  ...
  - title: Content Shutdown Crashes
    ...
    filters:
      tab_unloading_v2_mac_scalar.probe: content_shutdown_crashes
    row: 190
    col: 12
    width: 12
    height: 8
  ...
  - title: Startup Crashes
    ...
    filters:
      tab_unloading_v2_mac_scalar.probe: startup_crashes
    row: 200
    col: 12
    width: 12
    height: 8
  ...
  - title: Gpu Crashes
    ...
    filters:
      tab_unloading_v2_mac_scalar.probe: gpu_crashes
    row: 220
    col: 12
    width: 12
    height: 8
