...
- dashboard: hnt_weather_opt_in_release_post_nova
  title: Hnt Weather Opt In Release Post Nova
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      hnt_weather_opt_in_release_post_nova.metric: 'search_count'
      hnt_weather_opt_in_release_post_nova.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Ad Clicks
    ...
    filters:
      hnt_weather_opt_in_release_post_nova.metric: 'ad_clicks'
      hnt_weather_opt_in_release_post_nova.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Qualified Cumulative Days Of Use
    ...
    filters:
      hnt_weather_opt_in_release_post_nova.metric: 'qualified_cumulative_days_of_use'
      hnt_weather_opt_in_release_post_nova.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - title: Retained
    ...
    filters:
      hnt_weather_opt_in_release_post_nova.metric: 'retained'
      hnt_weather_opt_in_release_post_nova.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: hnt_weather_opt_in_release_post_nova
    listens_to_filters: []
    field: hnt_weather_opt_in_release_post_nova.submission_date
  ...
  - name: Percentile
    ...
    explore: hnt_weather_opt_in_release_post_nova
    listens_to_filters: []
    field: hnt_weather_opt_in_release_post_nova.parameter
