...
- dashboard: built_in_vpn_messaging_evergreen
  title: Built In Vpn Messaging Evergreen
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      built_in_vpn_messaging_evergreen.metric: 'ad_clicks'
      built_in_vpn_messaging_evergreen.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      built_in_vpn_messaging_evergreen.metric: 'search_count'
      built_in_vpn_messaging_evergreen.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: built_in_vpn_messaging_evergreen
    listens_to_filters: []
    field: built_in_vpn_messaging_evergreen.submission_date
  ...
  - name: Percentile
    ...
    explore: built_in_vpn_messaging_evergreen
    listens_to_filters: []
    field: built_in_vpn_messaging_evergreen.parameter
