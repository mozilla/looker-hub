...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "enddoc", "abort", "start_page", "print_failure", "unexpected", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "startdoc", "notimplemented", "oom", "cannot_open_file"'
