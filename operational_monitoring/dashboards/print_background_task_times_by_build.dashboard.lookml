...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "cannot_open_file", "print_failure", "not_available", "abort", "oom", "no_printer", "start_page", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "startdoc"'
