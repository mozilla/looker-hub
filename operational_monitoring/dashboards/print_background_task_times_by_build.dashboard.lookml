...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "startdoc", "abort", "no_printer", "oom", "print_failure", "enddoc", "unexpected", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "not_available", "start_page"'
