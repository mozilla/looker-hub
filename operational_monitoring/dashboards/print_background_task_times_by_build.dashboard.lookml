...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "startdoc", "notimplemented", "print_failure", "cannot_open_file", "enddoc", "start_page", "gfx_printer_doc_is_busy", "not_available", "abort", "oom", "unexpected", "name_not_found"'
