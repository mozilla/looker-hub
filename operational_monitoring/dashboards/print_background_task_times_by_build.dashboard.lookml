...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "oom", "no_printer", "gfx_printer_doc_is_busy", "startdoc", "start_page", "unexpected", "notimplemented", "name_not_found", "abort", "not_available", "print_failure", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
