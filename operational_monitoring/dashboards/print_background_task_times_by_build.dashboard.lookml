...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "gfx_printer_doc_is_busy", "print_failure", "abort", "startdoc", "not_available", "no_printer", "name_not_found", "unexpected", "start_page", "notimplemented", "enddoc", "cannot_open_file"'
