...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "print_failure", "startdoc", "gfx_printer_doc_is_busy", "oom", "cannot_open_file", "unexpected", "enddoc", "not_available", "no_printer", "notimplemented", "start_page", "abort"'
