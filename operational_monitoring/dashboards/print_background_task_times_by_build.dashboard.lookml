...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "startdoc", "oom", "print_failure", "gfx_printer_doc_is_busy", "unexpected", "start_page", "cannot_open_file", "no_printer", "abort", "notimplemented", "enddoc", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
