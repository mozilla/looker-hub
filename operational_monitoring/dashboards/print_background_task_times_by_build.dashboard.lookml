...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "unexpected", "start_page", "name_not_found", "notimplemented", "cannot_open_file", "enddoc", "abort", "print_failure", "oom", "no_printer", "gfx_printer_doc_is_busy", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
