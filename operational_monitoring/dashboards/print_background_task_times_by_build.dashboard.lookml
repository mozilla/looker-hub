...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "enddoc", "oom", "abort", "no_printer", "unexpected", "startdoc", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "print_failure", "cannot_open_file", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
