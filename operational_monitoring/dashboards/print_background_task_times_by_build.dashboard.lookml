...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "enddoc", "oom", "unexpected", "startdoc", "abort", "cannot_open_file", "notimplemented", "start_page", "name_not_found", "no_printer", "not_available", "print_failure"'
