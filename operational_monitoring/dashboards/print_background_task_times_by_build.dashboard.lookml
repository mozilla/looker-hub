...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "cannot_open_file", "startdoc", "not_available", "no_printer", "gfx_printer_doc_is_busy", "enddoc", "start_page", "oom", "print_failure", "notimplemented", "unexpected"'
