...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "not_available", "enddoc", "print_failure", "gfx_printer_doc_is_busy", "abort", "notimplemented", "name_not_found", "cannot_open_file", "start_page", "oom", "no_printer"'
