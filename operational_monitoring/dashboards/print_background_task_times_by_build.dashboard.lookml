...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "start_page", "notimplemented", "abort", "oom", "cannot_open_file", "not_available", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "print_failure", "startdoc", "enddoc"'
