...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "not_available", "enddoc", "print_failure", "cannot_open_file", "no_printer", "oom", "name_not_found", "abort", "notimplemented", "unexpected", "startdoc", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
