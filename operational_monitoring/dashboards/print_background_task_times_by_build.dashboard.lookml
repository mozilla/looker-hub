...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "startdoc", "unexpected", "oom", "not_available", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "no_printer", "abort", "enddoc", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
