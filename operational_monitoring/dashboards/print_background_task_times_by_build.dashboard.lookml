...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "not_available", "no_printer", "startdoc", "gfx_printer_doc_is_busy", "enddoc", "unexpected", "notimplemented", "start_page", "oom", "abort", "cannot_open_file"'
