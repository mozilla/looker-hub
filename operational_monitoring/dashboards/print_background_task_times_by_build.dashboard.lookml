...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "enddoc", "start_page", "unexpected", "abort", "print_failure", "name_not_found", "cannot_open_file", "gfx_printer_doc_is_busy", "startdoc", "notimplemented", "not_available", "no_printer"'
