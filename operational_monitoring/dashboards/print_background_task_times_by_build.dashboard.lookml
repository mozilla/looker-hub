...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "abort", "enddoc", "no_printer", "not_available", "start_page", "name_not_found", "cannot_open_file", "startdoc", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
