...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "not_available", "oom", "startdoc", "start_page", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "name_not_found", "unexpected", "abort"'
