...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "cannot_open_file", "unexpected", "startdoc", "not_available", "oom", "name_not_found", "abort", "print_failure", "start_page", "enddoc", "gfx_printer_doc_is_busy", "no_printer"'
