...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "print_failure", "oom", "startdoc", "not_available", "no_printer", "abort", "notimplemented", "unexpected", "start_page", "cannot_open_file", "name_not_found"'
