...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "name_not_found", "abort", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "enddoc", "start_page", "unexpected", "no_printer", "oom", "not_available"'
