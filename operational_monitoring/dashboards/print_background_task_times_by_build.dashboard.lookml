...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "not_available", "oom", "no_printer", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "unexpected", "start_page", "print_failure", "notimplemented"'
