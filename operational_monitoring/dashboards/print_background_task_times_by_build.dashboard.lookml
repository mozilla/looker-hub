...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "abort", "start_page", "enddoc", "gfx_printer_doc_is_busy", "not_available", "oom", "print_failure", "notimplemented", "startdoc", "name_not_found", "unexpected", "cannot_open_file"'
