...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "notimplemented", "enddoc", "start_page", "no_printer", "oom", "unexpected", "not_available", "print_failure"'
