...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "start_page", "oom", "name_not_found", "print_failure", "no_printer", "notimplemented", "enddoc", "cannot_open_file", "not_available", "startdoc", "abort", "unexpected"'
