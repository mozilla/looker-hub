...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "not_available", "startdoc", "enddoc", "abort", "start_page", "name_not_found", "cannot_open_file", "unexpected", "print_failure", "no_printer", "notimplemented", "oom"'
