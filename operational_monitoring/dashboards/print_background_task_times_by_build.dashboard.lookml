...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "start_page", "name_not_found", "abort", "unexpected", "notimplemented", "gfx_printer_doc_is_busy", "not_available", "cannot_open_file", "enddoc", "print_failure", "startdoc", "oom"'
