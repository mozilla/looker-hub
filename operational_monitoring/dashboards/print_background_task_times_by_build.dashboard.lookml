...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "unexpected", "start_page", "print_failure", "abort", "gfx_printer_doc_is_busy", "not_available", "startdoc", "enddoc", "no_printer", "name_not_found", "oom", "cannot_open_file"'
