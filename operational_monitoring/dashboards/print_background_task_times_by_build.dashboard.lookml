...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "enddoc", "start_page", "abort", "notimplemented", "oom", "unexpected", "startdoc", "print_failure", "not_available"'
