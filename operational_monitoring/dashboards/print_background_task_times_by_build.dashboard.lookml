...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "notimplemented", "no_printer", "unexpected", "startdoc", "not_available", "abort", "cannot_open_file", "oom", "print_failure", "name_not_found", "gfx_printer_doc_is_busy", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
