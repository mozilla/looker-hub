...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "cannot_open_file", "enddoc", "startdoc", "oom", "abort", "start_page", "no_printer", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
