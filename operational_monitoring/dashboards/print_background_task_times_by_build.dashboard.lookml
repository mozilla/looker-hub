...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "not_available", "print_failure", "notimplemented", "startdoc", "start_page", "no_printer", "abort", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "enddoc", "cannot_open_file"'
