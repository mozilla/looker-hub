...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "not_available", "name_not_found", "no_printer", "startdoc", "notimplemented", "print_failure", "start_page", "cannot_open_file", "enddoc", "abort", "gfx_printer_doc_is_busy", "oom"'
