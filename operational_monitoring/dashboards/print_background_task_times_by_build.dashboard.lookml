...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "oom", "print_failure", "no_printer", "notimplemented", "start_page", "startdoc", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "not_available", "abort", "enddoc"'
