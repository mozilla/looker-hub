...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "abort", "oom", "not_available", "notimplemented", "no_printer", "enddoc", "unexpected", "name_not_found", "start_page", "cannot_open_file", "print_failure"'
