...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "cannot_open_file", "abort", "enddoc", "notimplemented", "not_available", "gfx_printer_doc_is_busy", "print_failure", "start_page", "startdoc", "no_printer", "unexpected", "name_not_found"'
