...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "name_not_found", "unexpected", "cannot_open_file", "abort", "startdoc", "not_available", "gfx_printer_doc_is_busy", "print_failure", "oom", "no_printer", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
