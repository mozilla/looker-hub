...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "notimplemented", "cannot_open_file", "not_available", "name_not_found", "no_printer", "start_page", "oom", "print_failure", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "abort"'
