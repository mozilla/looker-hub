...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "unexpected", "enddoc", "notimplemented", "gfx_printer_doc_is_busy", "startdoc", "not_available", "start_page", "cannot_open_file", "name_not_found", "no_printer", "abort", "print_failure"'
