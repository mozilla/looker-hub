...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "startdoc", "cannot_open_file", "enddoc", "notimplemented", "no_printer", "start_page", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "abort", "not_available", "print_failure"'
