...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "notimplemented", "oom", "cannot_open_file", "not_available", "unexpected", "gfx_printer_doc_is_busy", "start_page", "name_not_found", "startdoc", "enddoc", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
