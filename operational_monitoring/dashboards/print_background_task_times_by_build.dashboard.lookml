...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "not_available", "oom", "unexpected", "print_failure", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "no_printer", "enddoc", "startdoc", "cannot_open_file", "abort"'
