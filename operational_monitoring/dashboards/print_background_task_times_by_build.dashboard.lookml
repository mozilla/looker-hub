...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "name_not_found", "abort", "not_available", "notimplemented", "enddoc", "start_page", "startdoc", "print_failure", "cannot_open_file", "oom", "unexpected", "no_printer"'
