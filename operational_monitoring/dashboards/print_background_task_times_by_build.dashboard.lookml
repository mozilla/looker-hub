...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "no_printer", "startdoc", "start_page", "enddoc", "abort", "oom", "unexpected", "cannot_open_file", "print_failure", "name_not_found", "not_available"'
