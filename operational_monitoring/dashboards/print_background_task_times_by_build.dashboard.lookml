...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "print_failure", "not_available", "notimplemented", "oom", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "abort", "no_printer", "start_page", "unexpected"'
