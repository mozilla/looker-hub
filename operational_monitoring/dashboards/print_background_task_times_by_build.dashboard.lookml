...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "name_not_found", "cannot_open_file", "print_failure", "start_page", "gfx_printer_doc_is_busy", "enddoc", "abort", "notimplemented", "oom", "unexpected", "startdoc", "no_printer"'
