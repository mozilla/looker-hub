...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "start_page", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "not_available", "notimplemented", "cannot_open_file", "no_printer", "enddoc", "oom", "print_failure"'
