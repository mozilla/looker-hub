...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "name_not_found", "enddoc", "gfx_printer_doc_is_busy", "unexpected", "start_page", "cannot_open_file", "abort", "startdoc", "oom", "notimplemented", "not_available", "print_failure"'
