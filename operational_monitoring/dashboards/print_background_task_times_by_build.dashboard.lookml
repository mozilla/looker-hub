...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "cannot_open_file", "abort", "name_not_found", "not_available", "start_page", "enddoc", "notimplemented", "unexpected", "startdoc", "print_failure", "no_printer", "oom"'
