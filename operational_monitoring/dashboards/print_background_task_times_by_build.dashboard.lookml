...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "unexpected", "notimplemented", "startdoc", "name_not_found", "abort", "cannot_open_file", "start_page", "enddoc", "oom", "not_available", "gfx_printer_doc_is_busy"'
