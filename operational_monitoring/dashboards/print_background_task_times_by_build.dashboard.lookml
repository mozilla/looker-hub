...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "no_printer", "cannot_open_file", "print_failure", "startdoc", "start_page", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "abort", "not_available", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
