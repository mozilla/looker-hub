...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "start_page", "unexpected", "startdoc", "no_printer", "oom", "print_failure", "not_available", "enddoc", "notimplemented", "gfx_printer_doc_is_busy", "cannot_open_file", "name_not_found"'
