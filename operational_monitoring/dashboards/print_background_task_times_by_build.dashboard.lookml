...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "unexpected", "oom", "start_page", "print_failure", "enddoc", "gfx_printer_doc_is_busy", "notimplemented", "abort", "not_available", "name_not_found", "startdoc", "no_printer"'
