...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "start_page", "name_not_found", "no_printer", "unexpected", "startdoc", "gfx_printer_doc_is_busy", "abort", "print_failure", "enddoc", "cannot_open_file", "not_available", "oom"'
