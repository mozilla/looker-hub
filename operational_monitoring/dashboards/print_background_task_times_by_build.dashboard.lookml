...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "enddoc", "notimplemented", "abort", "oom", "no_printer", "not_available", "start_page", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
