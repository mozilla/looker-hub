...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "no_printer", "oom", "abort", "not_available", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "startdoc", "enddoc", "unexpected", "print_failure", "cannot_open_file"'
