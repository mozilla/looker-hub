...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "oom", "notimplemented", "startdoc", "start_page", "abort", "enddoc", "name_not_found", "print_failure", "unexpected", "not_available", "gfx_printer_doc_is_busy", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
