...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "not_available", "start_page", "enddoc", "startdoc", "abort", "gfx_printer_doc_is_busy", "unexpected", "print_failure", "oom", "no_printer", "cannot_open_file", "notimplemented"'
