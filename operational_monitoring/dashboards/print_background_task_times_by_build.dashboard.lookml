...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "notimplemented", "print_failure", "name_not_found", "not_available", "no_printer", "startdoc", "oom", "start_page", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "abort"'
