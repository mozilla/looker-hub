...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "oom", "cannot_open_file", "print_failure", "start_page", "not_available", "unexpected", "enddoc", "abort", "gfx_printer_doc_is_busy", "startdoc", "no_printer", "name_not_found"'
