...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "oom", "not_available", "start_page", "no_printer", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "notimplemented", "unexpected", "startdoc", "abort"'
