...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "notimplemented", "print_failure", "unexpected", "enddoc", "oom", "abort", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "start_page", "startdoc", "no_printer"'
