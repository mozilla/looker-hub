...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "not_available", "enddoc", "notimplemented", "cannot_open_file", "start_page", "oom", "gfx_printer_doc_is_busy", "no_printer", "abort", "print_failure", "unexpected", "startdoc"'
