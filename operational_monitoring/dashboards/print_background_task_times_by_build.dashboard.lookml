...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "gfx_printer_doc_is_busy", "no_printer", "oom", "notimplemented", "enddoc", "startdoc", "start_page", "abort", "unexpected", "not_available", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
