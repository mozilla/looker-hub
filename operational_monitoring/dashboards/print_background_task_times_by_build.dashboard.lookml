...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "cannot_open_file", "gfx_printer_doc_is_busy", "startdoc", "notimplemented", "print_failure", "start_page", "no_printer", "unexpected", "enddoc", "name_not_found", "not_available", "oom"'
