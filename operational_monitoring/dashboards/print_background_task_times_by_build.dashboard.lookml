...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "startdoc", "name_not_found", "print_failure", "enddoc", "notimplemented", "abort", "cannot_open_file", "oom", "start_page", "gfx_printer_doc_is_busy", "unexpected"'
