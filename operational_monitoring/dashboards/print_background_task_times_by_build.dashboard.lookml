...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "not_available", "unexpected", "start_page", "print_failure", "abort", "notimplemented", "oom", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "enddoc"'
