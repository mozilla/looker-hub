...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "name_not_found", "cannot_open_file", "start_page", "enddoc", "notimplemented", "startdoc", "abort", "gfx_printer_doc_is_busy", "print_failure", "no_printer", "oom", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
