...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "not_available", "no_printer", "notimplemented", "gfx_printer_doc_is_busy", "cannot_open_file", "name_not_found", "startdoc", "oom", "abort", "enddoc", "start_page", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
