...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "start_page", "no_printer", "notimplemented", "cannot_open_file", "startdoc", "enddoc", "name_not_found", "print_failure", "not_available", "oom", "gfx_printer_doc_is_busy"'
