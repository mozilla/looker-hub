...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "abort", "print_failure", "name_not_found", "oom", "start_page", "not_available", "notimplemented", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "enddoc", "cannot_open_file"'
