...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "cannot_open_file", "start_page", "name_not_found", "startdoc", "enddoc", "no_printer", "oom", "not_available", "notimplemented", "print_failure", "gfx_printer_doc_is_busy"'
