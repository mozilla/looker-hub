...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "enddoc", "name_not_found", "abort", "oom", "print_failure", "notimplemented", "no_printer", "start_page", "not_available", "unexpected"'
