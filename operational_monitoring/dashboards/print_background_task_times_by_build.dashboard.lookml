...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "cannot_open_file", "enddoc", "no_printer", "not_available", "print_failure", "abort", "gfx_printer_doc_is_busy", "name_not_found", "oom", "unexpected", "start_page"'
