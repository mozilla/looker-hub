...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "gfx_printer_doc_is_busy", "start_page", "unexpected", "not_available", "cannot_open_file", "print_failure", "name_not_found", "startdoc", "enddoc", "notimplemented", "no_printer", "oom"'
