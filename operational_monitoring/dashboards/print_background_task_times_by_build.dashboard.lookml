...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "gfx_printer_doc_is_busy", "print_failure", "enddoc", "start_page", "unexpected", "no_printer", "name_not_found", "oom", "notimplemented", "not_available", "startdoc", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
