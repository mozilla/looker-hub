...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "notimplemented", "cannot_open_file", "no_printer", "not_available", "start_page", "enddoc", "startdoc", "gfx_printer_doc_is_busy", "unexpected", "print_failure", "abort", "oom"'
