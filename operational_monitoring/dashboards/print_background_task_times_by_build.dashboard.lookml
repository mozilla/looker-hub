...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "unexpected", "name_not_found", "notimplemented", "cannot_open_file", "abort", "startdoc", "oom", "gfx_printer_doc_is_busy", "start_page", "not_available", "enddoc"'
