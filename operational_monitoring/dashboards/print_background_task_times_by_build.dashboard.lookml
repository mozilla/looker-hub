...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "print_failure", "notimplemented", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "startdoc", "oom", "not_available", "start_page", "cannot_open_file", "enddoc", "abort"'
