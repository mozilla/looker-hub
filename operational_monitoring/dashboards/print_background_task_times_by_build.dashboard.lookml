...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "not_available", "oom", "enddoc", "print_failure", "cannot_open_file", "start_page", "startdoc", "unexpected", "gfx_printer_doc_is_busy", "abort", "name_not_found", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
