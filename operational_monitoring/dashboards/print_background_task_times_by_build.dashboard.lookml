...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "abort", "notimplemented", "start_page", "unexpected", "name_not_found", "cannot_open_file", "not_available", "no_printer", "startdoc", "gfx_printer_doc_is_busy", "enddoc", "oom"'
