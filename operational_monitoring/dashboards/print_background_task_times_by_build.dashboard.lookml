...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "print_failure", "oom", "unexpected", "gfx_printer_doc_is_busy", "notimplemented", "startdoc", "start_page", "no_printer", "not_available", "name_not_found", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
