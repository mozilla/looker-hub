...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "oom", "cannot_open_file", "abort", "start_page", "print_failure", "enddoc", "no_printer", "not_available", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
