...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "oom", "no_printer", "name_not_found", "enddoc", "abort", "notimplemented", "print_failure", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
