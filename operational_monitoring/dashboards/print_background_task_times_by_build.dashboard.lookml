...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "enddoc", "notimplemented", "not_available", "abort", "startdoc", "no_printer", "print_failure", "name_not_found", "gfx_printer_doc_is_busy", "oom", "start_page", "unexpected"'
