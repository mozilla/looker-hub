...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "startdoc", "not_available", "start_page", "enddoc", "no_printer", "notimplemented", "unexpected", "oom", "abort", "gfx_printer_doc_is_busy", "cannot_open_file"'
