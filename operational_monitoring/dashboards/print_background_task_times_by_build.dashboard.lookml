...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "notimplemented", "name_not_found", "print_failure", "cannot_open_file", "enddoc", "abort", "oom", "startdoc", "start_page", "no_printer", "not_available", "gfx_printer_doc_is_busy"'
