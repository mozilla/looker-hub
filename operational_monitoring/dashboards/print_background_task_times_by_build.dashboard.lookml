...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "startdoc", "abort", "not_available", "name_not_found", "oom", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "cannot_open_file", "unexpected", "enddoc", "no_printer"'
