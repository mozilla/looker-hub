...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "cannot_open_file", "start_page", "oom", "no_printer", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "abort", "enddoc", "not_available", "notimplemented", "name_not_found"'
