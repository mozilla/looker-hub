...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "print_failure", "unexpected", "oom", "start_page", "not_available", "name_not_found", "notimplemented", "no_printer", "gfx_printer_doc_is_busy", "startdoc", "enddoc"'
