...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "unexpected", "not_available", "start_page", "abort", "startdoc", "name_not_found", "gfx_printer_doc_is_busy", "enddoc", "oom", "cannot_open_file", "print_failure", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
