...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "enddoc", "notimplemented", "abort", "print_failure", "cannot_open_file", "gfx_printer_doc_is_busy", "name_not_found", "start_page", "oom", "unexpected", "no_printer", "not_available"'
