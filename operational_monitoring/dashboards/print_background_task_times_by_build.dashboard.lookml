...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "no_printer", "start_page", "oom", "enddoc", "name_not_found", "abort", "notimplemented", "cannot_open_file", "not_available", "print_failure", "unexpected"'
