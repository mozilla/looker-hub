...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "not_available", "name_not_found", "startdoc", "enddoc", "abort", "oom", "gfx_printer_doc_is_busy", "start_page", "cannot_open_file", "unexpected", "notimplemented", "no_printer"'
