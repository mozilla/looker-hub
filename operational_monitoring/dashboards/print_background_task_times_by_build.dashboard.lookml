...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "not_available", "unexpected", "oom", "name_not_found", "enddoc", "cannot_open_file", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "no_printer", "startdoc", "abort"'
