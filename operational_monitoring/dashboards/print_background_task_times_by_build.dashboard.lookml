...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "abort", "startdoc", "name_not_found", "enddoc", "not_available", "notimplemented", "oom", "print_failure", "gfx_printer_doc_is_busy", "unexpected", "no_printer", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
