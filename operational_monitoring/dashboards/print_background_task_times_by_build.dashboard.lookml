...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "name_not_found", "no_printer", "startdoc", "start_page", "notimplemented", "unexpected", "print_failure", "abort", "oom", "not_available", "gfx_printer_doc_is_busy", "enddoc"'
