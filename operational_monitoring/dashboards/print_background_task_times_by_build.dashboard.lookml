...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "print_failure", "enddoc", "unexpected", "no_printer", "notimplemented", "oom", "name_not_found", "start_page", "cannot_open_file", "not_available", "abort", "gfx_printer_doc_is_busy"'
