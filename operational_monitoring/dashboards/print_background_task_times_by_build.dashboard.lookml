...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "unexpected", "print_failure", "oom", "name_not_found", "start_page", "no_printer", "not_available", "notimplemented", "gfx_printer_doc_is_busy", "startdoc", "abort", "enddoc"'
