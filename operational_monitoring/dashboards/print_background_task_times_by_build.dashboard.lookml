...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "start_page", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "not_available", "abort", "notimplemented", "oom", "name_not_found", "print_failure"'
