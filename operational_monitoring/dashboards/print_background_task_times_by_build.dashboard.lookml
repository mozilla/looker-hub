...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "start_page", "oom", "no_printer", "startdoc", "not_available", "notimplemented", "print_failure", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
