...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "enddoc", "oom", "name_not_found", "start_page", "cannot_open_file", "not_available", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "print_failure", "no_printer"'
