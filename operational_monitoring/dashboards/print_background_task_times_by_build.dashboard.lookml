...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "notimplemented", "name_not_found", "print_failure", "oom", "cannot_open_file", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "not_available", "start_page"'
