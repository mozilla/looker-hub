...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "startdoc", "start_page", "name_not_found", "cannot_open_file", "abort", "oom", "unexpected", "gfx_printer_doc_is_busy", "no_printer", "enddoc", "notimplemented", "not_available"'
