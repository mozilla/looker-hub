...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "enddoc", "print_failure", "oom", "abort", "no_printer", "unexpected", "startdoc", "name_not_found", "start_page", "not_available", "cannot_open_file", "notimplemented"'
