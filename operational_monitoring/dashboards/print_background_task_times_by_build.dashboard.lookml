...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "notimplemented", "oom", "not_available", "no_printer", "start_page", "name_not_found", "cannot_open_file", "unexpected", "enddoc", "startdoc", "print_failure", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
