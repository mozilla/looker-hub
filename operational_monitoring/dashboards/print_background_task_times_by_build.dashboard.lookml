...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "enddoc", "print_failure", "unexpected", "no_printer", "name_not_found", "not_available", "start_page", "startdoc", "gfx_printer_doc_is_busy", "oom", "notimplemented", "abort"'
