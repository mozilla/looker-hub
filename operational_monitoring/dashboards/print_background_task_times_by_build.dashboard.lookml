...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "not_available", "start_page", "enddoc", "notimplemented", "print_failure", "name_not_found", "oom", "abort", "unexpected", "cannot_open_file", "no_printer", "gfx_printer_doc_is_busy"'
