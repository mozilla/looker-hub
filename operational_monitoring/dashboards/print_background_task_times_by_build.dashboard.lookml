...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "startdoc", "abort", "print_failure", "unexpected", "no_printer", "cannot_open_file", "oom", "not_available", "gfx_printer_doc_is_busy", "start_page", "name_not_found", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
