...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "notimplemented", "start_page", "gfx_printer_doc_is_busy", "print_failure", "startdoc", "cannot_open_file", "enddoc", "oom", "no_printer", "not_available", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
