...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "abort", "cannot_open_file", "not_available", "startdoc", "oom", "no_printer", "name_not_found", "print_failure", "gfx_printer_doc_is_busy", "notimplemented", "start_page"'
