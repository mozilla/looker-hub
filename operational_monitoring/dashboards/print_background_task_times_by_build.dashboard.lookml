...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "print_failure", "unexpected", "abort", "notimplemented", "name_not_found", "enddoc", "oom", "gfx_printer_doc_is_busy", "start_page", "no_printer", "not_available", "cannot_open_file"'
