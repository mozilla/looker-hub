...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "startdoc", "oom", "enddoc", "cannot_open_file", "notimplemented", "start_page", "print_failure", "abort", "unexpected", "gfx_printer_doc_is_busy", "no_printer", "not_available"'
