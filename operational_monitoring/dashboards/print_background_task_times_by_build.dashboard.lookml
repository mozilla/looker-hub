...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "startdoc", "start_page", "oom", "unexpected", "abort", "gfx_printer_doc_is_busy", "enddoc", "name_not_found", "no_printer", "print_failure", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
