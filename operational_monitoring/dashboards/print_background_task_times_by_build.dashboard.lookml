...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "print_failure", "name_not_found", "startdoc", "notimplemented", "no_printer", "not_available", "gfx_printer_doc_is_busy", "start_page", "oom", "cannot_open_file", "abort"'
