...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "notimplemented", "start_page", "not_available", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "enddoc", "startdoc", "print_failure", "no_printer", "oom", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
