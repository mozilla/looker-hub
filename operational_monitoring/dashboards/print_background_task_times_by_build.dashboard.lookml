...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "start_page", "cannot_open_file", "enddoc", "startdoc", "abort", "notimplemented", "oom", "no_printer", "not_available"'
