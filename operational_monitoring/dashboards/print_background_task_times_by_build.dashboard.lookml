...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "name_not_found", "oom", "enddoc", "abort", "no_printer", "cannot_open_file", "not_available", "startdoc", "start_page", "unexpected", "print_failure", "notimplemented"'
