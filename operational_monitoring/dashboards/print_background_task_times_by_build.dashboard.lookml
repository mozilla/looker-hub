...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "notimplemented", "start_page", "enddoc", "not_available", "no_printer", "unexpected", "print_failure", "abort", "name_not_found"'
