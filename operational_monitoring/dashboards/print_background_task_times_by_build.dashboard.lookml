...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "print_failure", "oom", "name_not_found", "not_available", "unexpected", "no_printer", "start_page", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
