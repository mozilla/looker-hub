...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "abort", "enddoc", "start_page", "gfx_printer_doc_is_busy", "not_available", "oom", "unexpected", "print_failure", "notimplemented", "name_not_found", "startdoc"'
