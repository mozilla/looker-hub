...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "startdoc", "oom", "start_page", "print_failure", "name_not_found", "not_available", "enddoc", "notimplemented", "abort", "unexpected", "gfx_printer_doc_is_busy"'
