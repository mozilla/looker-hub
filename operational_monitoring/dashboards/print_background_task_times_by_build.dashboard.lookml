...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "enddoc", "not_available", "oom", "abort", "no_printer", "startdoc", "unexpected", "cannot_open_file", "start_page"'
