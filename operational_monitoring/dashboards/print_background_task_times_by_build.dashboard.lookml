...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "print_failure", "no_printer", "not_available", "abort", "startdoc", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "name_not_found", "cannot_open_file", "enddoc", "oom"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
