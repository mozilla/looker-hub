...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "startdoc", "gfx_printer_doc_is_busy", "notimplemented", "enddoc", "not_available", "start_page", "oom", "abort", "unexpected", "name_not_found", "print_failure", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
