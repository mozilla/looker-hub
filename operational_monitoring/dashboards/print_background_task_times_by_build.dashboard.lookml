...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "abort", "no_printer", "start_page", "print_failure", "not_available", "cannot_open_file", "notimplemented", "name_not_found", "enddoc", "unexpected", "startdoc", "oom"'
