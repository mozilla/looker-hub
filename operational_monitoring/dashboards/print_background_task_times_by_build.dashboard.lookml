...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "notimplemented", "oom", "no_printer", "abort", "start_page", "unexpected", "startdoc", "not_available", "print_failure", "cannot_open_file", "gfx_printer_doc_is_busy"'
