...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "no_printer", "abort", "start_page", "unexpected", "gfx_printer_doc_is_busy", "enddoc", "name_not_found", "cannot_open_file", "startdoc", "oom", "not_available"'
