...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "start_page", "not_available", "oom", "startdoc", "no_printer", "name_not_found", "abort", "cannot_open_file", "unexpected", "print_failure", "notimplemented", "enddoc"'
