...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "notimplemented", "cannot_open_file", "start_page", "no_printer", "print_failure", "not_available", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "oom", "enddoc", "startdoc"'
