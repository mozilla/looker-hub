...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "oom", "not_available", "start_page", "abort", "print_failure", "startdoc", "no_printer", "cannot_open_file", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "enddoc"'
