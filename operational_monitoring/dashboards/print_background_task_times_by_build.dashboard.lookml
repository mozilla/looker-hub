...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "print_failure", "name_not_found", "notimplemented", "not_available", "cannot_open_file", "no_printer", "abort", "enddoc", "startdoc", "oom", "unexpected", "gfx_printer_doc_is_busy"'
