...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "unexpected", "no_printer", "startdoc", "name_not_found", "enddoc", "oom", "abort", "print_failure", "not_available", "gfx_printer_doc_is_busy", "notimplemented", "cannot_open_file"'
