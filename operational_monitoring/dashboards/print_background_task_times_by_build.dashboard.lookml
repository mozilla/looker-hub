...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "cannot_open_file", "not_available", "enddoc", "abort", "start_page", "unexpected", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "oom", "no_printer", "print_failure"'
