...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "oom", "name_not_found", "gfx_printer_doc_is_busy", "start_page", "unexpected", "enddoc", "not_available", "cannot_open_file", "notimplemented", "no_printer", "print_failure", "startdoc"'
