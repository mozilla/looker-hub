...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "unexpected", "no_printer", "oom", "cannot_open_file", "start_page", "abort", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "enddoc", "startdoc"'
