...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "notimplemented", "oom", "print_failure", "not_available", "name_not_found", "cannot_open_file", "start_page", "unexpected", "enddoc", "gfx_printer_doc_is_busy", "abort"'
