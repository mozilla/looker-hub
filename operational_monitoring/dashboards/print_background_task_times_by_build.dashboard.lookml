...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "startdoc", "print_failure", "cannot_open_file", "gfx_printer_doc_is_busy", "notimplemented", "oom", "start_page", "no_printer", "unexpected", "enddoc", "not_available"'
