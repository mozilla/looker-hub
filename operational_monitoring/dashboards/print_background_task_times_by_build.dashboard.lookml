...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "notimplemented", "name_not_found", "startdoc", "no_printer", "print_failure", "start_page", "abort", "gfx_printer_doc_is_busy", "oom", "cannot_open_file", "not_available"'
