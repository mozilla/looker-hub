...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "name_not_found", "enddoc", "abort", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "oom", "not_available", "start_page", "cannot_open_file", "unexpected", "no_printer"'
