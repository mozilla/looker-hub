...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "startdoc", "not_available", "enddoc", "no_printer", "notimplemented", "cannot_open_file", "print_failure", "start_page", "gfx_printer_doc_is_busy", "abort", "oom"'
