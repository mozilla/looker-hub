...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "unexpected", "notimplemented", "name_not_found", "not_available", "print_failure", "no_printer", "enddoc", "start_page", "abort", "cannot_open_file", "oom", "startdoc"'
