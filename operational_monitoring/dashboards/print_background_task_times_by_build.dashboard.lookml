...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "no_printer", "enddoc", "print_failure", "gfx_printer_doc_is_busy", "unexpected", "oom", "abort", "not_available", "cannot_open_file", "notimplemented", "startdoc", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
