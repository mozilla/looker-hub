...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "startdoc", "abort", "unexpected", "name_not_found", "enddoc", "gfx_printer_doc_is_busy", "cannot_open_file", "start_page", "oom", "not_available", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
