...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "print_failure", "unexpected", "abort", "not_available", "name_not_found", "no_printer", "cannot_open_file", "oom", "startdoc", "notimplemented", "start_page", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
