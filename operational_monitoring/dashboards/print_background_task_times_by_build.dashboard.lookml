...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "unexpected", "no_printer", "enddoc", "start_page", "cannot_open_file", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "print_failure", "startdoc", "abort", "not_available"'
