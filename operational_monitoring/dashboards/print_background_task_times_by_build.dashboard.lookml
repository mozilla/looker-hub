...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "cannot_open_file", "startdoc", "abort", "start_page", "gfx_printer_doc_is_busy", "oom", "name_not_found", "unexpected", "print_failure", "enddoc", "no_printer", "notimplemented"'
