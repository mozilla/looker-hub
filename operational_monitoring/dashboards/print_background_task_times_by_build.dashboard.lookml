...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "print_failure", "oom", "notimplemented", "not_available", "abort", "startdoc", "enddoc", "unexpected", "no_printer", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
