...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "print_failure", "no_printer", "startdoc", "name_not_found", "cannot_open_file", "abort", "start_page", "oom", "unexpected", "gfx_printer_doc_is_busy", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
