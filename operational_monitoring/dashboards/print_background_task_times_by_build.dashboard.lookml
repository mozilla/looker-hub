...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "no_printer", "print_failure", "gfx_printer_doc_is_busy", "enddoc", "unexpected", "name_not_found", "abort", "oom", "start_page", "cannot_open_file", "startdoc", "not_available"'
