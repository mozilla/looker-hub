...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "startdoc", "oom", "name_not_found", "no_printer", "start_page", "not_available", "enddoc", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "notimplemented", "abort"'
