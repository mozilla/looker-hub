...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "name_not_found", "print_failure", "enddoc", "notimplemented", "start_page", "oom", "not_available", "gfx_printer_doc_is_busy", "unexpected", "abort", "cannot_open_file", "startdoc"'
