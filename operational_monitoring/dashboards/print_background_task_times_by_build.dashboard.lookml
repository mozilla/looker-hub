...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "no_printer", "gfx_printer_doc_is_busy", "startdoc", "oom", "name_not_found", "abort", "start_page", "print_failure", "cannot_open_file", "not_available", "enddoc", "notimplemented"'
