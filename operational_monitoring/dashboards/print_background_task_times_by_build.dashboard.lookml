...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "name_not_found", "gfx_printer_doc_is_busy", "notimplemented", "unexpected", "cannot_open_file", "enddoc", "no_printer", "startdoc", "not_available", "oom", "print_failure", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
