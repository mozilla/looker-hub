...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "start_page", "no_printer", "notimplemented", "oom", "print_failure", "enddoc", "unexpected", "name_not_found", "abort", "gfx_printer_doc_is_busy", "cannot_open_file", "not_available"'
