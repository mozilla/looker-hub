...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "not_available", "startdoc", "enddoc", "cannot_open_file", "abort", "notimplemented", "oom", "print_failure", "name_not_found", "unexpected", "start_page", "no_printer"'
