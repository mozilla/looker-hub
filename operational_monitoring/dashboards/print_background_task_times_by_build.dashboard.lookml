...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "startdoc", "cannot_open_file", "no_printer", "notimplemented", "abort", "oom", "print_failure", "enddoc", "name_not_found", "unexpected", "not_available", "gfx_printer_doc_is_busy"'
