...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "not_available", "start_page", "unexpected", "cannot_open_file", "oom", "no_printer", "gfx_printer_doc_is_busy", "abort", "notimplemented", "startdoc", "name_not_found"'
