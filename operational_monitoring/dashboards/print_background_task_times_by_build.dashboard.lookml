...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "print_failure", "not_available", "oom", "gfx_printer_doc_is_busy", "abort", "enddoc", "startdoc", "no_printer", "cannot_open_file", "unexpected", "name_not_found", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
