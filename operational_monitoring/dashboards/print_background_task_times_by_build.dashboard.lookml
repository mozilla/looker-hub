...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "enddoc", "cannot_open_file", "notimplemented", "print_failure", "no_printer", "unexpected", "startdoc", "start_page", "name_not_found", "not_available", "abort", "oom"'
