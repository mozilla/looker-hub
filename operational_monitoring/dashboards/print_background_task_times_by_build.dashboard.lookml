...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "print_failure", "name_not_found", "notimplemented", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "oom", "enddoc", "start_page", "not_available", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
