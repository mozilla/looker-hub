...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "start_page", "oom", "abort", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "notimplemented", "enddoc", "startdoc", "unexpected"'
