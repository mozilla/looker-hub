...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "no_printer", "startdoc", "notimplemented", "not_available", "unexpected", "start_page", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "oom", "enddoc"'
