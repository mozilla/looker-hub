...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "abort", "cannot_open_file", "start_page", "gfx_printer_doc_is_busy", "oom", "unexpected", "not_available", "print_failure", "no_printer", "enddoc", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
