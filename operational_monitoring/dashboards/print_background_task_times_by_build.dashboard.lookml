...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "name_not_found", "gfx_printer_doc_is_busy", "unexpected", "notimplemented", "start_page", "not_available", "abort", "oom", "print_failure", "enddoc", "cannot_open_file"'
