...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "oom", "gfx_printer_doc_is_busy", "abort", "name_not_found", "start_page", "not_available", "cannot_open_file", "enddoc", "notimplemented", "print_failure", "startdoc", "no_printer"'
