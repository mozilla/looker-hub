...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "unexpected", "startdoc", "notimplemented", "no_printer", "start_page", "abort", "not_available", "print_failure", "cannot_open_file", "name_not_found", "oom", "enddoc"'
