...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "unexpected", "not_available", "no_printer", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "oom", "abort", "name_not_found", "enddoc", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
