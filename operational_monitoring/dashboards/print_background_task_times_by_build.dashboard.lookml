...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "oom", "abort", "no_printer", "cannot_open_file", "start_page", "not_available", "notimplemented", "gfx_printer_doc_is_busy", "startdoc", "print_failure", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
