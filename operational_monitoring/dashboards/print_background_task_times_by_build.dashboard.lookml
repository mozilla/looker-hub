...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "notimplemented", "gfx_printer_doc_is_busy", "abort", "start_page", "oom", "startdoc", "not_available", "cannot_open_file", "no_printer", "enddoc", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
