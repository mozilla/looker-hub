...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "start_page", "no_printer", "not_available", "unexpected", "notimplemented", "gfx_printer_doc_is_busy", "oom", "abort", "name_not_found", "enddoc", "startdoc"'
