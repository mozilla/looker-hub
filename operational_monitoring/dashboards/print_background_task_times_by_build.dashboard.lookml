...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "no_printer", "notimplemented", "enddoc", "not_available", "print_failure", "start_page", "abort", "unexpected", "cannot_open_file", "oom", "name_not_found", "startdoc"'
