...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "print_failure", "abort", "no_printer", "start_page", "name_not_found", "gfx_printer_doc_is_busy", "not_available", "oom", "enddoc", "startdoc", "unexpected", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
