...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "name_not_found", "start_page", "gfx_printer_doc_is_busy", "cannot_open_file", "not_available", "notimplemented", "oom", "startdoc", "enddoc", "unexpected", "abort"'
