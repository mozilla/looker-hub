...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "unexpected", "startdoc", "notimplemented", "start_page", "name_not_found", "print_failure", "no_printer", "cannot_open_file", "oom", "enddoc", "abort", "not_available"'
