...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "gfx_printer_doc_is_busy", "start_page", "enddoc", "oom", "not_available", "name_not_found", "cannot_open_file", "notimplemented", "no_printer", "unexpected", "abort", "print_failure"'
