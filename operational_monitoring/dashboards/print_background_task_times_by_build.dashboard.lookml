...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "notimplemented", "oom", "cannot_open_file", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "not_available", "no_printer", "name_not_found", "abort", "unexpected", "print_failure"'
