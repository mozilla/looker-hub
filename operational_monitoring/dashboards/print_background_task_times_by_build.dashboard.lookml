...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "cannot_open_file", "startdoc", "not_available", "unexpected", "gfx_printer_doc_is_busy", "abort", "oom", "no_printer", "print_failure", "notimplemented", "name_not_found", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
