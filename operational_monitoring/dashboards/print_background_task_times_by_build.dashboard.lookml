...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "no_printer", "name_not_found", "start_page", "unexpected", "gfx_printer_doc_is_busy", "enddoc", "abort", "notimplemented", "not_available", "startdoc", "cannot_open_file", "print_failure"'
