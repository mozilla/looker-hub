...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "start_page", "not_available", "startdoc", "enddoc", "cannot_open_file", "gfx_printer_doc_is_busy", "oom", "no_printer", "name_not_found", "abort", "print_failure", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
