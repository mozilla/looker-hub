...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "startdoc", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "start_page", "not_available", "enddoc", "notimplemented", "oom", "cannot_open_file", "abort"'
