...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "name_not_found", "print_failure", "no_printer", "enddoc", "start_page", "gfx_printer_doc_is_busy", "not_available", "startdoc", "oom", "unexpected", "cannot_open_file", "notimplemented"'
