...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "abort", "start_page", "print_failure", "cannot_open_file", "gfx_printer_doc_is_busy", "oom", "not_available", "enddoc", "no_printer", "name_not_found", "unexpected"'
