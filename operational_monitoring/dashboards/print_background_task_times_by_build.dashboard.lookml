...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "no_printer", "name_not_found", "cannot_open_file", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "startdoc", "start_page", "unexpected", "abort", "not_available", "enddoc"'
