...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "start_page", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "cannot_open_file", "oom", "no_printer", "unexpected", "print_failure", "startdoc", "abort", "not_available"'
