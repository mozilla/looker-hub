...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "notimplemented", "cannot_open_file", "oom", "unexpected", "abort", "print_failure", "no_printer", "name_not_found", "startdoc", "not_available", "gfx_printer_doc_is_busy", "enddoc"'
