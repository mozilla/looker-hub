...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "gfx_printer_doc_is_busy", "unexpected", "cannot_open_file", "oom", "no_printer", "enddoc", "startdoc", "notimplemented", "name_not_found", "abort", "print_failure"'
