...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "not_available", "startdoc", "no_printer", "abort", "gfx_printer_doc_is_busy", "start_page", "cannot_open_file", "unexpected", "enddoc", "name_not_found", "oom"'
