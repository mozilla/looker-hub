...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "start_page", "oom", "name_not_found", "notimplemented", "enddoc", "cannot_open_file", "gfx_printer_doc_is_busy", "no_printer", "unexpected", "startdoc", "print_failure", "not_available"'
