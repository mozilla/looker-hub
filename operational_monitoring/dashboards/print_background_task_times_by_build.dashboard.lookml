...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "unexpected", "no_printer", "oom", "startdoc", "print_failure", "notimplemented", "name_not_found", "start_page", "cannot_open_file", "enddoc", "gfx_printer_doc_is_busy", "not_available"'
