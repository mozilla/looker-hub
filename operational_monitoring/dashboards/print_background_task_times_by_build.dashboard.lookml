...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "not_available", "enddoc", "startdoc", "no_printer", "gfx_printer_doc_is_busy", "notimplemented", "name_not_found", "oom", "unexpected", "start_page", "abort", "print_failure"'
