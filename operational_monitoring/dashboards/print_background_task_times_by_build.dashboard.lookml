...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "start_page", "unexpected", "not_available", "abort", "gfx_printer_doc_is_busy", "startdoc", "print_failure", "oom", "notimplemented", "name_not_found", "enddoc", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
