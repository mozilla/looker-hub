...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "oom", "startdoc", "enddoc", "abort", "cannot_open_file", "not_available", "name_not_found", "notimplemented", "no_printer", "gfx_printer_doc_is_busy", "print_failure", "start_page"'
