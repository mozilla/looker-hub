...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "abort", "gfx_printer_doc_is_busy", "not_available", "unexpected", "startdoc", "enddoc", "start_page", "no_printer", "cannot_open_file", "oom", "name_not_found"'
