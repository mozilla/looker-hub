...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "unexpected", "abort", "gfx_printer_doc_is_busy", "print_failure", "not_available", "enddoc", "notimplemented", "oom", "no_printer", "cannot_open_file", "startdoc"'
