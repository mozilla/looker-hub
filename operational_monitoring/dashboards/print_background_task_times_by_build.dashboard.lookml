...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "gfx_printer_doc_is_busy", "startdoc", "oom", "print_failure", "notimplemented", "unexpected", "not_available", "no_printer", "name_not_found", "abort", "cannot_open_file", "enddoc"'
