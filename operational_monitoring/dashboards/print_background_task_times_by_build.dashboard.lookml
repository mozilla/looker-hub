...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "unexpected", "abort", "oom", "enddoc", "start_page", "name_not_found", "not_available", "notimplemented", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
