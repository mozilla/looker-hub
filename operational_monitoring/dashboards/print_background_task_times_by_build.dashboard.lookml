...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "enddoc", "start_page", "name_not_found", "startdoc", "abort", "gfx_printer_doc_is_busy", "oom", "print_failure", "unexpected", "no_printer", "not_available", "notimplemented"'
