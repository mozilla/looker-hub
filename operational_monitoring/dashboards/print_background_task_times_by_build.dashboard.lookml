...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "notimplemented", "no_printer", "unexpected", "not_available", "enddoc", "oom", "gfx_printer_doc_is_busy", "abort", "startdoc", "start_page", "cannot_open_file", "print_failure"'
