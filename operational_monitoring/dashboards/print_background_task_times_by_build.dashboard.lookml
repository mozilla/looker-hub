...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "notimplemented", "enddoc", "name_not_found", "abort", "no_printer", "start_page", "oom", "print_failure", "gfx_printer_doc_is_busy", "startdoc", "not_available", "unexpected"'
