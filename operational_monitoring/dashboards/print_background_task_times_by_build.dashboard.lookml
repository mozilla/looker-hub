...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "gfx_printer_doc_is_busy", "start_page", "abort", "notimplemented", "no_printer", "enddoc", "oom", "name_not_found", "cannot_open_file", "not_available", "print_failure", "unexpected"'
