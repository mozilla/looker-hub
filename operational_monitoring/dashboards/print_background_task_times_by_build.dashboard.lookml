...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "startdoc", "print_failure", "name_not_found", "unexpected", "cannot_open_file", "abort", "oom", "enddoc", "no_printer", "start_page", "not_available"'
