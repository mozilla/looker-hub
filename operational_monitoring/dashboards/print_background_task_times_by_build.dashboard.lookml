...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "not_available", "name_not_found", "unexpected", "abort", "start_page", "cannot_open_file", "no_printer", "print_failure", "oom", "gfx_printer_doc_is_busy", "startdoc", "notimplemented"'
