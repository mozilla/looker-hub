...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "not_available", "unexpected", "startdoc", "enddoc", "start_page", "print_failure", "oom", "notimplemented"'
