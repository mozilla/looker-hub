...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "print_failure", "enddoc", "start_page", "startdoc", "cannot_open_file", "no_printer", "notimplemented", "name_not_found", "abort", "gfx_printer_doc_is_busy", "unexpected", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
