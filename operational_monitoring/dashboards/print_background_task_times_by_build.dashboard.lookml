...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "no_printer", "notimplemented", "cannot_open_file", "gfx_printer_doc_is_busy", "enddoc", "start_page", "unexpected", "not_available", "startdoc", "oom", "abort"'
