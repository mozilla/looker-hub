...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "name_not_found", "abort", "not_available", "print_failure", "startdoc", "notimplemented", "enddoc", "oom", "no_printer", "unexpected", "start_page", "gfx_printer_doc_is_busy"'
