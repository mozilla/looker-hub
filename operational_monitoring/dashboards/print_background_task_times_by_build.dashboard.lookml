...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "cannot_open_file", "start_page", "no_printer", "unexpected", "enddoc", "abort", "oom", "gfx_printer_doc_is_busy", "print_failure", "not_available", "name_not_found", "notimplemented"'
