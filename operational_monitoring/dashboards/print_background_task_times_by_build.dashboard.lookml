...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "name_not_found", "print_failure", "oom", "unexpected", "no_printer", "startdoc", "not_available", "notimplemented", "enddoc", "start_page", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
