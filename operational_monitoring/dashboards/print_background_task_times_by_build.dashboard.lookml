...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "cannot_open_file", "no_printer", "enddoc", "abort", "not_available", "notimplemented", "name_not_found", "startdoc", "unexpected", "print_failure", "gfx_printer_doc_is_busy", "start_page"'
