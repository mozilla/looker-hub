...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "cannot_open_file", "oom", "start_page", "unexpected", "startdoc", "print_failure", "not_available", "enddoc", "gfx_printer_doc_is_busy", "name_not_found", "no_printer", "abort"'
