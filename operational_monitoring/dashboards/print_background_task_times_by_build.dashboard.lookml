...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "not_available", "cannot_open_file", "unexpected", "start_page", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "enddoc", "abort", "no_printer", "oom", "startdoc"'
