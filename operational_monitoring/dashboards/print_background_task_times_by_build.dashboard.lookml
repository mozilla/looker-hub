...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "not_available", "no_printer", "name_not_found", "print_failure", "oom", "unexpected", "abort", "startdoc", "start_page", "gfx_printer_doc_is_busy", "cannot_open_file", "notimplemented"'
