...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "name_not_found", "abort", "enddoc", "notimplemented", "unexpected", "no_printer", "cannot_open_file", "startdoc", "oom", "start_page", "print_failure", "gfx_printer_doc_is_busy"'
