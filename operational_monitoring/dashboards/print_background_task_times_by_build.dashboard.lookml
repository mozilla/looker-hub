...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "not_available", "no_printer", "enddoc", "oom", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "cannot_open_file", "print_failure", "start_page", "abort"'
