...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "notimplemented", "start_page", "oom", "print_failure", "gfx_printer_doc_is_busy", "startdoc", "abort", "enddoc", "no_printer", "cannot_open_file", "name_not_found", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
