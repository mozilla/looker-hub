...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "name_not_found", "startdoc", "oom", "enddoc", "no_printer", "gfx_printer_doc_is_busy", "not_available", "abort", "notimplemented", "print_failure", "start_page", "unexpected"'
