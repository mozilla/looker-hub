...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "notimplemented", "unexpected", "cannot_open_file", "start_page", "enddoc", "gfx_printer_doc_is_busy", "name_not_found", "not_available", "print_failure", "oom", "no_printer"'
