...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "start_page", "print_failure", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "enddoc", "startdoc", "name_not_found", "oom", "no_printer", "abort"'
