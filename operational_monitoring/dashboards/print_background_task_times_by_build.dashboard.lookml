...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "unexpected", "oom", "startdoc", "name_not_found", "enddoc", "print_failure", "start_page", "not_available", "no_printer", "cannot_open_file", "notimplemented", "abort"'
