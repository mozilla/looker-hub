...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "cannot_open_file", "notimplemented", "print_failure", "no_printer", "enddoc", "start_page", "abort", "name_not_found", "oom", "gfx_printer_doc_is_busy", "startdoc", "unexpected"'
