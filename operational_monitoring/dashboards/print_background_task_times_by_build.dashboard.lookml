...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "start_page", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "print_failure", "notimplemented", "abort", "unexpected", "startdoc", "enddoc", "name_not_found", "not_available"'
