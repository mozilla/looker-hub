...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "enddoc", "print_failure", "not_available", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "oom", "notimplemented", "cannot_open_file", "no_printer", "unexpected", "start_page"'
