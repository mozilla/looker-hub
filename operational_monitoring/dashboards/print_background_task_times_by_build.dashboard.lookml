...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "print_failure", "abort", "no_printer", "name_not_found", "startdoc", "enddoc", "notimplemented", "gfx_printer_doc_is_busy", "not_available", "unexpected", "cannot_open_file", "start_page"'
