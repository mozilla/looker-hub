...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "startdoc", "no_printer", "name_not_found", "unexpected", "not_available", "gfx_printer_doc_is_busy", "enddoc", "cannot_open_file", "start_page", "notimplemented", "oom", "abort"'
