...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "notimplemented", "no_printer", "oom", "abort", "gfx_printer_doc_is_busy", "not_available", "cannot_open_file", "name_not_found", "start_page", "startdoc", "print_failure", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
