...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "enddoc", "no_printer", "not_available", "abort", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "start_page", "notimplemented", "oom", "unexpected", "print_failure"'
