...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "not_available", "notimplemented", "gfx_printer_doc_is_busy", "print_failure", "start_page", "name_not_found", "no_printer", "unexpected", "startdoc", "abort", "oom", "enddoc"'
