...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "startdoc", "not_available", "abort", "gfx_printer_doc_is_busy", "oom", "notimplemented", "enddoc", "cannot_open_file", "print_failure", "no_printer", "start_page"'
