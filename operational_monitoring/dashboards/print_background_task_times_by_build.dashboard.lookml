...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "abort", "start_page", "notimplemented", "not_available", "cannot_open_file", "name_not_found", "oom", "unexpected", "startdoc", "no_printer", "print_failure"'
