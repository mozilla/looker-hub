...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "start_page", "cannot_open_file", "not_available", "no_printer", "notimplemented", "oom", "abort", "unexpected", "name_not_found", "gfx_printer_doc_is_busy", "enddoc", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
