...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "start_page", "abort", "not_available", "unexpected", "name_not_found", "notimplemented", "cannot_open_file", "oom", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
