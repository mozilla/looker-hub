...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "gfx_printer_doc_is_busy", "not_available", "no_printer", "print_failure", "name_not_found", "start_page", "unexpected", "startdoc", "oom", "notimplemented", "enddoc", "abort"'
