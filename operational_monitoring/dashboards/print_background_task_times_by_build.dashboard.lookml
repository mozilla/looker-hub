...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "oom", "name_not_found", "unexpected", "startdoc", "abort", "gfx_printer_doc_is_busy", "no_printer", "enddoc", "print_failure", "start_page", "not_available", "cannot_open_file"'
