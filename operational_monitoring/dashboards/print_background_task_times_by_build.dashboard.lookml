...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "abort", "not_available", "enddoc", "oom", "notimplemented", "startdoc", "no_printer", "start_page", "unexpected", "cannot_open_file", "print_failure", "name_not_found"'
