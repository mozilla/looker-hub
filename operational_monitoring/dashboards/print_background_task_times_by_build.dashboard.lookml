...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "not_available", "start_page", "enddoc", "no_printer", "name_not_found", "cannot_open_file", "startdoc", "unexpected", "gfx_printer_doc_is_busy", "print_failure", "oom", "abort"'
