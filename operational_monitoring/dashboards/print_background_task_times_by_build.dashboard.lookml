...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "notimplemented", "startdoc", "start_page", "unexpected", "oom", "enddoc", "abort", "name_not_found", "gfx_printer_doc_is_busy", "print_failure", "not_available"'
