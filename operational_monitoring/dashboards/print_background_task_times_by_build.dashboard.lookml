...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "notimplemented", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "not_available", "print_failure", "name_not_found", "start_page", "startdoc", "no_printer", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
