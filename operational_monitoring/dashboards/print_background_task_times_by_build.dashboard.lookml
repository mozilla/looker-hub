...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "gfx_printer_doc_is_busy", "abort", "enddoc", "notimplemented", "cannot_open_file", "name_not_found", "not_available", "no_printer", "oom", "start_page", "startdoc"'
