...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "print_failure", "oom", "abort", "unexpected", "no_printer", "cannot_open_file", "enddoc", "startdoc", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
