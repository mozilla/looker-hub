...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "no_printer", "startdoc", "name_not_found", "gfx_printer_doc_is_busy", "unexpected", "oom", "not_available", "abort", "enddoc", "notimplemented", "print_failure", "cannot_open_file"'
