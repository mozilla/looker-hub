...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "no_printer", "enddoc", "notimplemented", "print_failure", "startdoc", "cannot_open_file", "unexpected", "oom", "not_available", "name_not_found", "abort", "start_page"'
