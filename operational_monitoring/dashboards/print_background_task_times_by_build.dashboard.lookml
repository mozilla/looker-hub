...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "start_page", "name_not_found", "oom", "not_available", "startdoc", "enddoc", "print_failure", "no_printer", "cannot_open_file", "gfx_printer_doc_is_busy", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
