...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "name_not_found", "startdoc", "not_available", "gfx_printer_doc_is_busy", "notimplemented", "oom", "print_failure", "no_printer", "start_page", "cannot_open_file", "unexpected", "abort"'
