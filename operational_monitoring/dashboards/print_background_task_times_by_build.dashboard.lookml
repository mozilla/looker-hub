...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "print_failure", "unexpected", "startdoc", "enddoc", "cannot_open_file", "abort", "no_printer", "notimplemented", "start_page", "gfx_printer_doc_is_busy", "oom", "name_not_found"'
