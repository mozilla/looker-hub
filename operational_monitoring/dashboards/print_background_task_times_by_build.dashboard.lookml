...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "print_failure", "unexpected", "name_not_found", "notimplemented", "not_available", "no_printer", "abort", "oom", "enddoc", "startdoc", "gfx_printer_doc_is_busy", "start_page"'
