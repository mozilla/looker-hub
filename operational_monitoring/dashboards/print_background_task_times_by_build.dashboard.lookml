...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "print_failure", "start_page", "abort", "oom", "notimplemented", "enddoc", "cannot_open_file", "unexpected", "not_available", "startdoc", "no_printer", "name_not_found"'
