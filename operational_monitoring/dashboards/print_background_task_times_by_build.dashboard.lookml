...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "cannot_open_file", "oom", "gfx_printer_doc_is_busy", "enddoc", "start_page", "name_not_found", "unexpected", "abort", "startdoc", "not_available", "print_failure", "notimplemented"'
