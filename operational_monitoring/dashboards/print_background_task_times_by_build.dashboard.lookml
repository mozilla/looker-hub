...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "unexpected", "notimplemented", "enddoc", "cannot_open_file", "abort", "gfx_printer_doc_is_busy", "not_available", "startdoc", "name_not_found", "oom", "print_failure", "no_printer"'
