...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "name_not_found", "enddoc", "oom", "notimplemented", "gfx_printer_doc_is_busy", "no_printer", "unexpected", "start_page", "cannot_open_file", "print_failure", "startdoc", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
