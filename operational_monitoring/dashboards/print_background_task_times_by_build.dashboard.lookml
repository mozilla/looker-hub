...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "abort", "unexpected", "start_page", "enddoc", "notimplemented", "oom", "cannot_open_file", "not_available", "startdoc", "name_not_found", "no_printer", "gfx_printer_doc_is_busy"'
