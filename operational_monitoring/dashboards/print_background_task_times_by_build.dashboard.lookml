...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "unexpected", "enddoc", "print_failure", "name_not_found", "no_printer", "oom", "startdoc", "start_page", "not_available", "cannot_open_file", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
