...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "start_page", "gfx_printer_doc_is_busy", "oom", "abort", "notimplemented", "name_not_found", "cannot_open_file", "print_failure", "enddoc", "unexpected", "not_available", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
