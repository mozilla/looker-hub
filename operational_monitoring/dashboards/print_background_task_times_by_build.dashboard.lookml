...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "print_failure", "oom", "no_printer", "unexpected", "abort", "cannot_open_file", "notimplemented", "enddoc", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
