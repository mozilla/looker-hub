...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "start_page", "no_printer", "oom", "gfx_printer_doc_is_busy", "startdoc", "notimplemented", "not_available", "abort", "print_failure", "name_not_found", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
