...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "print_failure", "not_available", "startdoc", "cannot_open_file", "abort", "start_page", "enddoc", "notimplemented", "unexpected", "gfx_printer_doc_is_busy", "name_not_found", "oom"'
