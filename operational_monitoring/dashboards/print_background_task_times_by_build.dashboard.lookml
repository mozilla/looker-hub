...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "startdoc", "notimplemented", "cannot_open_file", "unexpected", "print_failure", "not_available", "no_printer", "oom", "enddoc", "gfx_printer_doc_is_busy", "abort", "name_not_found"'
