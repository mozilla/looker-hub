...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "notimplemented", "abort", "name_not_found", "oom", "enddoc", "startdoc", "print_failure", "not_available", "gfx_printer_doc_is_busy", "start_page", "unexpected", "no_printer"'
