...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "not_available", "name_not_found", "start_page", "abort", "enddoc", "oom", "unexpected", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc"'
