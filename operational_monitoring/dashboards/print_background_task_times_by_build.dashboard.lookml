...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "name_not_found", "cannot_open_file", "oom", "gfx_printer_doc_is_busy", "startdoc", "start_page", "no_printer", "not_available", "print_failure", "abort", "unexpected", "enddoc"'
