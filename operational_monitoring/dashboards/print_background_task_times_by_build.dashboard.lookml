...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "start_page", "abort", "oom", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "notimplemented", "print_failure", "cannot_open_file", "not_available", "enddoc"'
