...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "oom", "name_not_found", "abort", "notimplemented", "print_failure", "start_page", "unexpected", "startdoc", "cannot_open_file", "not_available", "no_printer"'
