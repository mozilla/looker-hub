...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "startdoc", "not_available", "unexpected", "start_page", "abort", "notimplemented", "no_printer", "name_not_found", "print_failure", "oom", "gfx_printer_doc_is_busy", "cannot_open_file"'
