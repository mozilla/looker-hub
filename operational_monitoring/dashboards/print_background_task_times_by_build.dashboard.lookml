...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "abort", "startdoc", "cannot_open_file", "enddoc", "oom", "unexpected", "no_printer", "start_page", "notimplemented", "not_available", "name_not_found", "gfx_printer_doc_is_busy"'
