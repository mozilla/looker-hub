...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "no_printer", "gfx_printer_doc_is_busy", "enddoc", "not_available", "abort", "unexpected", "start_page", "oom", "startdoc", "name_not_found", "notimplemented"'
