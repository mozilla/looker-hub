...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "oom", "startdoc", "no_printer", "abort", "gfx_printer_doc_is_busy", "name_not_found", "not_available", "enddoc", "start_page", "notimplemented", "cannot_open_file"'
