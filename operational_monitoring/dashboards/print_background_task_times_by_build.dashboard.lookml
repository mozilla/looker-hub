...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "abort", "startdoc", "print_failure", "not_available", "oom", "enddoc", "notimplemented", "start_page", "no_printer", "cannot_open_file", "gfx_printer_doc_is_busy"'
