...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "cannot_open_file", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "start_page", "not_available", "enddoc", "abort", "print_failure", "no_printer", "oom"'
