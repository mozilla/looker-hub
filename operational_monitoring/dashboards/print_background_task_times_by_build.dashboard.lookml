...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "oom", "cannot_open_file", "name_not_found", "no_printer", "startdoc", "start_page", "gfx_printer_doc_is_busy", "not_available", "unexpected", "print_failure", "notimplemented", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
