...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "enddoc", "gfx_printer_doc_is_busy", "unexpected", "print_failure", "not_available", "name_not_found", "start_page", "notimplemented", "oom", "startdoc", "no_printer", "cannot_open_file"'
