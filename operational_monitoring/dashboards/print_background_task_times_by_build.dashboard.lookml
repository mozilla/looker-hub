...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "not_available", "name_not_found", "no_printer", "startdoc", "notimplemented", "cannot_open_file", "start_page", "oom", "abort", "print_failure", "gfx_printer_doc_is_busy", "enddoc"'
