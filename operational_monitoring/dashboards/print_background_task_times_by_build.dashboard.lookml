...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "no_printer", "abort", "notimplemented", "oom", "cannot_open_file", "start_page", "not_available", "name_not_found", "startdoc", "print_failure", "unexpected"'
