...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "start_page", "abort", "notimplemented", "name_not_found", "not_available", "cannot_open_file", "oom", "print_failure", "enddoc", "startdoc", "unexpected", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
