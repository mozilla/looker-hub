...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "start_page", "oom", "enddoc", "print_failure", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "abort", "notimplemented", "startdoc", "not_available", "no_printer"'
