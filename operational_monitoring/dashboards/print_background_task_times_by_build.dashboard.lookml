...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "start_page", "print_failure", "cannot_open_file", "not_available", "abort", "notimplemented", "name_not_found", "unexpected", "no_printer", "gfx_printer_doc_is_busy", "startdoc", "oom"'
