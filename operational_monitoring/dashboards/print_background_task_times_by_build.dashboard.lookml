...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "not_available", "cannot_open_file", "startdoc", "abort", "notimplemented", "enddoc", "no_printer", "oom", "start_page", "unexpected", "name_not_found", "gfx_printer_doc_is_busy"'
