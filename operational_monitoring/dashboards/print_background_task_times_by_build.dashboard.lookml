...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "no_printer", "cannot_open_file", "print_failure", "not_available", "unexpected", "startdoc", "oom", "abort", "notimplemented", "enddoc", "name_not_found", "gfx_printer_doc_is_busy"'
