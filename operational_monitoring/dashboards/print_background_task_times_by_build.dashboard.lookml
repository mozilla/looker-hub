...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "cannot_open_file", "notimplemented", "enddoc", "unexpected", "no_printer", "startdoc", "oom", "gfx_printer_doc_is_busy", "name_not_found", "start_page", "print_failure", "not_available"'
