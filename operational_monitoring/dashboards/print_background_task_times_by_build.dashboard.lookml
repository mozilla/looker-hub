...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "notimplemented", "not_available", "oom", "cannot_open_file", "gfx_printer_doc_is_busy", "unexpected", "abort", "print_failure", "no_printer", "startdoc", "enddoc"'
