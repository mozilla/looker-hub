...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "unexpected", "cannot_open_file", "not_available", "gfx_printer_doc_is_busy", "abort", "oom", "notimplemented", "start_page", "startdoc", "print_failure", "enddoc", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
