...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "gfx_printer_doc_is_busy", "no_printer", "oom", "cannot_open_file", "print_failure", "start_page", "not_available", "abort", "unexpected", "startdoc", "name_not_found"'
