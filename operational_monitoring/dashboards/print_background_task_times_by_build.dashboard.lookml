...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "oom", "enddoc", "no_printer", "cannot_open_file", "startdoc", "start_page", "notimplemented", "not_available", "gfx_printer_doc_is_busy", "abort", "unexpected", "print_failure"'
