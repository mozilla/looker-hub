...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "cannot_open_file", "gfx_printer_doc_is_busy", "not_available", "startdoc", "enddoc", "unexpected", "start_page", "no_printer", "notimplemented", "print_failure", "oom", "name_not_found"'
