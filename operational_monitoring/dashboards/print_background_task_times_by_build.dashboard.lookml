...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "print_failure", "name_not_found", "abort", "start_page", "enddoc", "not_available", "gfx_printer_doc_is_busy", "startdoc", "no_printer", "notimplemented", "unexpected", "cannot_open_file"'
