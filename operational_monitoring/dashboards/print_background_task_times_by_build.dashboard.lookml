...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "oom", "gfx_printer_doc_is_busy", "unexpected", "not_available", "name_not_found", "cannot_open_file", "print_failure", "enddoc", "notimplemented", "start_page", "startdoc", "abort"'
