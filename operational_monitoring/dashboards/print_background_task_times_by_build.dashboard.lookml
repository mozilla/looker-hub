...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "abort", "gfx_printer_doc_is_busy", "enddoc", "print_failure", "not_available", "start_page", "notimplemented", "startdoc", "name_not_found", "unexpected", "oom", "cannot_open_file"'
