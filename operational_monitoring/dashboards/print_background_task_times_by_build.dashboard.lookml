...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "cannot_open_file", "not_available", "start_page", "startdoc", "gfx_printer_doc_is_busy", "no_printer", "notimplemented", "oom", "abort", "name_not_found", "print_failure"'
