...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "start_page", "unexpected", "enddoc", "abort", "notimplemented", "no_printer", "cannot_open_file", "oom", "print_failure", "gfx_printer_doc_is_busy", "not_available", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
