...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "not_available", "no_printer", "print_failure", "gfx_printer_doc_is_busy", "notimplemented", "startdoc", "abort", "name_not_found", "enddoc", "unexpected", "oom", "cannot_open_file"'
