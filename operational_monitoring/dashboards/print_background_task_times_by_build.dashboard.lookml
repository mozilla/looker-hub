...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "abort", "no_printer", "startdoc", "enddoc", "notimplemented", "unexpected", "oom", "not_available", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
