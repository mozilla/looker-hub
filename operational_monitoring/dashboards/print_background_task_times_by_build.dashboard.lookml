...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "startdoc", "enddoc", "not_available", "gfx_printer_doc_is_busy", "oom", "start_page", "no_printer", "unexpected", "name_not_found", "abort", "notimplemented", "cannot_open_file"'
