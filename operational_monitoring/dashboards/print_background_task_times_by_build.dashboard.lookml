...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "unexpected", "gfx_printer_doc_is_busy", "cannot_open_file", "oom", "name_not_found", "print_failure", "start_page", "enddoc", "notimplemented", "no_printer", "startdoc", "not_available"'
