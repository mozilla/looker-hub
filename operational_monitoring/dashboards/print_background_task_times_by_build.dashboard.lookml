...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "start_page", "abort", "name_not_found", "no_printer", "unexpected", "print_failure", "oom", "not_available", "cannot_open_file", "gfx_printer_doc_is_busy", "startdoc"'
