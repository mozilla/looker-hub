...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "not_available", "gfx_printer_doc_is_busy", "startdoc", "oom", "no_printer", "enddoc", "notimplemented", "unexpected", "cannot_open_file", "abort", "print_failure", "name_not_found"'
