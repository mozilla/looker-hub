...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "print_failure", "enddoc", "cannot_open_file", "unexpected", "gfx_printer_doc_is_busy", "name_not_found", "startdoc", "start_page", "oom", "abort", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
