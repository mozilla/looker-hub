...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "unexpected", "print_failure", "name_not_found", "abort", "gfx_printer_doc_is_busy", "enddoc", "startdoc", "start_page", "not_available", "notimplemented", "oom", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
