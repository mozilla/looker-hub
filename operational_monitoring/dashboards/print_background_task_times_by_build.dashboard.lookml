...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "start_page", "enddoc", "abort", "no_printer", "unexpected", "notimplemented", "not_available", "cannot_open_file", "name_not_found", "print_failure", "oom", "gfx_printer_doc_is_busy"'
