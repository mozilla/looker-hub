...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "name_not_found", "unexpected", "abort", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "notimplemented", "not_available", "no_printer", "enddoc", "start_page", "print_failure"'
