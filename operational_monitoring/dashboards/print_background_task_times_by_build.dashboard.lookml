...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "enddoc", "cannot_open_file", "not_available", "abort", "oom", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "unexpected", "start_page", "notimplemented", "print_failure"'
