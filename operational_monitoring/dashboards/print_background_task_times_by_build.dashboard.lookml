...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "name_not_found", "enddoc", "not_available", "no_printer", "start_page", "notimplemented", "abort", "unexpected", "oom", "startdoc", "gfx_printer_doc_is_busy"'
