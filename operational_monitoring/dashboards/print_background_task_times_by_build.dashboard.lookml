...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "not_available", "start_page", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "notimplemented", "abort", "enddoc", "startdoc", "cannot_open_file", "oom"'
