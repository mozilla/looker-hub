...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "cannot_open_file", "name_not_found", "start_page", "print_failure", "startdoc", "abort", "gfx_printer_doc_is_busy", "oom", "no_printer", "not_available", "unexpected", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
