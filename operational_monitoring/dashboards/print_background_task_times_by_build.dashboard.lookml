...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "print_failure", "abort", "oom", "no_printer", "unexpected", "name_not_found", "start_page", "not_available", "enddoc", "gfx_printer_doc_is_busy", "cannot_open_file"'
