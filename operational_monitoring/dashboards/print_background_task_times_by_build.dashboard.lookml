...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "notimplemented", "name_not_found", "enddoc", "abort", "not_available", "cannot_open_file", "startdoc", "print_failure", "oom", "unexpected", "no_printer", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
