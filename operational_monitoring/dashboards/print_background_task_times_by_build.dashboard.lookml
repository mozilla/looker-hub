...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "oom", "print_failure", "no_printer", "cannot_open_file", "name_not_found", "startdoc", "notimplemented", "not_available", "enddoc", "unexpected", "start_page", "gfx_printer_doc_is_busy"'
