...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "gfx_printer_doc_is_busy", "abort", "not_available", "start_page", "startdoc", "enddoc", "cannot_open_file", "no_printer", "notimplemented", "print_failure", "name_not_found", "unexpected"'
