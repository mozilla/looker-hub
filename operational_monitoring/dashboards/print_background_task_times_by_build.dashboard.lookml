...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "name_not_found", "cannot_open_file", "enddoc", "notimplemented", "print_failure", "startdoc", "oom", "unexpected", "no_printer", "start_page", "gfx_printer_doc_is_busy", "abort"'
