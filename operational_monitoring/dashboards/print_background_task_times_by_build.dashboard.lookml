...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "start_page", "name_not_found", "no_printer", "startdoc", "gfx_printer_doc_is_busy", "notimplemented", "cannot_open_file", "not_available", "abort", "enddoc", "print_failure", "oom"'
