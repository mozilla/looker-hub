...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "enddoc", "unexpected", "gfx_printer_doc_is_busy", "no_printer", "print_failure", "name_not_found", "notimplemented", "not_available", "startdoc", "abort", "oom", "cannot_open_file"'
