...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "start_page", "print_failure", "unexpected", "no_printer", "oom", "not_available", "name_not_found", "startdoc", "gfx_printer_doc_is_busy", "cannot_open_file", "abort", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
