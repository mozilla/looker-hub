...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "not_available", "enddoc", "gfx_printer_doc_is_busy", "start_page", "oom", "cannot_open_file", "no_printer", "notimplemented", "abort", "unexpected", "startdoc"'
