...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "startdoc", "oom", "name_not_found", "cannot_open_file", "unexpected", "enddoc", "print_failure", "notimplemented", "not_available", "abort", "gfx_printer_doc_is_busy", "no_printer"'
