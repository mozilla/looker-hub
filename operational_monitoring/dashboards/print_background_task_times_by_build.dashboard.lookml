...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "gfx_printer_doc_is_busy", "name_not_found", "enddoc", "print_failure", "unexpected", "not_available", "oom", "notimplemented", "start_page", "no_printer", "abort", "cannot_open_file"'
