...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "abort", "oom", "no_printer", "enddoc", "notimplemented", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc", "not_available", "print_failure"'
