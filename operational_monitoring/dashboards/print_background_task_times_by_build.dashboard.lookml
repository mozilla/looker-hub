...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "gfx_printer_doc_is_busy", "cannot_open_file", "notimplemented", "start_page", "unexpected", "oom", "print_failure", "abort", "no_printer", "not_available", "name_not_found", "enddoc"'
