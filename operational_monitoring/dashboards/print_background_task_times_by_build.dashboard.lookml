...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "abort", "not_available", "enddoc", "startdoc", "start_page", "notimplemented", "gfx_printer_doc_is_busy", "print_failure", "name_not_found", "unexpected", "cannot_open_file", "no_printer"'
