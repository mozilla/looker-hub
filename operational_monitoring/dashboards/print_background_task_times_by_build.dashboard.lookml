...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "start_page", "oom", "no_printer", "not_available", "cannot_open_file", "notimplemented", "print_failure", "enddoc", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "abort"'
