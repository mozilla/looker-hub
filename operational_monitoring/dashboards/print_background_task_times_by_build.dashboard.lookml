...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "cannot_open_file", "not_available", "print_failure", "start_page", "unexpected", "abort", "gfx_printer_doc_is_busy", "notimplemented", "startdoc", "no_printer", "enddoc", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
