...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "no_printer", "oom", "notimplemented", "startdoc", "not_available", "enddoc", "abort", "name_not_found", "cannot_open_file", "print_failure", "start_page", "gfx_printer_doc_is_busy"'
