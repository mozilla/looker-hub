...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "abort", "enddoc", "not_available", "gfx_printer_doc_is_busy", "start_page", "startdoc", "unexpected", "notimplemented", "no_printer", "oom", "cannot_open_file", "name_not_found"'
