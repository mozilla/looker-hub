...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "notimplemented", "print_failure", "startdoc", "unexpected", "cannot_open_file", "no_printer", "abort", "enddoc", "name_not_found", "gfx_printer_doc_is_busy", "not_available", "oom"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
