...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "startdoc", "notimplemented", "unexpected", "oom", "not_available", "cannot_open_file", "abort", "enddoc", "start_page", "print_failure", "gfx_printer_doc_is_busy", "name_not_found"'
