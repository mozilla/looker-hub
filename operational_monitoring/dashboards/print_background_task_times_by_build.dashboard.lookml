...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "unexpected", "startdoc", "start_page", "cannot_open_file", "print_failure", "notimplemented", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "oom", "abort", "name_not_found"'
