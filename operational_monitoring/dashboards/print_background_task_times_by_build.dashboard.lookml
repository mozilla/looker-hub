...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "unexpected", "notimplemented", "start_page", "name_not_found", "not_available", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "abort", "oom", "print_failure", "enddoc"'
