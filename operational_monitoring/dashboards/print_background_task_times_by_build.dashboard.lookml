...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "not_available", "notimplemented", "no_printer", "start_page", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "startdoc", "abort", "oom", "name_not_found", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
