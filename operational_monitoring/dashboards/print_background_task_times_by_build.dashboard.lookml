...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "no_printer", "unexpected", "cannot_open_file", "start_page", "abort", "gfx_printer_doc_is_busy", "oom", "notimplemented", "name_not_found", "startdoc", "not_available"'
