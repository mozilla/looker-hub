...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "name_not_found", "startdoc", "no_printer", "gfx_printer_doc_is_busy", "enddoc", "start_page", "print_failure", "not_available", "oom", "cannot_open_file", "unexpected", "abort"'
