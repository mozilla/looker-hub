...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "abort", "name_not_found", "not_available", "print_failure", "gfx_printer_doc_is_busy", "unexpected", "enddoc", "notimplemented", "oom", "start_page", "startdoc"'
