...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "start_page", "cannot_open_file", "abort", "no_printer", "notimplemented", "oom", "enddoc", "not_available", "name_not_found", "startdoc", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
