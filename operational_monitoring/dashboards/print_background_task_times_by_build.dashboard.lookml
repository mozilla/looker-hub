...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "unexpected", "cannot_open_file", "oom", "no_printer", "name_not_found", "start_page", "abort", "startdoc", "notimplemented", "print_failure", "not_available"'
