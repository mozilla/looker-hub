...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "gfx_printer_doc_is_busy", "abort", "cannot_open_file", "unexpected", "print_failure", "startdoc", "enddoc", "start_page", "name_not_found", "not_available", "oom"'
