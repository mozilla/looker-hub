...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "oom", "unexpected", "cannot_open_file", "startdoc", "notimplemented", "name_not_found", "abort", "no_printer", "gfx_printer_doc_is_busy", "start_page", "not_available", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
