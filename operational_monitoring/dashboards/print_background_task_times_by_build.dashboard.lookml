...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "oom", "notimplemented", "no_printer", "abort", "name_not_found", "startdoc", "not_available", "unexpected", "cannot_open_file", "print_failure", "start_page"'
