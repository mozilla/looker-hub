...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "not_available", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "enddoc", "startdoc", "name_not_found", "start_page", "unexpected", "notimplemented", "oom", "abort"'
