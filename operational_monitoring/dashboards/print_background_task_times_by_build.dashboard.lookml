...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "start_page", "oom", "name_not_found", "enddoc", "no_printer", "print_failure", "gfx_printer_doc_is_busy", "startdoc", "abort", "notimplemented", "not_available", "unexpected"'
