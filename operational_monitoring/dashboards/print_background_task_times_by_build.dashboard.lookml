...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "startdoc", "oom", "gfx_printer_doc_is_busy", "not_available", "no_printer", "abort", "start_page", "enddoc", "name_not_found", "cannot_open_file", "unexpected", "print_failure"'
