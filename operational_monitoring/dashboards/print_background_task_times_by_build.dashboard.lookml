...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "start_page", "notimplemented", "print_failure", "unexpected", "cannot_open_file", "no_printer", "enddoc", "not_available", "oom", "name_not_found", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
