...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "name_not_found", "cannot_open_file", "unexpected", "start_page", "abort", "print_failure", "notimplemented", "enddoc", "oom", "gfx_printer_doc_is_busy", "not_available"'
