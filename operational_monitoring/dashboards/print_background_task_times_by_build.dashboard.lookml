...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "abort", "not_available", "gfx_printer_doc_is_busy", "unexpected", "no_printer", "startdoc", "cannot_open_file", "notimplemented", "name_not_found", "print_failure", "oom", "enddoc"'
