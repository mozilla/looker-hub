...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "oom", "unexpected", "no_printer", "name_not_found", "not_available", "cannot_open_file", "print_failure", "startdoc", "start_page", "abort", "gfx_printer_doc_is_busy"'
