...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "start_page", "oom", "enddoc", "notimplemented", "name_not_found", "unexpected", "abort", "gfx_printer_doc_is_busy", "not_available", "cannot_open_file", "print_failure"'
