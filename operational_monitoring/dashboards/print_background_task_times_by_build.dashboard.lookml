...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "cannot_open_file", "startdoc", "no_printer", "enddoc", "notimplemented", "oom", "print_failure", "not_available", "name_not_found", "start_page", "gfx_printer_doc_is_busy"'
