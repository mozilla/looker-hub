...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "abort", "not_available", "gfx_printer_doc_is_busy", "unexpected", "name_not_found", "oom", "enddoc", "print_failure", "no_printer", "cannot_open_file", "notimplemented", "start_page"'
