...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "gfx_printer_doc_is_busy", "name_not_found", "abort", "print_failure", "notimplemented", "not_available", "oom", "no_printer", "startdoc", "cannot_open_file", "start_page"'
