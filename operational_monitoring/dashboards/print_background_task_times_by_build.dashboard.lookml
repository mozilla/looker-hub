...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "print_failure", "gfx_printer_doc_is_busy", "enddoc", "start_page", "no_printer", "cannot_open_file", "startdoc", "unexpected", "notimplemented", "not_available", "name_not_found", "oom"'
