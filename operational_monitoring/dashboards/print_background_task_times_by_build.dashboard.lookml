...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "unexpected", "print_failure", "no_printer", "not_available", "notimplemented", "name_not_found", "start_page", "cannot_open_file", "abort", "startdoc", "gfx_printer_doc_is_busy", "enddoc"'
