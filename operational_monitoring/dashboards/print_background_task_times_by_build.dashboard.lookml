...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "not_available", "name_not_found", "abort", "oom", "start_page", "startdoc", "enddoc", "notimplemented", "print_failure", "unexpected", "gfx_printer_doc_is_busy"'
