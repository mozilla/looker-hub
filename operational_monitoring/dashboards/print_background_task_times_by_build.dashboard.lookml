...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "unexpected", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "oom", "abort", "no_printer", "notimplemented", "not_available", "enddoc", "cannot_open_file", "startdoc"'
