...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "oom", "print_failure", "start_page", "abort", "not_available", "cannot_open_file", "unexpected", "name_not_found", "notimplemented", "startdoc", "gfx_printer_doc_is_busy", "enddoc"'
