...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "enddoc", "not_available", "print_failure", "abort", "oom", "no_printer", "startdoc", "unexpected", "name_not_found", "start_page", "notimplemented", "cannot_open_file"'
