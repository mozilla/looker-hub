...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "no_printer", "not_available", "enddoc", "start_page", "abort", "name_not_found", "unexpected", "oom", "cannot_open_file"'
