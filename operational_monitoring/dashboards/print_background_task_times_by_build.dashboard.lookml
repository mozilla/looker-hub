...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "gfx_printer_doc_is_busy", "notimplemented", "oom", "abort", "unexpected", "startdoc", "no_printer", "print_failure", "not_available", "cannot_open_file", "start_page", "enddoc"'
