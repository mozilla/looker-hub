...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "oom", "unexpected", "gfx_printer_doc_is_busy", "not_available", "startdoc", "enddoc", "notimplemented", "no_printer", "cannot_open_file", "name_not_found", "print_failure", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
