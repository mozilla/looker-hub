...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "enddoc", "start_page", "notimplemented", "name_not_found", "no_printer", "print_failure", "not_available", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "oom"'
