...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "unexpected", "cannot_open_file", "start_page", "gfx_printer_doc_is_busy", "startdoc", "notimplemented", "no_printer", "name_not_found", "enddoc", "print_failure", "oom", "abort"'
