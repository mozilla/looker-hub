...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "name_not_found", "print_failure", "cannot_open_file", "unexpected", "oom", "startdoc", "not_available", "enddoc", "no_printer", "gfx_printer_doc_is_busy", "start_page", "notimplemented"'
