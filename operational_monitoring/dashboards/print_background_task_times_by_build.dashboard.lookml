...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "abort", "notimplemented", "oom", "start_page", "startdoc", "name_not_found", "unexpected", "enddoc", "no_printer", "cannot_open_file", "not_available"'
