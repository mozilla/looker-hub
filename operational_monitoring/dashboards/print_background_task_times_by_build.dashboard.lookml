...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "startdoc", "start_page", "print_failure", "abort", "name_not_found", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "notimplemented", "oom", "unexpected", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
