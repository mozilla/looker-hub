...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "enddoc", "abort", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "oom", "print_failure", "notimplemented", "no_printer", "start_page", "unexpected"'
