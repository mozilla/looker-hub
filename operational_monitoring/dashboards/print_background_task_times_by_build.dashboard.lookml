...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "cannot_open_file", "start_page", "print_failure", "startdoc", "notimplemented", "unexpected", "name_not_found", "not_available", "gfx_printer_doc_is_busy", "oom", "no_printer", "enddoc"'
