...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "abort", "oom", "start_page", "name_not_found", "not_available", "no_printer", "notimplemented", "cannot_open_file", "startdoc", "print_failure", "gfx_printer_doc_is_busy"'
