...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "oom", "name_not_found", "unexpected", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc", "notimplemented", "abort", "start_page", "enddoc", "print_failure", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
