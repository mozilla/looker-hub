...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "unexpected", "name_not_found", "enddoc", "notimplemented", "print_failure", "abort", "startdoc", "no_printer", "gfx_printer_doc_is_busy", "start_page", "not_available", "oom"'
