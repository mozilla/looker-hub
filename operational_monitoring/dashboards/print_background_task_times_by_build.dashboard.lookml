...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "cannot_open_file", "notimplemented", "unexpected", "gfx_printer_doc_is_busy", "oom", "abort", "enddoc", "not_available", "startdoc", "no_printer", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
