...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "name_not_found", "abort", "not_available", "cannot_open_file", "oom", "notimplemented", "enddoc", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
