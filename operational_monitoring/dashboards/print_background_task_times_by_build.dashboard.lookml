...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "startdoc", "notimplemented", "cannot_open_file", "enddoc", "start_page", "oom", "abort", "unexpected", "print_failure", "name_not_found", "not_available", "gfx_printer_doc_is_busy"'
