...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "no_printer", "startdoc", "start_page", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "oom", "abort", "not_available", "name_not_found", "cannot_open_file", "enddoc"'
