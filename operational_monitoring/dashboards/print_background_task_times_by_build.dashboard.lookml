...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "name_not_found", "start_page", "not_available", "cannot_open_file", "unexpected", "print_failure", "startdoc", "oom", "no_printer", "abort", "enddoc", "notimplemented"'
