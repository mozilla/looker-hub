...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "unexpected", "cannot_open_file", "print_failure", "not_available", "enddoc", "notimplemented", "start_page", "startdoc", "abort", "gfx_printer_doc_is_busy", "oom", "no_printer"'
