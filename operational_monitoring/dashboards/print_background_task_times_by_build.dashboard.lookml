...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "unexpected", "name_not_found", "startdoc", "notimplemented", "not_available", "oom", "abort", "gfx_printer_doc_is_busy", "no_printer", "enddoc", "print_failure", "start_page"'
