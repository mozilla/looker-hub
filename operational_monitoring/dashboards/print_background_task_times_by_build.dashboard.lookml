...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "name_not_found", "print_failure", "cannot_open_file", "gfx_printer_doc_is_busy", "not_available", "startdoc", "abort", "unexpected", "oom", "start_page", "enddoc"'
