...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "gfx_printer_doc_is_busy", "unexpected", "name_not_found", "enddoc", "abort", "print_failure", "notimplemented", "oom", "no_printer", "startdoc", "cannot_open_file"'
