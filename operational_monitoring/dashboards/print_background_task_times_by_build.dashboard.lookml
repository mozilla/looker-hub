...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "cannot_open_file", "not_available", "name_not_found", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "abort", "notimplemented", "start_page", "oom"'
