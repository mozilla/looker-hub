...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "not_available", "enddoc", "no_printer", "startdoc", "print_failure", "notimplemented", "oom", "unexpected", "name_not_found", "start_page", "abort", "cannot_open_file"'
