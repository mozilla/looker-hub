...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "cannot_open_file", "oom", "no_printer", "print_failure", "notimplemented", "enddoc", "not_available", "unexpected", "abort", "startdoc", "name_not_found", "gfx_printer_doc_is_busy"'
