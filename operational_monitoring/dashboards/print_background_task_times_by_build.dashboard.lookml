...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "print_failure", "gfx_printer_doc_is_busy", "enddoc", "oom", "cannot_open_file", "no_printer", "start_page", "abort", "startdoc", "name_not_found", "notimplemented", "not_available"'
