...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "cannot_open_file", "notimplemented", "oom", "start_page", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "print_failure", "abort", "no_printer", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
