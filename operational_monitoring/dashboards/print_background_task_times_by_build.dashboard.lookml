...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "start_page", "gfx_printer_doc_is_busy", "no_printer", "notimplemented", "abort", "cannot_open_file", "oom", "name_not_found", "print_failure", "startdoc", "not_available"'
