...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "start_page", "notimplemented", "oom", "not_available", "startdoc", "no_printer", "abort", "gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "unexpected", "name_not_found"'
