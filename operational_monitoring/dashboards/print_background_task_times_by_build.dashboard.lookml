...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "gfx_printer_doc_is_busy", "start_page", "not_available", "name_not_found", "oom", "abort", "no_printer", "print_failure", "notimplemented", "enddoc", "cannot_open_file", "startdoc"'
