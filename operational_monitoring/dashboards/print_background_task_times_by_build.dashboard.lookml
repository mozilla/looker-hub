...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "oom", "unexpected", "not_available", "startdoc", "enddoc", "name_not_found", "no_printer", "abort", "start_page", "print_failure", "gfx_printer_doc_is_busy", "cannot_open_file"'
