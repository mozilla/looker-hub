...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "oom", "name_not_found", "enddoc", "no_printer", "cannot_open_file", "startdoc", "print_failure", "start_page", "abort", "notimplemented", "not_available", "unexpected"'
