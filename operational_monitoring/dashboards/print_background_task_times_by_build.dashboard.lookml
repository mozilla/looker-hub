...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "abort", "enddoc", "oom", "gfx_printer_doc_is_busy", "no_printer", "startdoc", "unexpected", "print_failure", "start_page", "cannot_open_file", "name_not_found"'
