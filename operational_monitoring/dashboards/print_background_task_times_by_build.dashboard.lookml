...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "not_available", "no_printer", "start_page", "name_not_found", "startdoc", "enddoc", "oom", "abort", "gfx_printer_doc_is_busy", "unexpected", "notimplemented"'
