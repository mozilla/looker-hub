...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "name_not_found", "abort", "startdoc", "enddoc", "no_printer", "start_page", "not_available", "unexpected", "gfx_printer_doc_is_busy", "cannot_open_file", "oom"'
