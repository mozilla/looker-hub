...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "cannot_open_file", "abort", "start_page", "startdoc", "not_available", "enddoc", "print_failure", "unexpected", "oom"'
