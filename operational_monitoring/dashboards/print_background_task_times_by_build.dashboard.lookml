...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "gfx_printer_doc_is_busy", "print_failure", "name_not_found", "unexpected", "abort", "enddoc", "notimplemented", "start_page", "no_printer", "startdoc", "oom", "cannot_open_file"'
