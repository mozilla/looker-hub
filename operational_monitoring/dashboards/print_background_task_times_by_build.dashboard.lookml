...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "no_printer", "enddoc", "abort", "start_page", "print_failure", "name_not_found", "notimplemented", "not_available", "oom", "unexpected", "cannot_open_file", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
