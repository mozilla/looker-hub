...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "cannot_open_file", "unexpected", "oom", "start_page", "startdoc", "abort", "gfx_printer_doc_is_busy", "enddoc", "notimplemented", "print_failure", "name_not_found"'
