...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "print_failure", "no_printer", "notimplemented", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "start_page", "name_not_found", "enddoc", "cannot_open_file", "oom", "abort"'
