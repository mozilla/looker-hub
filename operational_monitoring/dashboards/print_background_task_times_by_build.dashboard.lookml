...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "gfx_printer_doc_is_busy", "unexpected", "no_printer", "start_page", "oom", "print_failure", "name_not_found", "notimplemented", "enddoc", "abort", "startdoc", "cannot_open_file"'
