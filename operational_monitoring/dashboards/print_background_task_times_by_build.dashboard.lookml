...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "cannot_open_file", "print_failure", "oom", "abort", "no_printer", "unexpected", "startdoc", "enddoc", "name_not_found", "gfx_printer_doc_is_busy", "start_page", "notimplemented"'
