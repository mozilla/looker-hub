...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "notimplemented", "enddoc", "not_available", "no_printer", "print_failure", "name_not_found", "unexpected", "cannot_open_file", "oom", "abort", "gfx_printer_doc_is_busy", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
