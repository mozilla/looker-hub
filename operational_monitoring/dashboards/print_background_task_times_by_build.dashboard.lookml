...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "start_page", "abort", "name_not_found", "startdoc", "print_failure", "gfx_printer_doc_is_busy", "oom", "no_printer", "unexpected", "not_available", "cannot_open_file", "enddoc"'
