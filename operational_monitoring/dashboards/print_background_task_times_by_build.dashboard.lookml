...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "print_failure", "startdoc", "gfx_printer_doc_is_busy", "not_available", "name_not_found", "notimplemented", "oom", "enddoc", "start_page", "abort", "cannot_open_file", "unexpected"'
