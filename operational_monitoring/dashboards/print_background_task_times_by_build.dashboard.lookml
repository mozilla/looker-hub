...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "cannot_open_file", "oom", "print_failure", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "startdoc", "enddoc", "start_page", "notimplemented", "no_printer", "unexpected"'
