...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "not_available", "unexpected", "notimplemented", "cannot_open_file", "abort", "gfx_printer_doc_is_busy", "startdoc", "oom", "start_page", "name_not_found", "no_printer"'
