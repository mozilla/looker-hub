...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "cannot_open_file", "start_page", "oom", "abort", "startdoc", "unexpected", "enddoc", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
