...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "start_page", "name_not_found", "gfx_printer_doc_is_busy", "abort", "startdoc", "no_printer", "not_available", "unexpected", "enddoc", "oom", "print_failure", "notimplemented"'
