...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "print_failure", "not_available", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "oom", "notimplemented", "start_page", "abort", "cannot_open_file", "no_printer", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
