...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "enddoc", "abort", "unexpected", "startdoc", "not_available", "name_not_found", "start_page", "oom", "cannot_open_file", "gfx_printer_doc_is_busy", "notimplemented", "print_failure"'
