...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "not_available", "oom", "start_page", "enddoc", "unexpected", "abort", "name_not_found", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "notimplemented", "print_failure"'
