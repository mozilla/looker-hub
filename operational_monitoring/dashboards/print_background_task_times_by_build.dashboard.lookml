...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "enddoc", "name_not_found", "abort", "start_page", "unexpected", "notimplemented", "print_failure", "cannot_open_file", "not_available", "startdoc", "gfx_printer_doc_is_busy", "no_printer"'
