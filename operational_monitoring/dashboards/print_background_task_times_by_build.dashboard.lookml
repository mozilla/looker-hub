...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "enddoc", "start_page", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "unexpected", "not_available", "abort", "oom", "startdoc", "no_printer", "name_not_found"'
