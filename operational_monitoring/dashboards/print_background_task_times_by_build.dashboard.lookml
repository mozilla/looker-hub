...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "startdoc", "oom", "not_available", "no_printer", "cannot_open_file", "start_page", "abort", "unexpected", "enddoc", "print_failure", "name_not_found"'
