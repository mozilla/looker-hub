...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "abort", "oom", "no_printer", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "not_available", "enddoc", "notimplemented", "name_not_found", "start_page"'
