...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "start_page", "gfx_printer_doc_is_busy", "enddoc", "name_not_found", "unexpected", "notimplemented", "startdoc", "cannot_open_file", "oom", "print_failure", "abort"'
