...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "startdoc", "oom", "gfx_printer_doc_is_busy", "start_page", "abort", "no_printer", "enddoc", "notimplemented", "cannot_open_file", "name_not_found", "print_failure", "unexpected"'
