...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "oom", "print_failure", "not_available", "no_printer", "start_page", "gfx_printer_doc_is_busy", "unexpected", "cannot_open_file", "startdoc", "abort", "name_not_found"'
