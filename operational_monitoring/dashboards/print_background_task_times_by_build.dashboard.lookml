...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "abort", "enddoc", "unexpected", "cannot_open_file", "oom", "notimplemented", "name_not_found", "no_printer", "startdoc", "start_page", "gfx_printer_doc_is_busy", "not_available"'
