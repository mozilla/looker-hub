...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "cannot_open_file", "oom", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "name_not_found", "unexpected", "no_printer", "abort", "notimplemented", "enddoc", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
