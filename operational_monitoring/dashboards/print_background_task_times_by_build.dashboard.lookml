...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "cannot_open_file", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "abort", "oom", "startdoc", "enddoc", "start_page", "not_available", "unexpected"'
