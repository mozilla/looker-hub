...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "oom", "name_not_found", "start_page", "print_failure", "abort", "notimplemented", "unexpected", "cannot_open_file", "startdoc", "enddoc", "not_available", "no_printer"'
