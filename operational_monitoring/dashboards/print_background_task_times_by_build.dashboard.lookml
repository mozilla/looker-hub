...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "print_failure", "startdoc", "cannot_open_file", "start_page", "abort", "notimplemented", "name_not_found", "oom", "gfx_printer_doc_is_busy", "not_available", "no_printer"'
