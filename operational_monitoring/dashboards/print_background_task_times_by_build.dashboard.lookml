...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "unexpected", "gfx_printer_doc_is_busy", "cannot_open_file", "print_failure", "abort", "not_available", "enddoc", "name_not_found", "start_page", "oom", "startdoc", "notimplemented"'
