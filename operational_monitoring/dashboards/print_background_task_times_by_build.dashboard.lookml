...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "unexpected", "start_page", "oom", "enddoc", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "name_not_found", "startdoc", "abort", "notimplemented", "print_failure"'
