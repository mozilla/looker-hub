...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "cannot_open_file", "abort", "gfx_printer_doc_is_busy", "notimplemented", "enddoc", "no_printer", "startdoc", "name_not_found", "print_failure", "oom", "unexpected"'
