...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "gfx_printer_doc_is_busy", "print_failure", "start_page", "abort", "enddoc", "notimplemented", "not_available", "cannot_open_file", "name_not_found", "oom", "unexpected", "no_printer"'
