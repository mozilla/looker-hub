...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "not_available", "no_printer", "cannot_open_file", "startdoc", "print_failure", "start_page", "gfx_printer_doc_is_busy", "notimplemented", "enddoc", "oom", "unexpected"'
