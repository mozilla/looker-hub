...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "no_printer", "notimplemented", "unexpected", "cannot_open_file", "startdoc", "name_not_found", "print_failure", "gfx_printer_doc_is_busy", "start_page", "oom", "not_available", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
