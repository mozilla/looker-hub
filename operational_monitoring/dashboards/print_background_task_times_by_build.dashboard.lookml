...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "not_available", "unexpected", "name_not_found", "start_page", "oom", "notimplemented", "cannot_open_file", "enddoc", "abort", "gfx_printer_doc_is_busy", "print_failure", "no_printer"'
