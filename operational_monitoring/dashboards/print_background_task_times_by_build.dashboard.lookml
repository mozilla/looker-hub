...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "print_failure", "abort", "oom", "enddoc", "start_page", "gfx_printer_doc_is_busy", "notimplemented", "cannot_open_file", "name_not_found", "unexpected", "no_printer", "not_available"'
