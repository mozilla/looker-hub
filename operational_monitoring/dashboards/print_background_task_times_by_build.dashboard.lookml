...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "no_printer", "start_page", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "oom", "not_available", "startdoc", "print_failure", "cannot_open_file", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
