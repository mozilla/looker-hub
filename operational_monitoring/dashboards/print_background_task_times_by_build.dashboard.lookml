...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "gfx_printer_doc_is_busy", "notimplemented", "oom", "startdoc", "name_not_found", "enddoc", "print_failure", "no_printer", "unexpected", "not_available", "start_page"'
