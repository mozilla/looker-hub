...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "oom", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "startdoc", "start_page", "print_failure", "name_not_found", "notimplemented", "unexpected", "not_available", "abort"'
