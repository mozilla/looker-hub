...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "startdoc", "enddoc", "not_available", "start_page", "oom", "notimplemented", "no_printer", "abort", "name_not_found"'
