...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "no_printer", "gfx_printer_doc_is_busy", "print_failure", "name_not_found", "notimplemented", "cannot_open_file", "startdoc", "not_available", "start_page", "abort", "unexpected", "enddoc"'
