...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "print_failure", "abort", "notimplemented", "cannot_open_file", "enddoc", "oom", "start_page", "gfx_printer_doc_is_busy", "unexpected", "startdoc", "no_printer", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
