...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "print_failure", "startdoc", "enddoc", "oom", "not_available", "unexpected", "cannot_open_file", "no_printer", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "abort"'
