...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "enddoc", "no_printer", "abort", "cannot_open_file", "startdoc", "start_page", "not_available", "oom", "name_not_found", "notimplemented", "print_failure", "unexpected"'
