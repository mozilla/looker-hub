...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "no_printer", "print_failure", "cannot_open_file", "name_not_found", "notimplemented", "oom", "gfx_printer_doc_is_busy", "startdoc", "enddoc", "unexpected", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
