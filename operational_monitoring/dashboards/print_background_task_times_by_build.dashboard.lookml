...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "cannot_open_file", "abort", "notimplemented", "name_not_found", "enddoc", "print_failure", "oom", "startdoc", "unexpected", "start_page", "gfx_printer_doc_is_busy", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
