...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "start_page", "notimplemented", "abort", "name_not_found", "unexpected", "oom", "print_failure", "startdoc", "not_available", "enddoc", "gfx_printer_doc_is_busy"'
