...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "cannot_open_file", "name_not_found", "abort", "gfx_printer_doc_is_busy", "unexpected", "no_printer", "notimplemented", "print_failure", "enddoc", "start_page", "startdoc", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
