...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "enddoc", "gfx_printer_doc_is_busy", "oom", "unexpected", "cannot_open_file", "start_page", "no_printer", "notimplemented", "name_not_found", "not_available", "abort", "print_failure"'
