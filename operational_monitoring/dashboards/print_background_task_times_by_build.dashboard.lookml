...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "enddoc", "oom", "cannot_open_file", "no_printer", "startdoc", "print_failure", "unexpected", "name_not_found", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "abort"'
