...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "abort", "print_failure", "no_printer", "startdoc", "enddoc", "notimplemented", "name_not_found", "cannot_open_file", "oom", "gfx_printer_doc_is_busy", "unexpected"'
