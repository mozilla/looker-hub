...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "print_failure", "no_printer", "name_not_found", "not_available", "startdoc", "abort", "start_page", "unexpected", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
