...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "startdoc", "abort", "unexpected", "notimplemented", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "enddoc", "not_available", "print_failure", "oom", "name_not_found"'
