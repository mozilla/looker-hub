...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "oom", "gfx_printer_doc_is_busy", "enddoc", "no_printer", "abort", "startdoc", "notimplemented", "not_available", "start_page", "name_not_found", "unexpected", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
