...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "oom", "notimplemented", "name_not_found", "enddoc", "unexpected", "abort", "startdoc", "gfx_printer_doc_is_busy", "not_available", "start_page", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
