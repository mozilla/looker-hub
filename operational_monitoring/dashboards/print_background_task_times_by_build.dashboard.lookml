...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "print_failure", "gfx_printer_doc_is_busy", "enddoc", "oom", "no_printer", "unexpected", "name_not_found", "start_page", "abort", "startdoc", "not_available", "cannot_open_file"'
