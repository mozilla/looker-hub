...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "unexpected", "notimplemented", "abort", "cannot_open_file", "oom", "no_printer", "not_available", "enddoc", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
