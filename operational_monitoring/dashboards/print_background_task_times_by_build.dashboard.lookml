...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "start_page", "not_available", "gfx_printer_doc_is_busy", "no_printer", "unexpected", "enddoc", "notimplemented", "startdoc", "print_failure", "oom", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
