...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "oom", "start_page", "cannot_open_file", "gfx_printer_doc_is_busy", "not_available", "no_printer", "name_not_found", "notimplemented", "unexpected", "print_failure", "enddoc"'
