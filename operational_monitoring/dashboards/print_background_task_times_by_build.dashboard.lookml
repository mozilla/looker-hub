...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "enddoc", "print_failure", "unexpected", "cannot_open_file", "start_page", "not_available", "startdoc", "abort", "oom", "name_not_found", "notimplemented", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
