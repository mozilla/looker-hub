...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "start_page", "gfx_printer_doc_is_busy", "not_available", "oom", "abort", "name_not_found", "no_printer", "cannot_open_file", "notimplemented", "print_failure", "startdoc"'
