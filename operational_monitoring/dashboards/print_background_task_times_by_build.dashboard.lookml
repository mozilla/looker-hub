...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "name_not_found", "startdoc", "notimplemented", "oom", "print_failure", "gfx_printer_doc_is_busy", "cannot_open_file", "not_available", "abort", "no_printer", "start_page", "unexpected"'
