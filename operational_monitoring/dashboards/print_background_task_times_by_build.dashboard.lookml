...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "abort", "oom", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "no_printer", "not_available", "print_failure", "cannot_open_file", "startdoc", "start_page"'
