...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "print_failure", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "oom", "unexpected", "name_not_found", "cannot_open_file", "start_page", "not_available", "abort"'
