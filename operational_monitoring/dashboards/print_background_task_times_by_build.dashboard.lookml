...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "cannot_open_file", "startdoc", "oom", "print_failure", "unexpected", "enddoc", "not_available", "start_page", "name_not_found", "gfx_printer_doc_is_busy", "no_printer"'
