...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "start_page", "oom", "enddoc", "abort", "notimplemented", "startdoc", "name_not_found", "print_failure", "no_printer"'
