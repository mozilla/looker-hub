...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "unexpected", "not_available", "print_failure", "no_printer", "enddoc", "start_page", "cannot_open_file", "gfx_printer_doc_is_busy", "oom", "notimplemented", "startdoc", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
