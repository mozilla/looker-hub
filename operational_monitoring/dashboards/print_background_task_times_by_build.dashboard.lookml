...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "startdoc", "enddoc", "unexpected", "name_not_found", "notimplemented", "no_printer", "gfx_printer_doc_is_busy", "oom", "abort", "print_failure", "not_available", "cannot_open_file"'
