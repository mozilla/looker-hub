...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "startdoc", "enddoc", "no_printer", "not_available", "unexpected", "abort", "notimplemented", "start_page", "oom", "print_failure", "gfx_printer_doc_is_busy"'
