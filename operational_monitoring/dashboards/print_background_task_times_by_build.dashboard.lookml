...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "no_printer", "abort", "start_page", "gfx_printer_doc_is_busy", "print_failure", "not_available", "oom", "enddoc", "notimplemented", "unexpected", "startdoc", "cannot_open_file"'
