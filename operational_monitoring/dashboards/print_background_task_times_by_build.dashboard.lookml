...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "notimplemented", "print_failure", "name_not_found", "unexpected", "start_page", "abort", "cannot_open_file", "enddoc", "oom", "startdoc", "no_printer", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
