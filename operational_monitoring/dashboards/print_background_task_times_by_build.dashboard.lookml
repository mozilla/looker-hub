...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "startdoc", "start_page", "abort", "no_printer", "notimplemented", "oom", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "not_available", "unexpected"'
