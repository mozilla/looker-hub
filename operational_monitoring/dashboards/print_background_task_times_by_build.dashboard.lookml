...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "abort", "unexpected", "name_not_found", "gfx_printer_doc_is_busy", "no_printer", "print_failure", "start_page", "enddoc", "oom", "cannot_open_file", "notimplemented", "not_available"'
