...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "not_available", "print_failure", "enddoc", "startdoc", "abort", "no_printer", "unexpected", "cannot_open_file", "notimplemented", "name_not_found", "gfx_printer_doc_is_busy", "start_page"'
