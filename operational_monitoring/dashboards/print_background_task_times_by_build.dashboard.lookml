...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "no_printer", "not_available", "enddoc", "name_not_found", "notimplemented", "start_page", "unexpected", "oom", "abort", "startdoc", "gfx_printer_doc_is_busy"'
