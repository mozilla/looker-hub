...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "print_failure", "oom", "not_available", "unexpected", "start_page", "abort", "enddoc", "name_not_found", "gfx_printer_doc_is_busy", "notimplemented", "cannot_open_file"'
