...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "cannot_open_file", "oom", "no_printer", "gfx_printer_doc_is_busy", "not_available", "print_failure", "abort", "start_page", "enddoc", "startdoc", "notimplemented"'
