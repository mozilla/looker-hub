...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "no_printer", "enddoc", "oom", "start_page", "not_available", "cannot_open_file", "print_failure", "startdoc", "gfx_printer_doc_is_busy", "unexpected", "name_not_found"'
