...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "abort", "no_printer", "name_not_found", "cannot_open_file", "notimplemented", "unexpected", "print_failure", "startdoc", "enddoc", "oom", "start_page", "not_available"'
