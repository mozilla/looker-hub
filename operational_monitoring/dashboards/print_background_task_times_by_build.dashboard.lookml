...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "no_printer", "not_available", "start_page", "name_not_found", "abort", "print_failure", "notimplemented", "enddoc", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
