...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "start_page", "cannot_open_file", "oom", "print_failure", "abort", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "unexpected", "not_available", "startdoc", "enddoc"'
