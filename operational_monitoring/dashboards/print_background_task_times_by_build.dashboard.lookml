...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "notimplemented", "start_page", "print_failure", "not_available", "gfx_printer_doc_is_busy", "enddoc", "no_printer", "abort", "name_not_found", "unexpected", "cannot_open_file", "startdoc"'
