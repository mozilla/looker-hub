...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "no_printer", "enddoc", "name_not_found", "notimplemented", "print_failure", "unexpected", "start_page", "not_available", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc", "oom"'
