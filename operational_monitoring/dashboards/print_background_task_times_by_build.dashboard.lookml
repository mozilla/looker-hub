...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "notimplemented", "enddoc", "start_page", "unexpected", "oom", "startdoc", "gfx_printer_doc_is_busy", "not_available", "name_not_found", "cannot_open_file", "no_printer", "print_failure"'
