...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "print_failure", "not_available", "gfx_printer_doc_is_busy", "notimplemented", "unexpected", "start_page", "oom", "enddoc", "startdoc", "cannot_open_file", "name_not_found", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
