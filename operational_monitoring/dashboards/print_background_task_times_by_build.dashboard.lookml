...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "not_available", "no_printer", "unexpected", "start_page", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "print_failure", "name_not_found", "startdoc", "abort", "notimplemented"'
