...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "enddoc", "cannot_open_file", "startdoc", "no_printer", "oom", "unexpected", "print_failure", "start_page", "abort", "gfx_printer_doc_is_busy", "notimplemented", "name_not_found"'
