...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "print_failure", "start_page", "abort", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc", "no_printer", "not_available", "enddoc", "notimplemented"'
