...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "name_not_found", "unexpected", "start_page", "cannot_open_file", "no_printer", "gfx_printer_doc_is_busy", "enddoc", "notimplemented", "oom", "not_available", "print_failure", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
