...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "start_page", "enddoc", "oom", "name_not_found", "startdoc", "no_printer", "unexpected", "cannot_open_file", "not_available", "abort", "notimplemented"'
