...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "notimplemented", "startdoc", "gfx_printer_doc_is_busy", "abort", "print_failure", "unexpected", "start_page", "no_printer", "name_not_found", "oom", "not_available", "cannot_open_file"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
