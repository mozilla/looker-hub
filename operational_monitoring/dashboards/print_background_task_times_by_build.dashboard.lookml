...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "unexpected", "no_printer", "notimplemented", "cannot_open_file", "start_page", "startdoc", "print_failure", "not_available", "enddoc", "abort", "name_not_found", "gfx_printer_doc_is_busy"'
