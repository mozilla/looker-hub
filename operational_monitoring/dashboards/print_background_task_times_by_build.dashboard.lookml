...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "no_printer", "print_failure", "not_available", "name_not_found", "cannot_open_file", "startdoc", "abort", "start_page", "oom", "unexpected", "enddoc", "gfx_printer_doc_is_busy"'
