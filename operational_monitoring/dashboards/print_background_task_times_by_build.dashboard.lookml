...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "no_printer", "enddoc", "start_page", "oom", "cannot_open_file", "abort", "startdoc", "notimplemented", "not_available", "unexpected", "name_not_found", "print_failure"'
