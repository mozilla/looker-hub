...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "startdoc", "no_printer", "oom", "notimplemented", "unexpected", "enddoc", "not_available", "abort", "start_page", "name_not_found"'
