...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "oom", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "no_printer", "start_page", "notimplemented", "abort", "startdoc", "print_failure", "not_available"'
