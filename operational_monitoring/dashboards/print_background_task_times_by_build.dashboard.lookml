...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "startdoc", "abort", "gfx_printer_doc_is_busy", "print_failure", "unexpected", "start_page", "notimplemented", "enddoc", "not_available", "oom", "no_printer"'
