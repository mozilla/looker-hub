...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "abort", "gfx_printer_doc_is_busy", "not_available", "startdoc", "cannot_open_file", "notimplemented", "oom", "start_page", "enddoc", "name_not_found", "print_failure", "unexpected"'
