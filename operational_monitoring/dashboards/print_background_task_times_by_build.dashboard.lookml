...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "start_page", "cannot_open_file", "oom", "name_not_found", "startdoc", "unexpected", "enddoc", "abort", "gfx_printer_doc_is_busy", "not_available", "no_printer", "notimplemented"'
