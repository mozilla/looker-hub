...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "not_available", "gfx_printer_doc_is_busy", "startdoc", "oom", "enddoc", "cannot_open_file", "notimplemented", "unexpected", "start_page", "no_printer", "print_failure"'
