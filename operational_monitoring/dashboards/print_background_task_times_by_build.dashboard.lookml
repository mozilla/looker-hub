...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "cannot_open_file", "abort", "oom", "print_failure", "start_page", "not_available", "enddoc", "gfx_printer_doc_is_busy", "no_printer", "startdoc", "name_not_found", "notimplemented"'
