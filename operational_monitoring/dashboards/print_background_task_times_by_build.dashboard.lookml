...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "cannot_open_file", "notimplemented", "name_not_found", "startdoc", "start_page", "unexpected", "not_available", "oom", "gfx_printer_doc_is_busy", "abort", "enddoc"'
