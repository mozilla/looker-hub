...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "print_failure", "startdoc", "abort", "start_page", "enddoc", "oom", "notimplemented", "not_available", "unexpected", "gfx_printer_doc_is_busy", "no_printer"'
