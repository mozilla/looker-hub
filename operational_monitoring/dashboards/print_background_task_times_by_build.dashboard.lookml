...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "unexpected", "print_failure", "not_available", "startdoc", "start_page", "name_not_found", "oom", "no_printer", "enddoc", "cannot_open_file", "gfx_printer_doc_is_busy", "notimplemented"'
