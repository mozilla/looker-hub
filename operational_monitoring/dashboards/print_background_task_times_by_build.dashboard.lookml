...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "print_failure", "name_not_found", "abort", "notimplemented", "gfx_printer_doc_is_busy", "startdoc", "unexpected", "no_printer", "oom", "start_page", "cannot_open_file", "enddoc"'
