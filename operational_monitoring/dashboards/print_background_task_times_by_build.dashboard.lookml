...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "notimplemented", "no_printer", "print_failure", "cannot_open_file", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "start_page", "oom", "not_available", "abort"'
