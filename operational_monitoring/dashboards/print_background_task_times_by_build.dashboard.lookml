...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "notimplemented", "gfx_printer_doc_is_busy", "cannot_open_file", "not_available", "print_failure", "enddoc", "no_printer", "start_page", "unexpected", "startdoc", "oom", "abort"'
