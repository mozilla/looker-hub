...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "print_failure", "cannot_open_file", "oom", "not_available", "abort", "startdoc", "no_printer", "unexpected", "notimplemented", "gfx_printer_doc_is_busy", "enddoc"'
