...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "print_failure", "name_not_found", "cannot_open_file", "enddoc", "oom", "start_page", "startdoc", "gfx_printer_doc_is_busy", "notimplemented", "not_available", "no_printer", "unexpected"'
