...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "oom", "unexpected", "name_not_found", "not_available", "print_failure", "no_printer", "abort", "cannot_open_file", "enddoc", "startdoc", "start_page"'
