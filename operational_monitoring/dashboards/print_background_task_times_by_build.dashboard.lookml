...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "unexpected", "gfx_printer_doc_is_busy", "startdoc", "print_failure", "cannot_open_file", "no_printer", "start_page", "notimplemented", "oom", "abort", "enddoc", "not_available"'
