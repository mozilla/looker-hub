...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "start_page", "unexpected", "name_not_found", "cannot_open_file", "no_printer", "enddoc", "startdoc", "abort", "gfx_printer_doc_is_busy", "oom", "not_available", "notimplemented"'
