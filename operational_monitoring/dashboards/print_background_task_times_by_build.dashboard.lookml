...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "no_printer", "not_available", "enddoc", "startdoc", "name_not_found", "cannot_open_file", "oom", "notimplemented", "abort", "unexpected", "gfx_printer_doc_is_busy", "print_failure"'
