...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "oom", "abort", "name_not_found", "gfx_printer_doc_is_busy", "not_available", "startdoc", "start_page", "enddoc", "unexpected", "print_failure", "cannot_open_file", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
