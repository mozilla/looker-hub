...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "name_not_found", "unexpected", "startdoc", "cannot_open_file", "gfx_printer_doc_is_busy", "oom", "start_page", "print_failure", "abort", "notimplemented", "no_printer", "not_available"'
