...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "notimplemented", "print_failure", "abort", "not_available", "name_not_found", "unexpected", "no_printer", "enddoc", "start_page"'
