...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "unexpected", "gfx_printer_doc_is_busy", "enddoc", "cannot_open_file", "oom", "not_available", "start_page", "print_failure", "name_not_found", "no_printer", "notimplemented", "startdoc"'
