...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "start_page", "name_not_found", "enddoc", "print_failure", "not_available", "no_printer", "notimplemented", "oom", "gfx_printer_doc_is_busy", "unexpected", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
