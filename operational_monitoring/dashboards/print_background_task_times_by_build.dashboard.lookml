...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "gfx_printer_doc_is_busy", "print_failure", "unexpected", "start_page", "startdoc", "enddoc", "abort", "notimplemented", "cannot_open_file", "name_not_found", "not_available", "oom"'
