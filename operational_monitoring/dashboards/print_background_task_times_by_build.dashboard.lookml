...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "start_page", "oom", "abort", "enddoc", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "name_not_found", "notimplemented", "startdoc", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
