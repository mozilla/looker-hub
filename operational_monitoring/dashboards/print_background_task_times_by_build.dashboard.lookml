...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "abort", "cannot_open_file", "notimplemented", "name_not_found", "startdoc", "unexpected", "gfx_printer_doc_is_busy", "print_failure", "no_printer", "enddoc", "oom"'
