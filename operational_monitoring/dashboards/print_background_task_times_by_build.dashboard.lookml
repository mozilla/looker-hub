...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "startdoc", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "abort", "not_available", "notimplemented", "print_failure", "start_page", "cannot_open_file", "oom", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
