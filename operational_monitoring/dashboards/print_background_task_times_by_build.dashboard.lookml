...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "abort", "name_not_found", "cannot_open_file", "enddoc", "no_printer", "start_page", "notimplemented", "startdoc", "gfx_printer_doc_is_busy", "not_available", "unexpected", "print_failure"'
