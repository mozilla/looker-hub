...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "startdoc", "cannot_open_file", "oom", "abort", "print_failure", "not_available", "gfx_printer_doc_is_busy", "unexpected", "no_printer", "start_page", "notimplemented", "enddoc"'
