...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "unexpected", "name_not_found", "not_available", "startdoc", "enddoc", "abort", "notimplemented", "print_failure", "gfx_printer_doc_is_busy", "cannot_open_file", "no_printer", "start_page"'
