...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "enddoc", "cannot_open_file", "not_available", "gfx_printer_doc_is_busy", "start_page", "print_failure", "oom", "no_printer", "startdoc", "unexpected", "name_not_found", "abort"'
