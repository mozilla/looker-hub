...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "name_not_found", "abort", "oom", "unexpected", "not_available", "no_printer", "start_page", "notimplemented", "startdoc", "cannot_open_file", "enddoc", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
