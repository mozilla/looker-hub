...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "startdoc", "print_failure", "name_not_found", "abort", "notimplemented", "unexpected", "not_available", "no_printer", "start_page", "cannot_open_file", "enddoc", "gfx_printer_doc_is_busy"'
