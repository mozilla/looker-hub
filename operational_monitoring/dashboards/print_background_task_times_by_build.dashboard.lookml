...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "not_available", "abort", "start_page", "oom", "startdoc", "unexpected", "name_not_found", "print_failure", "cannot_open_file"'
