...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "gfx_printer_doc_is_busy", "oom", "startdoc", "start_page", "not_available", "unexpected", "cannot_open_file", "no_printer", "enddoc", "print_failure", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
