...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "not_available", "startdoc", "abort", "name_not_found", "unexpected", "oom", "enddoc", "print_failure", "cannot_open_file"'
