...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "notimplemented", "oom", "not_available", "print_failure", "unexpected", "startdoc", "abort", "enddoc", "name_not_found", "cannot_open_file", "no_printer", "start_page"'
