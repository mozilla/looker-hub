...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "notimplemented", "print_failure", "startdoc", "oom", "not_available", "cannot_open_file", "gfx_printer_doc_is_busy", "name_not_found", "no_printer", "start_page", "abort"'
