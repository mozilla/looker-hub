...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "oom", "gfx_printer_doc_is_busy", "start_page", "enddoc", "no_printer", "print_failure", "name_not_found", "notimplemented", "startdoc", "abort", "not_available", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
