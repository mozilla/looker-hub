...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "print_failure", "enddoc", "not_available", "cannot_open_file", "abort", "name_not_found", "startdoc", "gfx_printer_doc_is_busy", "no_printer", "start_page", "oom", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
