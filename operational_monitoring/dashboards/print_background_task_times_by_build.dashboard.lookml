...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "startdoc", "not_available", "abort", "gfx_printer_doc_is_busy", "oom", "no_printer", "name_not_found", "unexpected", "print_failure", "start_page", "cannot_open_file", "enddoc"'
