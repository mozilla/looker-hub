...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "not_available", "enddoc", "oom", "cannot_open_file", "no_printer", "unexpected", "name_not_found", "abort", "gfx_printer_doc_is_busy", "start_page", "startdoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
