...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "no_printer", "enddoc", "notimplemented", "oom", "gfx_printer_doc_is_busy", "startdoc", "start_page", "unexpected", "abort", "cannot_open_file", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
