...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "startdoc", "notimplemented", "gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "oom", "unexpected", "no_printer", "abort", "not_available", "start_page", "print_failure"'
