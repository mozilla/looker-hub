...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "cannot_open_file", "name_not_found", "startdoc", "gfx_printer_doc_is_busy", "oom", "abort", "unexpected", "not_available", "print_failure", "no_printer", "start_page", "enddoc"'
