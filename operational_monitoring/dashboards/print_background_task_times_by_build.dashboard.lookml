...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "notimplemented", "not_available", "cannot_open_file", "startdoc", "start_page", "print_failure", "no_printer", "abort", "oom", "gfx_printer_doc_is_busy", "unexpected"'
