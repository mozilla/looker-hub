...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "no_printer", "not_available", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "startdoc", "enddoc", "unexpected", "name_not_found", "start_page", "oom", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
