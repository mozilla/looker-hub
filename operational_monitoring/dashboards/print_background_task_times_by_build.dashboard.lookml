...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "enddoc", "gfx_printer_doc_is_busy", "start_page", "unexpected", "not_available", "oom", "no_printer", "cannot_open_file", "print_failure", "notimplemented", "startdoc", "name_not_found"'
