...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "startdoc", "unexpected", "cannot_open_file", "no_printer", "start_page", "gfx_printer_doc_is_busy", "notimplemented", "print_failure", "oom", "not_available", "enddoc"'
