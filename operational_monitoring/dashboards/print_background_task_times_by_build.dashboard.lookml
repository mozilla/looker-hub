...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "oom", "enddoc", "name_not_found", "notimplemented", "startdoc", "no_printer", "start_page", "not_available", "cannot_open_file", "print_failure", "gfx_printer_doc_is_busy", "abort"'
