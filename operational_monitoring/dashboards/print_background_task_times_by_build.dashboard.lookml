...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "oom", "start_page", "cannot_open_file", "abort", "enddoc", "startdoc", "notimplemented", "print_failure", "no_printer", "name_not_found", "gfx_printer_doc_is_busy", "unexpected"'
