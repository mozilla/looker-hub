...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "oom", "unexpected", "start_page", "notimplemented", "cannot_open_file", "startdoc", "print_failure", "abort", "gfx_printer_doc_is_busy", "enddoc", "name_not_found", "not_available"'
