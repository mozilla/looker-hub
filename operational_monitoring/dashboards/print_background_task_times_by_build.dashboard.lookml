...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "start_page", "print_failure", "gfx_printer_doc_is_busy", "no_printer", "notimplemented", "enddoc", "oom", "unexpected", "startdoc", "cannot_open_file", "abort", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
