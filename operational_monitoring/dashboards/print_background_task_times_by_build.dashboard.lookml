...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "abort", "name_not_found", "cannot_open_file", "unexpected", "no_printer", "notimplemented", "gfx_printer_doc_is_busy", "print_failure", "not_available", "enddoc", "startdoc", "start_page"'
