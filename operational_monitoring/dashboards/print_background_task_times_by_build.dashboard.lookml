...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "cannot_open_file", "notimplemented", "name_not_found", "oom", "start_page", "enddoc", "print_failure", "gfx_printer_doc_is_busy", "abort", "startdoc", "unexpected"'
