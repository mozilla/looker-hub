...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "gfx_printer_doc_is_busy", "print_failure", "notimplemented", "unexpected", "cannot_open_file", "startdoc", "start_page", "name_not_found", "oom", "abort", "no_printer", "not_available"'
