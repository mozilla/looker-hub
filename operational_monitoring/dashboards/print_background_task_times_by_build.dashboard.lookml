...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "unexpected", "startdoc", "enddoc", "name_not_found", "start_page", "oom", "abort", "notimplemented", "not_available", "no_printer", "print_failure", "cannot_open_file"'
