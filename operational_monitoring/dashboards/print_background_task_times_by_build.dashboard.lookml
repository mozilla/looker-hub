...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "name_not_found", "unexpected", "cannot_open_file", "start_page", "abort", "not_available", "gfx_printer_doc_is_busy", "startdoc", "enddoc", "print_failure", "oom"'
