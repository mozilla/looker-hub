...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "start_page", "oom", "notimplemented", "enddoc", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "startdoc", "print_failure", "unexpected", "abort"'
