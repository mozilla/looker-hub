...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "name_not_found", "enddoc", "start_page", "not_available", "unexpected", "oom", "startdoc", "gfx_printer_doc_is_busy", "cannot_open_file", "abort", "print_failure", "no_printer"'
