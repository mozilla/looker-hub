...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "name_not_found", "unexpected", "start_page", "enddoc", "notimplemented", "gfx_printer_doc_is_busy", "oom", "startdoc", "abort", "print_failure", "no_printer", "not_available"'
