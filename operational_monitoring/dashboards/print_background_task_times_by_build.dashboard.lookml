...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "enddoc", "oom", "name_not_found", "startdoc", "gfx_printer_doc_is_busy", "not_available", "abort", "print_failure", "unexpected", "start_page", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
