...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "oom", "name_not_found", "start_page", "notimplemented", "no_printer", "abort", "startdoc", "not_available", "print_failure", "unexpected"'
