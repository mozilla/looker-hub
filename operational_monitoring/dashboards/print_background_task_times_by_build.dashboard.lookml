...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "enddoc", "notimplemented", "not_available", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "abort", "name_not_found", "no_printer", "startdoc", "start_page", "print_failure"'
