...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "unexpected", "gfx_printer_doc_is_busy", "not_available", "name_not_found", "startdoc", "no_printer", "cannot_open_file", "start_page", "enddoc", "abort", "oom", "notimplemented"'
