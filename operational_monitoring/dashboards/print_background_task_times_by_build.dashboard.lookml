...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "name_not_found", "no_printer", "enddoc", "print_failure", "not_available", "gfx_printer_doc_is_busy", "cannot_open_file", "start_page", "oom", "abort", "notimplemented"'
