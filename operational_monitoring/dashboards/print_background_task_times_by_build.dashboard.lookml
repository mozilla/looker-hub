...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "no_printer", "not_available", "startdoc", "abort", "start_page", "unexpected", "cannot_open_file", "notimplemented", "enddoc", "print_failure", "gfx_printer_doc_is_busy", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
