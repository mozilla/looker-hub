...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "name_not_found", "no_printer", "cannot_open_file", "not_available", "start_page", "startdoc", "oom", "enddoc", "gfx_printer_doc_is_busy", "unexpected", "notimplemented", "abort"'
