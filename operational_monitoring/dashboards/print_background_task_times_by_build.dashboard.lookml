...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "print_failure", "not_available", "abort", "start_page", "notimplemented", "unexpected", "no_printer", "oom", "cannot_open_file", "gfx_printer_doc_is_busy", "name_not_found", "startdoc"'
