...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "print_failure", "no_printer", "name_not_found", "abort", "unexpected", "startdoc", "cannot_open_file", "enddoc", "notimplemented", "not_available", "start_page", "gfx_printer_doc_is_busy"'
