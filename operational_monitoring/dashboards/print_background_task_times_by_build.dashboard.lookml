...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "abort", "unexpected", "cannot_open_file", "name_not_found", "print_failure", "no_printer", "start_page", "enddoc", "oom", "notimplemented", "not_available", "startdoc"'
