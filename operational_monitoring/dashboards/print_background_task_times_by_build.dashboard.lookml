...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "unexpected", "startdoc", "print_failure", "start_page", "name_not_found", "not_available", "no_printer", "oom", "notimplemented", "enddoc", "cannot_open_file", "abort"'
