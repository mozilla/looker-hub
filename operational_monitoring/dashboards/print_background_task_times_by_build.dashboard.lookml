...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "not_available", "unexpected", "startdoc", "start_page", "no_printer", "cannot_open_file", "print_failure", "abort", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "name_not_found"'
