...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "notimplemented", "no_printer", "cannot_open_file", "print_failure", "gfx_printer_doc_is_busy", "startdoc", "start_page", "abort", "not_available", "unexpected", "oom", "enddoc"'
