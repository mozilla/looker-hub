...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "oom", "notimplemented", "unexpected", "name_not_found", "abort", "not_available", "startdoc", "enddoc", "cannot_open_file", "start_page", "gfx_printer_doc_is_busy", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
