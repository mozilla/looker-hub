...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "no_printer", "unexpected", "not_available", "startdoc", "enddoc", "oom", "notimplemented", "gfx_printer_doc_is_busy", "start_page", "cannot_open_file", "print_failure", "name_not_found"'
