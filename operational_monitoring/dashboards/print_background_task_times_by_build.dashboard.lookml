...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "name_not_found", "startdoc", "enddoc", "no_printer", "notimplemented", "gfx_printer_doc_is_busy", "oom", "abort", "cannot_open_file", "print_failure", "start_page", "unexpected"'
