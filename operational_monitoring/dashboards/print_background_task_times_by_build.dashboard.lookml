...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "enddoc", "abort", "oom", "notimplemented", "name_not_found", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "start_page", "startdoc", "print_failure", "unexpected"'
