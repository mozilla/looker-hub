...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "gfx_printer_doc_is_busy", "print_failure", "start_page", "name_not_found", "startdoc", "not_available", "oom", "unexpected", "notimplemented", "abort", "cannot_open_file", "enddoc"'
