...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "oom", "print_failure", "notimplemented", "start_page", "name_not_found", "no_printer", "abort", "enddoc", "gfx_printer_doc_is_busy", "not_available", "cannot_open_file", "startdoc"'
