...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "abort", "print_failure", "not_available", "unexpected", "startdoc", "start_page", "oom", "cannot_open_file", "no_printer", "name_not_found", "enddoc", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
