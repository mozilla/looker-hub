...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "not_available", "print_failure", "start_page", "cannot_open_file", "startdoc", "no_printer", "oom", "name_not_found", "unexpected", "abort", "enddoc"'
