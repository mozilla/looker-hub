...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "print_failure", "unexpected", "no_printer", "name_not_found", "start_page", "not_available", "abort", "startdoc", "notimplemented", "gfx_printer_doc_is_busy", "enddoc", "oom"'
