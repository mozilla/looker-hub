...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "cannot_open_file", "gfx_printer_doc_is_busy", "print_failure", "name_not_found", "abort", "startdoc", "enddoc", "start_page", "unexpected", "not_available", "oom"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
