...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "gfx_printer_doc_is_busy", "no_printer", "unexpected", "start_page", "print_failure", "not_available", "abort", "name_not_found", "startdoc", "enddoc", "oom", "cannot_open_file"'
