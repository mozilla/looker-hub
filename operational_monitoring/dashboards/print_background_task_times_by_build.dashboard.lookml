...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "cannot_open_file", "print_failure", "notimplemented", "not_available", "name_not_found", "oom", "gfx_printer_doc_is_busy", "start_page", "no_printer", "startdoc", "abort", "unexpected"'
