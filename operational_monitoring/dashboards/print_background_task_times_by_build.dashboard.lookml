...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "name_not_found", "abort", "notimplemented", "unexpected", "no_printer", "enddoc", "not_available", "start_page", "cannot_open_file", "oom", "print_failure"'
