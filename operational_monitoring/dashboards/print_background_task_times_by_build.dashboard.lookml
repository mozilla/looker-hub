...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "start_page", "abort", "name_not_found", "enddoc", "gfx_printer_doc_is_busy", "notimplemented", "unexpected", "not_available", "no_printer", "print_failure", "cannot_open_file", "oom"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
