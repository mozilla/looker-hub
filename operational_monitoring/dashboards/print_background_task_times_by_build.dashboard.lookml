...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "no_printer", "name_not_found", "gfx_printer_doc_is_busy", "notimplemented", "startdoc", "start_page", "enddoc", "oom", "not_available", "print_failure", "cannot_open_file"'
