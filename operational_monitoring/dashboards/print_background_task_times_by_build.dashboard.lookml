...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "no_printer", "not_available", "startdoc", "name_not_found", "enddoc", "start_page", "notimplemented", "cannot_open_file", "oom", "gfx_printer_doc_is_busy", "print_failure"'
