...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "unexpected", "no_printer", "not_available", "cannot_open_file", "startdoc", "enddoc", "name_not_found", "oom", "print_failure", "gfx_printer_doc_is_busy", "notimplemented", "abort"'
