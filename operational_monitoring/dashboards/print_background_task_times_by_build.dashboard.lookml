...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "start_page", "enddoc", "oom", "cannot_open_file", "name_not_found", "startdoc", "notimplemented", "unexpected", "gfx_printer_doc_is_busy", "print_failure", "abort", "not_available"'
