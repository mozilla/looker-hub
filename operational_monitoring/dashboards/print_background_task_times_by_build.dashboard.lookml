...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "no_printer", "notimplemented", "name_not_found", "oom", "unexpected", "print_failure", "abort", "cannot_open_file", "start_page", "not_available", "enddoc", "startdoc"'
