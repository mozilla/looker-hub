...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "not_available", "oom", "notimplemented", "gfx_printer_doc_is_busy", "print_failure", "unexpected", "cannot_open_file", "no_printer", "startdoc", "start_page", "enddoc", "name_not_found"'
