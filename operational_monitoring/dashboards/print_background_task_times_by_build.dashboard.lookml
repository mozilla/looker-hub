...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "name_not_found", "enddoc", "print_failure", "no_printer", "not_available", "start_page", "oom", "notimplemented", "gfx_printer_doc_is_busy", "abort", "cannot_open_file", "unexpected"'
