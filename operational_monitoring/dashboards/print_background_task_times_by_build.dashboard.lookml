...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "unexpected", "print_failure", "no_printer", "abort", "start_page", "name_not_found", "oom", "startdoc", "enddoc", "not_available", "gfx_printer_doc_is_busy", "cannot_open_file"'
