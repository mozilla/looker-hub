...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "start_page", "no_printer", "abort", "notimplemented", "gfx_printer_doc_is_busy", "oom", "cannot_open_file", "not_available", "startdoc", "print_failure", "unexpected", "name_not_found"'
