...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "gfx_printer_doc_is_busy", "abort", "notimplemented", "no_printer", "cannot_open_file", "unexpected", "oom", "name_not_found", "start_page", "not_available", "startdoc"'
