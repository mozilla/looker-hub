...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "no_printer", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "unexpected", "enddoc", "abort", "notimplemented", "oom", "print_failure", "start_page", "startdoc"'
