...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "name_not_found", "oom", "not_available", "unexpected", "cannot_open_file", "startdoc", "enddoc", "notimplemented", "abort", "no_printer", "print_failure", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
