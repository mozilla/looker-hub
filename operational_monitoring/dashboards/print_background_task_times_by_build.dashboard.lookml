...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "no_printer", "unexpected", "startdoc", "start_page", "enddoc", "notimplemented", "abort", "name_not_found", "not_available", "gfx_printer_doc_is_busy", "oom", "print_failure"'
