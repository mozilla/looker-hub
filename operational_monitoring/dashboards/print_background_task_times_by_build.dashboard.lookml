...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "start_page", "not_available", "abort", "no_printer", "unexpected", "notimplemented", "cannot_open_file", "print_failure", "startdoc", "oom", "gfx_printer_doc_is_busy", "name_not_found"'
