...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "unexpected", "notimplemented", "cannot_open_file", "no_printer", "start_page", "print_failure", "oom", "not_available", "enddoc", "startdoc", "gfx_printer_doc_is_busy", "name_not_found"'
