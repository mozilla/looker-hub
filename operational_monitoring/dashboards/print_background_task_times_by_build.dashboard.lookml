...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "no_printer", "notimplemented", "name_not_found", "oom", "print_failure", "not_available", "abort", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
