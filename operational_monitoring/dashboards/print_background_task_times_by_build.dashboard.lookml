...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "notimplemented", "start_page", "oom", "not_available", "gfx_printer_doc_is_busy", "cannot_open_file", "unexpected", "name_not_found", "abort", "startdoc", "enddoc", "print_failure"'
