...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "start_page", "notimplemented", "enddoc", "not_available", "no_printer", "name_not_found", "oom", "unexpected", "abort", "cannot_open_file", "gfx_printer_doc_is_busy", "startdoc"'
