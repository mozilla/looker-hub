...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "gfx_printer_doc_is_busy", "no_printer", "unexpected", "enddoc", "start_page", "name_not_found", "abort", "oom", "startdoc", "print_failure", "cannot_open_file", "notimplemented"'
