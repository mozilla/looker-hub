...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "startdoc", "unexpected", "abort", "enddoc", "oom", "start_page", "gfx_printer_doc_is_busy", "name_not_found", "print_failure", "notimplemented", "cannot_open_file", "no_printer"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
