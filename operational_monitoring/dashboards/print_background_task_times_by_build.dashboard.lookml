...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "print_failure", "startdoc", "enddoc", "abort", "gfx_printer_doc_is_busy", "name_not_found", "start_page", "unexpected", "not_available", "notimplemented", "oom", "cannot_open_file"'
