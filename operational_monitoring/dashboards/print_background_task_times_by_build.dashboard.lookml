...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "oom", "gfx_printer_doc_is_busy", "not_available", "enddoc", "notimplemented", "no_printer", "cannot_open_file", "unexpected", "start_page", "name_not_found", "abort", "startdoc"'
