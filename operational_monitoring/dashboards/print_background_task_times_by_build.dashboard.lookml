...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "startdoc", "abort", "start_page", "notimplemented", "oom", "unexpected", "no_printer", "not_available", "enddoc", "print_failure", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
