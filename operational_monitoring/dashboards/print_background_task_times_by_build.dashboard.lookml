...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "unexpected", "cannot_open_file", "enddoc", "oom", "startdoc", "print_failure", "start_page", "not_available", "gfx_printer_doc_is_busy", "no_printer", "notimplemented", "abort"'
