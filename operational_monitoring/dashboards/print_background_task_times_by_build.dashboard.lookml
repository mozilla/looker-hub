...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "startdoc", "print_failure", "cannot_open_file", "enddoc", "start_page", "abort", "unexpected", "notimplemented", "not_available", "gfx_printer_doc_is_busy", "name_not_found", "oom"'
