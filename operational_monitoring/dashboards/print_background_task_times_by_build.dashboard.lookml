...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "start_page", "not_available", "print_failure", "startdoc", "gfx_printer_doc_is_busy", "enddoc", "unexpected", "abort", "oom", "notimplemented", "no_printer"'
