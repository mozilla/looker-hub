...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "enddoc", "not_available", "name_not_found", "notimplemented", "gfx_printer_doc_is_busy", "print_failure", "unexpected", "no_printer", "startdoc", "abort", "cannot_open_file", "oom"'
