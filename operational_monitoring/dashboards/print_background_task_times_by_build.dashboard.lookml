...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "startdoc", "start_page", "oom", "cannot_open_file", "name_not_found", "enddoc", "notimplemented", "print_failure", "no_printer", "abort", "gfx_printer_doc_is_busy", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
