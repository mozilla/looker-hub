...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "start_page", "oom", "gfx_printer_doc_is_busy", "no_printer", "cannot_open_file", "abort", "notimplemented", "startdoc", "print_failure", "enddoc", "unexpected", "not_available"'
