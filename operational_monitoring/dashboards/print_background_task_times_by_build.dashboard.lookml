...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "no_printer", "oom", "not_available", "name_not_found", "gfx_printer_doc_is_busy", "enddoc", "start_page", "startdoc", "notimplemented", "cannot_open_file", "print_failure", "abort"'
