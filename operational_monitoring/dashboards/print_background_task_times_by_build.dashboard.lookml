...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "no_printer", "unexpected", "oom", "name_not_found", "startdoc", "notimplemented", "abort", "enddoc", "cannot_open_file", "gfx_printer_doc_is_busy", "print_failure"'
