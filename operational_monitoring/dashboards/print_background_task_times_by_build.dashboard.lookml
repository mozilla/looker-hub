...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "notimplemented", "gfx_printer_doc_is_busy", "unexpected", "no_printer", "abort", "startdoc", "start_page", "oom", "name_not_found", "cannot_open_file", "not_available", "print_failure"'
