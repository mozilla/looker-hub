...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "not_available", "startdoc", "enddoc", "no_printer", "abort", "print_failure", "notimplemented", "oom", "cannot_open_file", "gfx_printer_doc_is_busy", "start_page", "unexpected"'
