...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "oom", "not_available", "cannot_open_file", "start_page", "enddoc", "print_failure", "startdoc", "unexpected", "gfx_printer_doc_is_busy", "no_printer", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
