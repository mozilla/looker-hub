...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "no_printer", "unexpected", "abort", "enddoc", "print_failure", "not_available", "start_page", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "notimplemented", "name_not_found"'
