...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "print_failure", "cannot_open_file", "no_printer", "name_not_found", "abort", "not_available", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "startdoc", "unexpected", "oom"'
