...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "notimplemented", "startdoc", "start_page", "not_available", "abort", "name_not_found", "enddoc", "gfx_printer_doc_is_busy", "cannot_open_file", "no_printer", "oom", "unexpected"'
