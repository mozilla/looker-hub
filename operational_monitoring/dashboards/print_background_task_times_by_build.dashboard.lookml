...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "notimplemented", "no_printer", "oom", "not_available", "startdoc", "unexpected", "gfx_printer_doc_is_busy", "enddoc", "print_failure", "name_not_found", "start_page"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
