...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "name_not_found", "cannot_open_file", "startdoc", "no_printer", "not_available", "print_failure", "enddoc", "abort", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
