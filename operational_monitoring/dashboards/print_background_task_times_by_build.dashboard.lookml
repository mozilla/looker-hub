...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "oom", "no_printer", "cannot_open_file", "startdoc", "start_page", "not_available", "unexpected", "enddoc", "notimplemented", "name_not_found", "abort", "gfx_printer_doc_is_busy"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
