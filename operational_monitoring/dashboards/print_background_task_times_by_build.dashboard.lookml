...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "oom", "print_failure", "enddoc", "abort", "notimplemented", "start_page", "no_printer", "unexpected", "name_not_found", "cannot_open_file", "not_available"'
