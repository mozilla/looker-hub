...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "startdoc", "unexpected", "not_available", "abort", "gfx_printer_doc_is_busy", "enddoc", "name_not_found", "cannot_open_file", "start_page", "notimplemented", "print_failure", "no_printer"'
