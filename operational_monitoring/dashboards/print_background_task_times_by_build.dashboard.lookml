...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "name_not_found", "enddoc", "notimplemented", "oom", "cannot_open_file", "abort", "gfx_printer_doc_is_busy", "not_available", "unexpected", "print_failure", "startdoc", "no_printer"'
