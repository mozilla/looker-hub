...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "name_not_found", "startdoc", "notimplemented", "not_available", "start_page", "cannot_open_file", "enddoc", "gfx_printer_doc_is_busy", "oom", "print_failure", "abort", "unexpected"'
