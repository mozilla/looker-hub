...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "abort", "cannot_open_file", "name_not_found", "startdoc", "no_printer", "enddoc", "not_available", "oom", "gfx_printer_doc_is_busy", "print_failure", "unexpected", "start_page"'
