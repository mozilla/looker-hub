...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "notimplemented", "cannot_open_file", "unexpected", "oom", "start_page", "not_available", "no_printer", "name_not_found", "startdoc", "abort", "enddoc", "print_failure"'
