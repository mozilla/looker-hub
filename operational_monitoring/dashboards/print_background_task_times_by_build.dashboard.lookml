...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "cannot_open_file", "print_failure", "enddoc", "startdoc", "gfx_printer_doc_is_busy", "name_not_found", "start_page", "notimplemented", "no_printer", "oom", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
