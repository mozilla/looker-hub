...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "oom", "not_available", "startdoc", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "print_failure", "cannot_open_file", "abort", "notimplemented", "unexpected", "start_page"'
