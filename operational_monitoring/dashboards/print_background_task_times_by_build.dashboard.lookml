...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "no_printer", "name_not_found", "cannot_open_file", "startdoc", "abort", "notimplemented", "unexpected", "gfx_printer_doc_is_busy", "oom", "enddoc", "start_page", "not_available"'
