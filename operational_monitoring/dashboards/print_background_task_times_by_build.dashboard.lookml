...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "not_available", "enddoc", "gfx_printer_doc_is_busy", "no_printer", "notimplemented", "abort", "unexpected", "startdoc", "cannot_open_file", "start_page", "name_not_found", "print_failure"'
