...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "abort", "oom", "no_printer", "gfx_printer_doc_is_busy", "cannot_open_file", "print_failure", "start_page", "name_not_found", "startdoc", "notimplemented", "not_available", "enddoc"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
