...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "print_failure", "not_available", "start_page", "unexpected", "startdoc", "cannot_open_file", "enddoc", "abort", "name_not_found", "no_printer", "gfx_printer_doc_is_busy", "oom"'
