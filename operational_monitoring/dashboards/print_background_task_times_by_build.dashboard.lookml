...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "startdoc", "start_page", "oom", "name_not_found", "no_printer", "enddoc", "unexpected", "gfx_printer_doc_is_busy", "abort", "print_failure", "cannot_open_file", "notimplemented"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
