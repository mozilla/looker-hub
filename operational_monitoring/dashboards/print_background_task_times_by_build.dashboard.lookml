...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "oom", "gfx_printer_doc_is_busy", "cannot_open_file", "start_page", "notimplemented", "no_printer", "name_not_found", "unexpected", "print_failure", "startdoc", "abort", "not_available"'
