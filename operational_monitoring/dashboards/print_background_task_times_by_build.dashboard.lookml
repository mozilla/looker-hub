...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "enddoc", "start_page", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "notimplemented", "unexpected", "oom", "cannot_open_file", "print_failure", "not_available", "abort"'
