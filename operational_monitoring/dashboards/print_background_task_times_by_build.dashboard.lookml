...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "oom", "enddoc", "cannot_open_file", "gfx_printer_doc_is_busy", "start_page", "notimplemented", "unexpected", "print_failure", "startdoc", "abort", "no_printer", "not_available"'
