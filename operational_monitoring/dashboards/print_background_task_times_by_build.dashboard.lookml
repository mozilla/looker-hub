...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "gfx_printer_doc_is_busy", "no_printer", "print_failure", "enddoc", "start_page", "notimplemented", "startdoc", "abort", "not_available", "unexpected", "cannot_open_file", "oom"'
