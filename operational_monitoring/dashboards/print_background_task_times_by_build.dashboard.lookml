...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "startdoc", "notimplemented", "oom", "print_failure", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file", "enddoc", "not_available", "no_printer", "unexpected", "abort"'
