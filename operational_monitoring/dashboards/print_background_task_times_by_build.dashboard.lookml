...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "name_not_found", "startdoc", "print_failure", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "not_available", "notimplemented", "oom", "enddoc", "no_printer", "start_page"'
