...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "not_available", "no_printer", "cannot_open_file", "startdoc", "enddoc", "abort", "oom", "notimplemented", "print_failure", "start_page", "gfx_printer_doc_is_busy", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
