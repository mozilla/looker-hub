...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "name_not_found", "startdoc", "print_failure", "no_printer", "start_page", "oom", "gfx_printer_doc_is_busy", "abort", "not_available", "notimplemented", "unexpected", "enddoc"'
