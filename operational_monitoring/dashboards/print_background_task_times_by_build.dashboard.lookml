...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "not_available", "no_printer", "print_failure", "cannot_open_file", "start_page", "enddoc", "unexpected", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "oom"'
