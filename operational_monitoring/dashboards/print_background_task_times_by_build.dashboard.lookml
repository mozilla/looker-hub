...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "enddoc", "start_page", "cannot_open_file", "print_failure", "name_not_found", "notimplemented", "not_available", "no_printer", "oom", "abort", "gfx_printer_doc_is_busy"'
