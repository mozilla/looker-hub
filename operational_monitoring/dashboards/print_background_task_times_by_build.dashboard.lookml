...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "startdoc", "not_available", "notimplemented", "unexpected", "gfx_printer_doc_is_busy", "no_printer", "name_not_found", "cannot_open_file", "oom", "abort", "start_page"'
