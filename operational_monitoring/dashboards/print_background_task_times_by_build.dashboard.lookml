...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "start_page", "abort", "name_not_found", "oom", "gfx_printer_doc_is_busy", "no_printer", "print_failure", "enddoc", "cannot_open_file", "notimplemented", "not_available"'
