...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "oom", "enddoc", "no_printer", "abort", "not_available", "cannot_open_file", "unexpected", "startdoc", "print_failure", "gfx_printer_doc_is_busy", "notimplemented", "start_page"'
