...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "cannot_open_file", "enddoc", "gfx_printer_doc_is_busy", "not_available", "start_page", "notimplemented", "startdoc", "abort", "name_not_found", "no_printer", "unexpected", "print_failure"'
