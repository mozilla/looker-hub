...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "startdoc", "name_not_found", "not_available", "enddoc", "start_page", "print_failure", "cannot_open_file", "no_printer", "gfx_printer_doc_is_busy", "notimplemented", "unexpected", "oom"'
