...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "name_not_found", "not_available", "cannot_open_file", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "oom", "start_page", "abort", "notimplemented", "startdoc", "print_failure"'
