...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "cannot_open_file", "startdoc", "name_not_found", "abort", "unexpected", "enddoc", "not_available", "start_page", "notimplemented", "no_printer", "gfx_printer_doc_is_busy", "print_failure"'
