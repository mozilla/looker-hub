...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "gfx_printer_doc_is_busy", "no_printer", "oom", "not_available", "unexpected", "start_page", "abort", "notimplemented", "startdoc", "enddoc", "name_not_found", "print_failure"'
