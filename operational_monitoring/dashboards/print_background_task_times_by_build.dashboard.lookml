...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "not_available", "oom", "gfx_printer_doc_is_busy", "notimplemented", "start_page", "name_not_found", "cannot_open_file", "no_printer", "startdoc", "abort", "unexpected", "print_failure"'
