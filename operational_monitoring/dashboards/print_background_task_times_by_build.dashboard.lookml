...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "abort", "no_printer", "unexpected", "startdoc", "start_page", "enddoc", "gfx_printer_doc_is_busy", "not_available", "notimplemented", "oom", "name_not_found"'
