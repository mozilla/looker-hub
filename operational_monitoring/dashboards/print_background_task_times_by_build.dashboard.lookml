...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "print_failure", "start_page", "oom", "not_available", "startdoc", "name_not_found", "abort", "cannot_open_file", "notimplemented", "enddoc", "no_printer", "gfx_printer_doc_is_busy"'
