...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "print_failure", "abort", "not_available", "startdoc", "no_printer", "gfx_printer_doc_is_busy", "notimplemented", "name_not_found", "enddoc", "start_page", "oom", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
