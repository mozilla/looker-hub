...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "startdoc", "cannot_open_file", "print_failure", "not_available", "abort", "unexpected", "start_page", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "oom", "no_printer"'
