...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "no_printer", "start_page", "oom", "not_available", "abort", "notimplemented", "startdoc", "gfx_printer_doc_is_busy", "name_not_found", "enddoc", "unexpected"'
