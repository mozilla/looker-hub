...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "enddoc", "start_page", "oom", "unexpected", "no_printer", "name_not_found", "notimplemented", "not_available", "startdoc", "gfx_printer_doc_is_busy", "abort", "cannot_open_file"'
