...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "unexpected", "cannot_open_file", "no_printer", "enddoc", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "notimplemented", "not_available", "oom", "start_page"'
