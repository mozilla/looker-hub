...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "no_printer", "start_page", "cannot_open_file", "not_available", "notimplemented", "name_not_found", "oom", "abort", "unexpected", "enddoc", "startdoc"'
