...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "unexpected", "start_page", "no_printer", "enddoc", "gfx_printer_doc_is_busy", "oom", "abort", "print_failure", "not_available", "notimplemented", "name_not_found", "cannot_open_file"'
