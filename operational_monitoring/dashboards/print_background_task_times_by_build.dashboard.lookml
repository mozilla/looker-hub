...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "unexpected", "abort", "name_not_found", "not_available", "gfx_printer_doc_is_busy", "cannot_open_file", "enddoc", "start_page", "startdoc", "print_failure", "no_printer", "oom"'
