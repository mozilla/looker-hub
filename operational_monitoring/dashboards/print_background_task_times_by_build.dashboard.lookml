...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "print_failure", "unexpected", "not_available", "enddoc", "abort", "notimplemented", "name_not_found", "no_printer", "oom", "start_page"'
