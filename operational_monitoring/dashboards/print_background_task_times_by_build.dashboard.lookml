...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "no_printer", "abort", "not_available", "oom", "print_failure", "cannot_open_file", "start_page", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "enddoc"'
