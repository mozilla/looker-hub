...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "cannot_open_file", "notimplemented", "gfx_printer_doc_is_busy", "no_printer", "enddoc", "unexpected", "name_not_found", "abort", "start_page", "print_failure", "not_available", "oom"'
