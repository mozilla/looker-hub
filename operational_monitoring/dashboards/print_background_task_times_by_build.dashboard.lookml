...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "notimplemented", "oom", "abort", "cannot_open_file", "startdoc", "unexpected", "enddoc", "start_page", "not_available", "name_not_found", "no_printer", "print_failure"'
