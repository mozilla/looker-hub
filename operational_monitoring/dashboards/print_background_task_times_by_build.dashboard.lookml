...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"notimplemented", "cannot_open_file", "no_printer", "not_available", "startdoc", "print_failure", "unexpected", "enddoc", "oom", "gfx_printer_doc_is_busy", "start_page", "abort", "name_not_found"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
