...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "oom", "gfx_printer_doc_is_busy", "abort", "not_available", "notimplemented", "startdoc", "print_failure", "unexpected", "enddoc", "start_page", "no_printer", "cannot_open_file"'
