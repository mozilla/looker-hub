...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "no_printer", "startdoc", "oom", "unexpected", "not_available", "start_page", "enddoc", "cannot_open_file", "abort", "notimplemented", "name_not_found", "print_failure"'
