...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "cannot_open_file", "enddoc", "startdoc", "unexpected", "gfx_printer_doc_is_busy", "not_available", "start_page", "name_not_found", "oom", "print_failure", "notimplemented", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
