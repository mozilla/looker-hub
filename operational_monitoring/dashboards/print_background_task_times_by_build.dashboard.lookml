...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "cannot_open_file", "enddoc", "abort", "oom", "gfx_printer_doc_is_busy", "startdoc", "name_not_found", "unexpected", "start_page", "notimplemented", "print_failure", "not_available"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
