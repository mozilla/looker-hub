...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "unexpected", "enddoc", "startdoc", "abort", "gfx_printer_doc_is_busy", "oom", "notimplemented", "not_available", "cannot_open_file", "print_failure", "no_printer", "start_page"'
