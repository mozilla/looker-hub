...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "start_page", "cannot_open_file", "no_printer", "enddoc", "startdoc", "not_available", "name_not_found", "oom", "notimplemented", "abort", "unexpected", "print_failure"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
