...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "cannot_open_file", "abort", "no_printer", "name_not_found", "not_available", "notimplemented", "start_page", "unexpected", "startdoc", "enddoc", "gfx_printer_doc_is_busy", "oom"'
