...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "startdoc", "cannot_open_file", "oom", "notimplemented", "abort", "start_page", "enddoc", "no_printer", "unexpected", "name_not_found", "not_available"'
