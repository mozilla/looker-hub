...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "not_available", "unexpected", "enddoc", "no_printer", "notimplemented", "start_page", "abort", "name_not_found", "gfx_printer_doc_is_busy", "startdoc", "oom", "cannot_open_file"'
