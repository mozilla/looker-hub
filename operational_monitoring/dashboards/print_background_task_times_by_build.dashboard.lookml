...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "enddoc", "startdoc", "oom", "start_page", "unexpected", "no_printer", "print_failure", "abort", "notimplemented", "gfx_printer_doc_is_busy", "name_not_found", "cannot_open_file"'
