...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "start_page", "oom", "enddoc", "print_failure", "gfx_printer_doc_is_busy", "unexpected", "notimplemented", "cannot_open_file", "startdoc", "name_not_found", "no_printer", "not_available"'
