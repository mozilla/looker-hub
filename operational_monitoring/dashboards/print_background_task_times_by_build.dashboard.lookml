...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "startdoc", "not_available", "notimplemented", "enddoc", "gfx_printer_doc_is_busy", "start_page", "abort", "no_printer", "cannot_open_file", "print_failure", "name_not_found", "oom"'
