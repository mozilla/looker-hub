...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "abort", "gfx_printer_doc_is_busy", "startdoc", "notimplemented", "not_available", "cannot_open_file", "enddoc", "start_page", "oom", "unexpected", "name_not_found", "print_failure"'
