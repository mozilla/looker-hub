...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "gfx_printer_doc_is_busy", "not_available", "cannot_open_file", "start_page", "abort", "enddoc", "no_printer", "print_failure", "unexpected", "name_not_found", "notimplemented", "startdoc"'
