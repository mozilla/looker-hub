...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "not_available", "no_printer", "unexpected", "name_not_found", "start_page", "print_failure", "abort", "notimplemented", "startdoc", "oom", "gfx_printer_doc_is_busy", "enddoc"'
