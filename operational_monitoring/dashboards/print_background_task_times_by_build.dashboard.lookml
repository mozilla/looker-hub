...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"not_available", "start_page", "unexpected", "abort", "notimplemented", "enddoc", "oom", "print_failure", "name_not_found", "startdoc", "no_printer", "gfx_printer_doc_is_busy", "cannot_open_file"'
