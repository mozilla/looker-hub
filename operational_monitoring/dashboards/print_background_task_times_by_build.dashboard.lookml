...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "oom", "no_printer", "not_available", "cannot_open_file", "abort", "startdoc", "gfx_printer_doc_is_busy", "print_failure", "start_page", "name_not_found", "notimplemented"'
