...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "unexpected", "gfx_printer_doc_is_busy", "name_not_found", "oom", "startdoc", "no_printer", "not_available", "abort", "notimplemented", "cannot_open_file", "print_failure", "start_page"'
