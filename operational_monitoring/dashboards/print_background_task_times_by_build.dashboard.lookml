...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "start_page", "no_printer", "gfx_printer_doc_is_busy", "not_available", "name_not_found", "print_failure", "cannot_open_file", "notimplemented", "enddoc", "abort", "startdoc", "unexpected"'
