...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"enddoc", "startdoc", "not_available", "unexpected", "notimplemented", "abort", "no_printer", "name_not_found", "cannot_open_file", "gfx_printer_doc_is_busy", "start_page", "oom", "print_failure"'
