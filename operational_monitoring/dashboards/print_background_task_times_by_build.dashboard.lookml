...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "notimplemented", "print_failure", "not_available", "start_page", "name_not_found", "oom", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "startdoc", "no_printer", "enddoc"'
