...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "print_failure", "abort", "startdoc", "not_available", "cannot_open_file", "enddoc", "start_page", "no_printer", "name_not_found", "notimplemented", "unexpected", "gfx_printer_doc_is_busy"'
