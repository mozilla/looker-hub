...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"oom", "not_available", "print_failure", "name_not_found", "gfx_printer_doc_is_busy", "cannot_open_file", "startdoc", "enddoc", "no_printer", "notimplemented", "start_page", "abort", "unexpected"'
