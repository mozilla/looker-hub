...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "abort", "not_available", "no_printer", "enddoc", "print_failure", "notimplemented", "startdoc", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "start_page", "oom"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
