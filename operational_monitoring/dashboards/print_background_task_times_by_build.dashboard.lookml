...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "not_available", "abort", "print_failure", "name_not_found", "notimplemented", "unexpected", "no_printer", "enddoc", "oom", "start_page", "startdoc", "gfx_printer_doc_is_busy"'
