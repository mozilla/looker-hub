...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"no_printer", "print_failure", "cannot_open_file", "not_available", "name_not_found", "gfx_printer_doc_is_busy", "notimplemented", "unexpected", "start_page", "enddoc", "oom", "startdoc", "abort"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
