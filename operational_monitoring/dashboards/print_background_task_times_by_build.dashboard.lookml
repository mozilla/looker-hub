...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "enddoc", "oom", "print_failure", "no_printer", "notimplemented", "start_page", "startdoc", "abort", "unexpected", "cannot_open_file", "gfx_printer_doc_is_busy", "not_available"'
