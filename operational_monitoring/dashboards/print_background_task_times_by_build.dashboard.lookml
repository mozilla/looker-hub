...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "print_failure", "no_printer", "start_page", "gfx_printer_doc_is_busy", "startdoc", "enddoc", "abort", "oom", "notimplemented", "unexpected", "not_available"'
