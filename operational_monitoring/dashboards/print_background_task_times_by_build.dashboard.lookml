...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"abort", "not_available", "startdoc", "notimplemented", "print_failure", "start_page", "enddoc", "oom", "gfx_printer_doc_is_busy", "name_not_found", "no_printer", "cannot_open_file", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 0
    col: 12
    width: 12
