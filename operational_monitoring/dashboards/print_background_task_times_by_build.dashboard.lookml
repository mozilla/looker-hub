...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "cannot_open_file", "startdoc", "print_failure", "oom", "not_available", "enddoc", "unexpected", "start_page", "gfx_printer_doc_is_busy", "abort", "notimplemented", "no_printer"'
