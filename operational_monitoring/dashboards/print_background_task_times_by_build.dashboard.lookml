...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"startdoc", "enddoc", "unexpected", "cannot_open_file", "print_failure", "start_page", "no_printer", "oom", "abort", "gfx_printer_doc_is_busy", "notimplemented", "name_not_found", "not_available"'
