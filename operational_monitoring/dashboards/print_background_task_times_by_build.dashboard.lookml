...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "enddoc", "startdoc", "start_page", "oom", "abort", "print_failure", "name_not_found", "no_printer", "notimplemented", "not_available", "gfx_printer_doc_is_busy", "unexpected"'
      print_background_task_times_by_build.statistic: sum
    row: 10
    col: 0
    width: 12
