...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"start_page", "abort", "enddoc", "gfx_printer_doc_is_busy", "name_not_found", "notimplemented", "print_failure", "cannot_open_file", "startdoc", "oom", "not_available", "no_printer", "unexpected"'
