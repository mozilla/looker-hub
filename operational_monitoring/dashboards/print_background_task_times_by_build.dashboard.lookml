...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "startdoc", "not_available", "gfx_printer_doc_is_busy", "no_printer", "abort", "enddoc", "notimplemented", "oom", "cannot_open_file", "print_failure", "unexpected", "start_page"'
