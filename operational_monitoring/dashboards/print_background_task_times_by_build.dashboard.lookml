...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"unexpected", "not_available", "startdoc", "print_failure", "notimplemented", "name_not_found", "abort", "gfx_printer_doc_is_busy", "enddoc", "oom", "no_printer", "cannot_open_file", "start_page"'
