...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "abort", "oom", "startdoc", "name_not_found", "no_printer", "enddoc", "start_page", "unexpected", "not_available", "gfx_printer_doc_is_busy", "notimplemented", "print_failure"'
