...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"cannot_open_file", "gfx_printer_doc_is_busy", "print_failure", "oom", "notimplemented", "startdoc", "not_available", "start_page", "enddoc", "abort", "unexpected", "name_not_found", "no_printer"'
