...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"gfx_printer_doc_is_busy", "oom", "startdoc", "cannot_open_file", "no_printer", "notimplemented", "enddoc", "print_failure", "not_available", "name_not_found", "abort", "unexpected", "start_page"'
