...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"print_failure", "gfx_printer_doc_is_busy", "abort", "cannot_open_file", "start_page", "no_printer", "startdoc", "not_available", "enddoc", "notimplemented", "unexpected", "oom", "name_not_found"'
