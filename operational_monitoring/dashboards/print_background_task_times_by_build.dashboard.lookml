...
- dashboard: print_background_task_times_by_build
  ...
  - title: Print Error Breakdown
    ...
    filters:
      print_background_task_times_by_build.metric: '"name_not_found", "print_failure", "start_page", "abort", "cannot_open_file", "unexpected", "enddoc", "notimplemented", "startdoc", "no_printer", "oom", "gfx_printer_doc_is_busy", "not_available"'
