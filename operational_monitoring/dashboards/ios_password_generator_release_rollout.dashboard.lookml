...
- dashboard: ios_password_generator_release_rollout
  title: Ios Password Generator Release Rollout
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      ios_password_generator_release_rollout.metric: 'retained'
  ...
  - title: Active Hours
    ...
    filters:
      ios_password_generator_release_rollout.metric: 'active_hours'
      ios_password_generator_release_rollout.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: ios_password_generator_release_rollout
    listens_to_filters: []
    field: ios_password_generator_release_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_password_generator_release_rollout
    listens_to_filters: []
    field: ios_password_generator_release_rollout.parameter
