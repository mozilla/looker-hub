...
- dashboard: ios_sync_manager_integration_rust_sync_manager_rollout
  ...
  - title: Memory Total
    ...
    fields: [
      ios_sync_manager_integration_rust_sync_manager_rollout.submission_date,
      ios_sync_manager_integration_rust_sync_manager_rollout.branch,
      ios_sync_manager_integration_rust_sync_manager_rollout.upper,
      ios_sync_manager_integration_rust_sync_manager_rollout.lower,
      ios_sync_manager_integration_rust_sync_manager_rollout.point
    ]
    pivots: [
      ios_sync_manager_integration_rust_sync_manager_rollout.branch
    ...
    filters:
      ios_sync_manager_integration_rust_sync_manager_rollout.metric: 'memory_total'
      ios_sync_manager_integration_rust_sync_manager_rollout.statistic: percentile
    row: 20
    col: 12
    width: 12
    height: 8
    ...
    listen:
      Date: ios_sync_manager_integration_rust_sync_manager_rollout.submission_date
      Percentile: ios_sync_manager_integration_rust_sync_manager_rollout.parameter
