...
- dashboard: address_autofill_desktop_pref_release_rollout
  title: Address Autofill Desktop Pref Release Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: address_autofill_desktop_pref_release_rollout
    listens_to_filters: []
    field: address_autofill_desktop_pref_release_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: address_autofill_desktop_pref_release_rollout
    listens_to_filters: []
    field: address_autofill_desktop_pref_release_rollout.parameter
