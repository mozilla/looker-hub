...
- dashboard: summarizer_mistral_model_rollout_language_extension
  title: Summarizer Mistral Model Rollout Language Extension
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      summarizer_mistral_model_rollout_language_extension.metric: 'ad_clicks'
      summarizer_mistral_model_rollout_language_extension.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: summarizer_mistral_model_rollout_language_extension
    listens_to_filters: []
    field: summarizer_mistral_model_rollout_language_extension.submission_date
  ...
  - name: Percentile
    ...
    explore: summarizer_mistral_model_rollout_language_extension
    listens_to_filters: []
    field: summarizer_mistral_model_rollout_language_extension.parameter
