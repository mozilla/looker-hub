...
- dashboard: sidebar_customization_message_day_3_users_all_locales_sticky_targeting
  title: Sidebar Customization Message Day 3 Users All Locales Sticky Targeting
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      sidebar_customization_message_day_3_users_all_locales_sticky_targeting.metric: 'ad_clicks'
  ...
  - title: Search Count
    ...
    filters:
      sidebar_customization_message_day_3_users_all_locales_sticky_targeting.metric: 'search_count'
      sidebar_customization_message_day_3_users_all_locales_sticky_targeting.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: sidebar_customization_message_day_3_users_all_locales_sticky_targeting
    listens_to_filters: []
    field: sidebar_customization_message_day_3_users_all_locales_sticky_targeting.submission_date
  ...
  - name: Percentile
    ...
    explore: sidebar_customization_message_day_3_users_all_locales_sticky_targeting
    listens_to_filters: []
    field: sidebar_customization_message_day_3_users_all_locales_sticky_targeting.parameter
