...
- dashboard: rootca_info_card_hcw2_fenix
  title: Rootca Info Card Hcw2 Fenix
  layout: newspaper
  ...
  - title: URI Count
    ...
    filters:
      rootca_info_card_hcw2_fenix.metric: 'uri_count'
      rootca_info_card_hcw2_fenix.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: rootca_info_card_hcw2_fenix
    listens_to_filters: []
    field: rootca_info_card_hcw2_fenix.submission_date
  ...
  - name: Percentile
    ...
    explore: rootca_info_card_hcw2_fenix
    listens_to_filters: []
    field: rootca_info_card_hcw2_fenix.parameter
