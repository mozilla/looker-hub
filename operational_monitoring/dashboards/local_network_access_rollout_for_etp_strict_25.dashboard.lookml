...
- dashboard: local_network_access_rollout_for_etp_strict_25
  title: Local Network Access Rollout For Etp Strict 25
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      ...
      local_network_access_rollout_for_etp_strict_25.upper,
      local_network_access_rollout_for_etp_strict_25.lower,
  ...
  - name: Date
    ...
    explore: local_network_access_rollout_for_etp_strict_25
    listens_to_filters: []
    field: local_network_access_rollout_for_etp_strict_25.submission_date
  ...
  - name: Percentile
    ...
    explore: local_network_access_rollout_for_etp_strict_25
    listens_to_filters: []
    field: local_network_access_rollout_for_etp_strict_25.parameter
