...
- dashboard: ios_web_compatibility_reporting_tool
  title: Ios Web Compatibility Reporting Tool
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      ios_web_compatibility_reporting_tool.metric: 'active_hours'
  ...
  - name: Date
    ...
    explore: ios_web_compatibility_reporting_tool
    listens_to_filters: []
    field: ios_web_compatibility_reporting_tool.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_web_compatibility_reporting_tool
    listens_to_filters: []
    field: ios_web_compatibility_reporting_tool.parameter
