...
- dashboard: firefox_labs_new_tab_widgets_lists_timer_december
  title: Firefox Labs New Tab Widgets Lists Timer December
  layout: newspaper
  ...
  - name: Date
    ...
    explore: firefox_labs_new_tab_widgets_lists_timer_december
    listens_to_filters: []
    field: firefox_labs_new_tab_widgets_lists_timer_december.submission_date
  ...
  - name: Percentile
    ...
    explore: firefox_labs_new_tab_widgets_lists_timer_december
    listens_to_filters: []
    field: firefox_labs_new_tab_widgets_lists_timer_december.parameter
