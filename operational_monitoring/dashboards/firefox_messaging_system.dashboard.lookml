...
- dashboard: firefox_messaging_system
  ...
  - title: Ping Volume By Ping Type
    ...
    filters:
      firefox_messaging_system.metric: '"null_ping_volume", "other_ping_volume", "cfr_ping_volume", "infobar_ping_volume", "spotlight_ping_volume", "moments_ping_volume", "whats_new_panel_ping_volume"'
