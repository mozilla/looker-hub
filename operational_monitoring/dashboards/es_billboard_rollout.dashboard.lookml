...
- dashboard: es_billboard_rollout
  title: Es Billboard Rollout
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      ...
      es_billboard_rollout.upper,
      es_billboard_rollout.lower,
    ...
    listen:
      ...
      Percentile: es_billboard_rollout.parameter
  ...
  - name: Date
    ...
    explore: es_billboard_rollout
    listens_to_filters: []
    field: es_billboard_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: es_billboard_rollout
    listens_to_filters: []
    field: es_billboard_rollout.parameter
