...
- dashboard: smart_window_whats_new_history_images
  title: Smart Window Whats New History Images
  layout: newspaper
  ...
  - title: URI Count
    ...
    filters:
      smart_window_whats_new_history_images.metric: 'uri_count'
      smart_window_whats_new_history_images.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: smart_window_whats_new_history_images
    listens_to_filters: []
    field: smart_window_whats_new_history_images.submission_date
  ...
  - name: Percentile
    ...
    explore: smart_window_whats_new_history_images
    listens_to_filters: []
    field: smart_window_whats_new_history_images.parameter
