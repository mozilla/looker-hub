...
- dashboard: pocket_newtab_existing_markets_us_rollout
  title: Pocket Newtab Existing Markets Us Rollout
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      pocket_newtab_existing_markets_us_rollout.metric: 'retained'
      pocket_newtab_existing_markets_us_rollout.statistic: mean
    row: 30
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: pocket_newtab_existing_markets_us_rollout
    listens_to_filters: []
    field: pocket_newtab_existing_markets_us_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: pocket_newtab_existing_markets_us_rollout
    listens_to_filters: []
    field: pocket_newtab_existing_markets_us_rollout.parameter
