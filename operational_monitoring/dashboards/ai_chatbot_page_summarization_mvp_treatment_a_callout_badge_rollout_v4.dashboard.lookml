...
- dashboard: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4
  title: Ai Chatbot Page Summarization Mvp Treatment A Callout Badge Rollout V4
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4.metric: 'ad_clicks'
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Days Of Use
    ...
    filters:
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4.metric: 'days_of_use'
      ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4
    listens_to_filters: []
    field: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4.submission_date
  ...
  - name: Percentile
    ...
    explore: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4
    listens_to_filters: []
    field: ai_chatbot_page_summarization_mvp_treatment_a_callout_badge_rollout_v4.parameter
