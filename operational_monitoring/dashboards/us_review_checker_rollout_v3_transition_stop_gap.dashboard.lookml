...
- dashboard: us_review_checker_rollout_v3_transition_stop_gap
  title: Us Review Checker Rollout V3 Transition Stop Gap
  layout: newspaper
  ...
  - name: Date
    ...
    explore: us_review_checker_rollout_v3_transition_stop_gap
    listens_to_filters: []
    field: us_review_checker_rollout_v3_transition_stop_gap.submission_date
  ...
  - name: Percentile
    ...
    explore: us_review_checker_rollout_v3_transition_stop_gap
    listens_to_filters: []
    field: us_review_checker_rollout_v3_transition_stop_gap.parameter
