...
- dashboard: win10_eos_survey_2025_it
  title: Win10 Eos Survey 2025 It
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      win10_eos_survey_2025_it.metric: 'search_count'
      win10_eos_survey_2025_it.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: win10_eos_survey_2025_it
    listens_to_filters: []
    field: win10_eos_survey_2025_it.submission_date
  ...
  - name: Percentile
    ...
    explore: win10_eos_survey_2025_it
    listens_to_filters: []
    field: win10_eos_survey_2025_it.parameter
