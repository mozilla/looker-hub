...
- dashboard: microsurvey_ios_world_cup_csat_en_holdback
  title: Microsurvey Ios World Cup Csat En Holdback
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      microsurvey_ios_world_cup_csat_en_holdback.metric: 'retained'
  ...
  - title: Days Of Use
    ...
    filters:
      microsurvey_ios_world_cup_csat_en_holdback.metric: 'days_of_use'
      microsurvey_ios_world_cup_csat_en_holdback.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Search Count
    ...
    filters:
      microsurvey_ios_world_cup_csat_en_holdback.metric: 'search_count'
      microsurvey_ios_world_cup_csat_en_holdback.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: microsurvey_ios_world_cup_csat_en_holdback
    listens_to_filters: []
    field: microsurvey_ios_world_cup_csat_en_holdback.submission_date
  ...
  - name: Percentile
    ...
    explore: microsurvey_ios_world_cup_csat_en_holdback
    listens_to_filters: []
    field: microsurvey_ios_world_cup_csat_en_holdback.parameter
