...
- dashboard: store_new_tab_content_interactions_locally_ca
  title: Store New Tab Content Interactions Locally Ca
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      store_new_tab_content_interactions_locally_ca.metric: 'ad_clicks'
      store_new_tab_content_interactions_locally_ca.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Active Hours
    ...
    filters:
      store_new_tab_content_interactions_locally_ca.metric: 'active_hours'
      store_new_tab_content_interactions_locally_ca.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - name: Date
    ...
    explore: store_new_tab_content_interactions_locally_ca
    listens_to_filters: []
    field: store_new_tab_content_interactions_locally_ca.submission_date
  ...
  - name: Percentile
    ...
    explore: store_new_tab_content_interactions_locally_ca
    listens_to_filters: []
    field: store_new_tab_content_interactions_locally_ca.parameter
