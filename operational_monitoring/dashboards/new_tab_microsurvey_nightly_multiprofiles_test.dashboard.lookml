...
- dashboard: new_tab_microsurvey_nightly_multiprofiles_test
  title: New Tab Microsurvey Nightly Multiprofiles Test
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      new_tab_microsurvey_nightly_multiprofiles_test.metric: 'search_count'
      new_tab_microsurvey_nightly_multiprofiles_test.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: new_tab_microsurvey_nightly_multiprofiles_test
    listens_to_filters: []
    field: new_tab_microsurvey_nightly_multiprofiles_test.submission_date
  ...
  - name: Percentile
    ...
    explore: new_tab_microsurvey_nightly_multiprofiles_test
    listens_to_filters: []
    field: new_tab_microsurvey_nightly_multiprofiles_test.parameter
