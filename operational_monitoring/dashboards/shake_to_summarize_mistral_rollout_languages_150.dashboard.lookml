...
- dashboard: shake_to_summarize_mistral_rollout_languages_150
  title: Shake To Summarize Mistral Rollout Languages 150
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      shake_to_summarize_mistral_rollout_languages_150.metric: 'active_hours'
  ...
  - title: Ad Clicks
    ...
    filters:
      shake_to_summarize_mistral_rollout_languages_150.metric: 'ad_clicks'
      shake_to_summarize_mistral_rollout_languages_150.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: shake_to_summarize_mistral_rollout_languages_150
    listens_to_filters: []
    field: shake_to_summarize_mistral_rollout_languages_150.submission_date
  ...
  - name: Percentile
    ...
    explore: shake_to_summarize_mistral_rollout_languages_150
    listens_to_filters: []
    field: shake_to_summarize_mistral_rollout_languages_150.parameter
