...
- dashboard: print_background_task_times
  ...
  - title: Print Cancel Ratios
    ...
    filters:
      print_background_task_times.metric: '"printing_dialog_without_preview_cancelled", "printing_preview_cancelled", "printing_preview_cancelled_tm", "printing_dialog_via_preview_cancelled_tm", "printing_dialog_via_preview_cancelled"'
