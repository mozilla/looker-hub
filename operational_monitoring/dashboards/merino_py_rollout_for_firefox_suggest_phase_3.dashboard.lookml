...
- dashboard: merino_py_rollout_for_firefox_suggest_phase_3
  title: Merino Py Rollout For Firefox Suggest Phase 3
  layout: newspaper
  ...
  - title: Memory Total
    ...
    fields: [
      ...
      merino_py_rollout_for_firefox_suggest_phase_3.upper,
      merino_py_rollout_for_firefox_suggest_phase_3.lower,
    ...
    filters:
      merino_py_rollout_for_firefox_suggest_phase_3.metric: 'memory_total'
      merino_py_rollout_for_firefox_suggest_phase_3.statistic: percentile
    row: 0
    col: 0
    width: 12
    height: 8
    ...
    listen:
      ...
      Percentile: merino_py_rollout_for_firefox_suggest_phase_3.parameter
  ...
  - name: Date
    ...
    explore: merino_py_rollout_for_firefox_suggest_phase_3
    listens_to_filters: []
    field: merino_py_rollout_for_firefox_suggest_phase_3.submission_date
  ...
  - name: Percentile
    ...
    explore: merino_py_rollout_for_firefox_suggest_phase_3
    listens_to_filters: []
    field: merino_py_rollout_for_firefox_suggest_phase_3.parameter
