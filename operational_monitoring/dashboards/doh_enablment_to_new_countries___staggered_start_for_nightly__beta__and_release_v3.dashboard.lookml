...
- dashboard: doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3
  ...
  - title: Gc Ms
    ...
    y_axes: [{type: log}]
    series_colors:
      active - doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3_histogram.percentile: "#ff6a06"
      active - doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3_histogram.high: "#ffb380"
      active - doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3_histogram.low: "#ffb380"
  ...
  - title: Content Crashes
    ...
    y_axes: [{type: log}]
    series_colors:
      active - doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3_scalar.percentile: "#ff6a06"
      active - doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3_scalar.high: "#ffb380"
      active - doh_enablment_to_new_countries___staggered_start_for_nightly__beta__and_release_v3_scalar.low: "#ffb380"
