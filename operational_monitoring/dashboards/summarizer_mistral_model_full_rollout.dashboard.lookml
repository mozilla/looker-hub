...
- dashboard: summarizer_mistral_model_full_rollout
  title: Summarizer Mistral Model Full Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: summarizer_mistral_model_full_rollout
    listens_to_filters: []
    field: summarizer_mistral_model_full_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: summarizer_mistral_model_full_rollout
    listens_to_filters: []
    field: summarizer_mistral_model_full_rollout.parameter
