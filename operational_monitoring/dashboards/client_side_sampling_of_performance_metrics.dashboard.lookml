...
- dashboard: client_side_sampling_of_performance_metrics
  title: Client Side Sampling Of Performance Metrics
  layout: newspaper
  ...
  - title: Retained
    ...
    filters:
      client_side_sampling_of_performance_metrics.metric: 'retained'
  ...
  - name: Date
    ...
    explore: client_side_sampling_of_performance_metrics
    listens_to_filters: []
    field: client_side_sampling_of_performance_metrics.submission_date
  ...
  - name: Percentile
    ...
    explore: client_side_sampling_of_performance_metrics
    listens_to_filters: []
    field: client_side_sampling_of_performance_metrics.parameter
