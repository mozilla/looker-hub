...
- dashboard: https_upgrades_fallback_time_bugfix
  title: Https Upgrades Fallback Time Bugfix
  layout: newspaper
  ...
  - name: Date
    ...
    explore: https_upgrades_fallback_time_bugfix
    listens_to_filters: []
    field: https_upgrades_fallback_time_bugfix.submission_date
  ...
  - name: Percentile
    ...
    explore: https_upgrades_fallback_time_bugfix
    listens_to_filters: []
    field: https_upgrades_fallback_time_bugfix.parameter
