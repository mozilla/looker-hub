...
- dashboard: disable_performanceclone_metrics
  title: Disable Performanceclone Metrics
  layout: newspaper
  ...
  - title: Tagged Sap Searches
    ...
    filters:
      disable_performanceclone_metrics.metric: 'tagged_sap_searches'
      disable_performanceclone_metrics.statistic: mean
    row: 10
    col: 12
    width: 12
  ...
  - title: Ad Clicks
    ...
    filters:
      disable_performanceclone_metrics.metric: 'ad_clicks'
      disable_performanceclone_metrics.statistic: mean
    row: 30
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: disable_performanceclone_metrics
    listens_to_filters: []
    field: disable_performanceclone_metrics.submission_date
  ...
  - name: Percentile
    ...
    explore: disable_performanceclone_metrics
    listens_to_filters: []
    field: disable_performanceclone_metrics.parameter
