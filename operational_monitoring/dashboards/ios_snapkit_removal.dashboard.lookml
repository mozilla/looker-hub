...
- dashboard: ios_snapkit_removal
  title: Ios Snapkit Removal
  layout: newspaper
  ...
  - title: Days Of Use
    ...
    filters:
      ios_snapkit_removal.metric: 'days_of_use'
      ios_snapkit_removal.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - title: Active Hours
    ...
    filters:
      ios_snapkit_removal.metric: 'active_hours'
      ios_snapkit_removal.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: ios_snapkit_removal
    listens_to_filters: []
    field: ios_snapkit_removal.submission_date
  ...
  - name: Percentile
    ...
    explore: ios_snapkit_removal
    listens_to_filters: []
    field: ios_snapkit_removal.parameter
