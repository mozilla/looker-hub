...
- dashboard: custom_wallpapers_message_rollout_release
  title: Custom Wallpapers Message Rollout Release
  layout: newspaper
  ...
  - title: URI Count
    ...
    filters:
      custom_wallpapers_message_rollout_release.metric: 'uri_count'
      custom_wallpapers_message_rollout_release.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Days Of Use
    ...
    filters:
      custom_wallpapers_message_rollout_release.metric: 'days_of_use'
      custom_wallpapers_message_rollout_release.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: custom_wallpapers_message_rollout_release
    listens_to_filters: []
    field: custom_wallpapers_message_rollout_release.submission_date
  ...
  - name: Percentile
    ...
    explore: custom_wallpapers_message_rollout_release
    listens_to_filters: []
    field: custom_wallpapers_message_rollout_release.parameter
