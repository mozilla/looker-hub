...
- dashboard: viewpoint_ios_rolling_week_4
  title: Viewpoint Ios Rolling Week 4
  layout: newspaper
  ...
  - title: Active Hours
    ...
    filters:
      viewpoint_ios_rolling_week_4.metric: 'active_hours'
      viewpoint_ios_rolling_week_4.statistic: mean
    row: 0
    col: 12
    width: 12
  ...
  - title: Ad Clicks
    ...
    filters:
      viewpoint_ios_rolling_week_4.metric: 'ad_clicks'
      viewpoint_ios_rolling_week_4.statistic: mean
    row: 10
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: viewpoint_ios_rolling_week_4
    listens_to_filters: []
    field: viewpoint_ios_rolling_week_4.submission_date
  ...
  - name: Percentile
    ...
    explore: viewpoint_ios_rolling_week_4
    listens_to_filters: []
    field: viewpoint_ios_rolling_week_4.parameter
