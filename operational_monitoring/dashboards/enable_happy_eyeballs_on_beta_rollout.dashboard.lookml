...
- dashboard: enable_happy_eyeballs_on_beta_rollout
  title: Enable Happy Eyeballs On Beta Rollout
  layout: newspaper
  ...
  - title: Search Count
    ...
    filters:
      enable_happy_eyeballs_on_beta_rollout.metric: 'search_count'
      enable_happy_eyeballs_on_beta_rollout.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - title: Memory Total
    ...
    fields: [
      enable_happy_eyeballs_on_beta_rollout.submission_date,
      enable_happy_eyeballs_on_beta_rollout.branch,
      enable_happy_eyeballs_on_beta_rollout.upper,
      enable_happy_eyeballs_on_beta_rollout.lower,
      enable_happy_eyeballs_on_beta_rollout.point
    ]
    pivots: [
      enable_happy_eyeballs_on_beta_rollout.branch
  ...
  - name: Date
    ...
    explore: enable_happy_eyeballs_on_beta_rollout
    listens_to_filters: []
    field: enable_happy_eyeballs_on_beta_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: enable_happy_eyeballs_on_beta_rollout
    listens_to_filters: []
    field: enable_happy_eyeballs_on_beta_rollout.parameter
