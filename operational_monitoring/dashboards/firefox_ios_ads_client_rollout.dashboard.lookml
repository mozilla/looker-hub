...
- dashboard: firefox_ios_ads_client_rollout
  title: Firefox Ios Ads Client Rollout
  layout: newspaper
  ...
  - title: Ad Clicks
    ...
    filters:
      firefox_ios_ads_client_rollout.metric: 'ad_clicks'
  ...
  - title: Active Hours
    ...
    filters:
      firefox_ios_ads_client_rollout.metric: 'active_hours'
      firefox_ios_ads_client_rollout.statistic: mean
    row: 20
    col: 0
    width: 12
  ...
  - name: Date
    ...
    explore: firefox_ios_ads_client_rollout
    listens_to_filters: []
    field: firefox_ios_ads_client_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: firefox_ios_ads_client_rollout
    listens_to_filters: []
    field: firefox_ios_ads_client_rollout.parameter
