...
- dashboard: fx_view_discoverability_rollout
  title: Fx View Discoverability Rollout
  layout: newspaper
  ...
  - name: Date
    ...
    explore: fx_view_discoverability_rollout
    listens_to_filters: []
    field: fx_view_discoverability_rollout.submission_date
  ...
  - name: Percentile
    ...
    explore: fx_view_discoverability_rollout
    listens_to_filters: []
    field: fx_view_discoverability_rollout.parameter
