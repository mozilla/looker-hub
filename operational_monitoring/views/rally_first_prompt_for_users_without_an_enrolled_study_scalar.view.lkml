...
view: rally_first_prompt_for_users_without_an_enrolled_study_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.rally_first_prompt_for_users_without_an_enrolled_study_scalar`
WHERE agg_type = "SUM" ;;
  }
