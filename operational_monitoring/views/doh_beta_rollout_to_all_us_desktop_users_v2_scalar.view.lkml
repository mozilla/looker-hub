...
view: doh_beta_rollout_to_all_us_desktop_users_v2_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.rollout_doh_beta_rollout_to_all_us_desktop_users_v2_beta_74_80_bug_1613489_scalar`
WHERE agg_type = "SUM" ;;
  }
