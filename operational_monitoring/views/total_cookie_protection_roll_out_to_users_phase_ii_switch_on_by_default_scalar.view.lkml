...
view: total_cookie_protection_roll_out_to_users_phase_ii_switch_on_by_default_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.total_cookie_protection_roll_out_to_users_phase_ii_switch_on_by_default_scalar`
WHERE agg_type = "SUM" ;;
  }
