...
view: bug_1767475_rollout_enable_pip_subtitles_pref_in_release_release_100_101_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1767475_rollout_enable_pip_subtitles_pref_in_release_release_100_101_scalar`
WHERE agg_type = "SUM" ;;
  }
