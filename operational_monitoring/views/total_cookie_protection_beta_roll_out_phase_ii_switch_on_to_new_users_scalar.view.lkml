...
view: total_cookie_protection_beta_roll_out_phase_ii_switch_on_to_new_users_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.total_cookie_protection_beta_roll_out_phase_ii_switch_on_to_new_users_scalar`
WHERE agg_type = "SUM" ;;
  }
