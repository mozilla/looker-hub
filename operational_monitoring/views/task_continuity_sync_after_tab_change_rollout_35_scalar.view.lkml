...
view: task_continuity_sync_after_tab_change_rollout_35_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.task_continuity_sync_after_tab_change_rollout_35_scalar`
WHERE agg_type = "SUM" ;;
  }
