...
view: bug_1715474_rollout_yandex_sponsored_tile_rollout_release_89_100_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1715474_rollout_yandex_sponsored_tile_rollout_release_89_100_scalar`
WHERE agg_type = "SUM" ;;
  }
