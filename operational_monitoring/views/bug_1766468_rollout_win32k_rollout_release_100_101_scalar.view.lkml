...
view: bug_1766468_rollout_win32k_rollout_release_100_101_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1766468_rollout_win32k_rollout_release_100_101_scalar`
WHERE agg_type = "SUM" ;;
  }
