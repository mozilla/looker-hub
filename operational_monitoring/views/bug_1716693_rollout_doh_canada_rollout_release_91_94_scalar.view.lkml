...
view: bug_1716693_rollout_doh_canada_rollout_release_91_94_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1716693_rollout_doh_canada_rollout_release_91_94_scalar`
WHERE agg_type = "SUM" ;;
  }
