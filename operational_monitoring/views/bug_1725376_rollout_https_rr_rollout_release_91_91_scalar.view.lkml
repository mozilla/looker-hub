...
view: bug_1725376_rollout_https_rr_rollout_release_91_91_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1725376_rollout_https_rr_rollout_release_91_91_scalar`
WHERE agg_type = "SUM" ;;
  }
