...
view: tcp_rollout_aurora_phase_iii_tcp_on_by_default_for_100_aurora_profiles_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.tcp_rollout_aurora_phase_iii_tcp_on_by_default_for_100_aurora_profiles_scalar`
WHERE agg_type = "SUM" ;;
  }
