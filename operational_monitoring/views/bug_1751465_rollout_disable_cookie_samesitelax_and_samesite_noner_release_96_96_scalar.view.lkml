...
view: bug_1751465_rollout_disable_cookie_samesitelax_and_samesite_noner_release_96_96_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1751465_rollout_disable_cookie_samesitelax_and_samesite_noner_release_96_96_scalar`
WHERE agg_type = "SUM" ;;
  }
