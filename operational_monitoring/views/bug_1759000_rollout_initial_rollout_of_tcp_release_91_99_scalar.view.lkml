...
view: bug_1759000_rollout_initial_rollout_of_tcp_release_91_99_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1759000_rollout_initial_rollout_of_tcp_release_91_99_scalar`
WHERE agg_type = "SUM" ;;
  }
