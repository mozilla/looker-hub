...
view: bug_1766618_rollout_disable_websocket_over_http2_release_91_100_scalar {
  derived_table: {
    sql: SELECT *
FROM `moz-fx-data-shared-prod.operational_monitoring.bug_1766618_rollout_disable_websocket_over_http2_release_91_100_scalar`
WHERE agg_type = "SUM" ;;
  }
