...
datagroup: bounce_tracking_protection_table_last_updated {
  ...
  description: "Updates for bounce_tracking_protection_table when moz-fx-data-shared-prod.org_mozilla_klar_stable.bounce_tracking_protection_v1 is modified."
