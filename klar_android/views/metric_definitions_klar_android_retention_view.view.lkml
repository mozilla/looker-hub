...
view: metric_definitions_klar_android_retention_view {
  derived_table: {
    sql: SELECT
...
klar_android_retention_view_active_metric_date,
...
klar_android_retention_view_new_profiles_metric_date,
klar_android_retention_view_normalized_channel,
klar_android_retention_view_paid_vs_organic,
klar_android_retention_view_ping_sent_metric_date,
klar_android_retention_view_ping_sent_week_4,
klar_android_retention_view_repeat_profiles,
klar_android_retention_view_retained_week_4,
klar_android_retention_view_retained_week_4_new_profiles,
...
klar_android_retention_view.active_metric_date AS klar_android_retention_view_active_metric_date,
...
klar_android_retention_view.normalized_channel AS klar_android_retention_view_normalized_channel,
...
klar_android_retention_view.ping_sent_week_4 AS klar_android_retention_view_ping_sent_week_4,
klar_android_retention_view.repeat_profiles AS klar_android_retention_view_repeat_profiles,
klar_android_retention_view.retained_week_4 AS klar_android_retention_view_retained_week_4,
klar_android_retention_view.retained_week_4_new_profiles AS klar_android_retention_view_retained_week_4_new_profiles,
    ...
    WHERE app_name = "Klar Android"
            ...
            ) AS klar_android_retention_view
...
klar_android_retention_view_retained_week_4_new_profiles,
  ...
  dimension: retention_rate_v1 {
    group_label: "Metrics"
    label: "Klar Android Retention Rate"
...
"
  ...
  dimension: new_profile_retention_rate_v1 {
    group_label: "Metrics"
    label: "Klar Android New Proflie Retention Rate"
