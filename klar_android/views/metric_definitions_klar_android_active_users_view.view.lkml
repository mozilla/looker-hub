...
view: metric_definitions_klar_android_active_users_view {
  derived_table: {
    sql: SELECT
...
looker_base_fields_user_agent__version,
            ...
            FROM
                (
                    SELECT
                        klar_android_active_users_view.*,
...
looker_base_fields.user_agent.version AS looker_base_fields_user_agent__version,
  ...
  FROM
    ...
    ON 
    klar_android_active_users_view.client_id =
        looker_base_fields.client_id AND
        klar_android_active_users_view.submission_date =
...
looker_base_fields_user_agent__version,
  ...
  dimension: client_level_daily_active_users_v1 {
    group_label: "Metrics"
    label: "Klar Android Client-Level DAU"
