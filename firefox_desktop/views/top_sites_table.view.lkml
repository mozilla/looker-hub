...
view: top_sites_table {
  ...
  dimension: metrics__url__quick_suggest_reporting_url {
    sql: ${TABLE}.metrics.url.quick_suggest_reporting_url ;;
    type: string
    suggest_persist_for: "24 hours"
  ...
  dimension: metrics__url__top_sites_reporting_url {
    sql: ${TABLE}.metrics.url.top_sites_reporting_url ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: URL"
  ...
  dimension: metrics__uuid__activity_stream_context_id {
    sql: ${TABLE}.metrics.uuid.activity_stream_context_id ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: UUID"
    group_item_label: "Activity Stream Context ID"
  }
...
view: top_sites_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: top_sites_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
