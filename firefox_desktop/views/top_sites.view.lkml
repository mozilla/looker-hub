...
view: top_sites {
  dimension: metrics__uuid__activity_stream_context_id {
    label: "Activity Stream Context Id"
    hidden: yes
    sql: ${TABLE}.metrics.uuid.activity_stream_context_id ;;
    type: string
    group_label: "Activity Stream"
    group_item_label: "Context Id"

    link: {
      label: "Glean Dictionary reference for Activity Stream Context Id"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/activity_stream_context_id"
...
view: top_sites__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
