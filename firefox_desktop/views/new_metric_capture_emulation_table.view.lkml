...
view: new_metric_capture_emulation_table {
...
view: new_metric_capture_emulation_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
  }
...
view: new_metric_capture_emulation_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: new_metric_capture_emulation_table__metrics__timing_distribution__wr_renderer_time__values {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: new_metric_capture_emulation_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
