...
view: new_metric_capture_emulation {
...
view: new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${new_metric_capture_emulation.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${new_metric_capture_emulation.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_label.key
    hidden: no
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${new_metric_capture_emulation.client_info__client_id} end ;;
    hidden: no
  }
}

view: new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_overflow
    suggest_dimension: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_overflow.key
    hidden: no
  }
...
view: new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_state
    suggest_dimension: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_state.key
    hidden: no
  }
...
view: new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_value
    suggest_dimension: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_value.key
    hidden: no
  }
...
view: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.firefox_desktop.new_metric_capture_emulation as t,
...
view: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_overflow {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_state {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__new_metric_capture_emulation__metrics__labeled_counter__glean_error_invalid_value {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: new_metric_capture_emulation__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
  }
...
view: new_metric_capture_emulation__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: new_metric_capture_emulation__metrics__timing_distribution__wr_renderer_time__values {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: new_metric_capture_emulation__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
