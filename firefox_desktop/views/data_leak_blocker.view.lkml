...
"
  ...
  sql_table_name: `mozdata.firefox_desktop.data_leak_blocker` ;;
}

view: data_leak_blocker__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error: Invalid Label"

  dimension: document_id {
    type: string
    sql: ${data_leak_blocker.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${data_leak_blocker.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${data_leak_blocker.client_info__client_id} end ;;
    hidden: no
  }
}

view: data_leak_blocker__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error: Invalid Overflow"
...
view: data_leak_blocker__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error: Invalid State"
...
view: data_leak_blocker__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error: Invalid Value"
...
view: data_leak_blocker__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: data_leak_blocker__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: data_leak_blocker__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: data_leak_blocker__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: data_leak_blocker__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
