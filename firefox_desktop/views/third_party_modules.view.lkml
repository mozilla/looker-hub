...
"
  ...
  sql_table_name: `mozdata.firefox_desktop.third_party_modules` ;;
}

view: third_party_modules__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${third_party_modules.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${third_party_modules.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${third_party_modules.client_info__client_id} end ;;
    hidden: no
  }
}

view: third_party_modules__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
...
view: third_party_modules__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
...
view: third_party_modules__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
...
view: third_party_modules__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: third_party_modules__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: third_party_modules__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
