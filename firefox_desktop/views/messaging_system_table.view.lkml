...
view: messaging_system_table {
  ...
  dimension: metrics__counter__messaging_system_last_window_close_trigger_bypassed {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Messaging System Last Window Close Trigger Bypassed"
  }
...
view: messaging_system_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: messaging_system_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
