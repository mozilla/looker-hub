...
looker_base_fields.sample_id AS looker_base_fields_sample_id,
  ...
  FROM
    ...
    ON 
    protections_popup_events.client_id =
        looker_base_fields.client_id AND
        protections_popup_events.submission_date =
...
looker_base_fields_sample_id,
  ...
  dimension: etp_disablement {
    group_label: "Metrics"
    label: "ETP Disablement"
    description: ""
    type: number
    sql: ${TABLE}.etp_disablement ;;
  }
