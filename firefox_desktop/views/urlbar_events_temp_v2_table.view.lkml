...
view: urlbar_events_temp_v2_table {
  ...
  sql_table_name: `mozdata.firefox_desktop.urlbar_events_temp_v2` ;;
}

view: urlbar_events_temp_v2_table__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: urlbar_events_temp_v2_table__results {
  dimension: position {
    sql: ${TABLE}.position ;;
    type: number
  }
