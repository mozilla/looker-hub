...
view: newtab_content {
  dimension: metrics__string__newtab_content_coarse_os {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/newtab_content_coarse_os"
...
"
  ...
  dimension: metrics__string__newtab_content_coarse_os_version {
    ...
    type: string
    group_label: "Newtab Content"
    group_item_label: "Coarse OS Version"

    link: {
      label: "Glean Dictionary reference for Newtab Content Coarse OS Version"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/newtab_content_coarse_os_version"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__newtab_content_utc_offset {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/newtab_content_utc_offset"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: newtab_content__metrics__labeled_counter__glean_error_invalid_label {
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__newtab_content__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__newtab_content__metrics__labeled_counter__glean_error_invalid_label.key
    hidden: no
  }
...
view: suggest__newtab_content__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.firefox_desktop.newtab_content as t,
