...
looker_base_fields.sample_id AS looker_base_fields_sample_id,
  ...
  FROM
    ...
    ON 
    site_breakage_events.client_id =
        looker_base_fields.client_id AND
        site_breakage_events.submission_date =
...
looker_base_fields_sample_id,
  ...
  dimension: site_breakage_impressions {
    group_label: "Metrics"
    label: "Webcompat Reporting Panel Impressions"
    description: ""
    type: number
    sql: ${TABLE}.site_breakage_impressions ;;
  }

  dimension: site_breakage_uses {
    group_label: "Metrics"
    label: "Webcompat Reporting Panel Uses"
    description: ""
    type: number
    sql: ${TABLE}.site_breakage_uses ;;
  }
  ...
  set: metrics {
    fields: [site_breakage_impressions, site_breakage_uses]
  }
