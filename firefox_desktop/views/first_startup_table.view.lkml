...
view: first_startup_table {
  ...
  dimension: metrics__quantity__first_startup_nimbus_init_time {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "First Startup Nimbus Init Time"
  }
  ...
  dimension: metrics__quantity__first_startup_nimbus_loader_init_time {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "First Startup Nimbus Loader Init Time"
  }
  ...
  dimension: metrics__quantity__first_startup_nimbus_manager_init_time {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "First Startup Nimbus Manager Init Time"
  }
  ...
  dimension: metrics__quantity__first_startup_nimbus_store_init_time {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "First Startup Nimbus Store Init Time"
  }
...
view: first_startup_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: first_startup_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
