...
view: onboarding_opt_out__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${onboarding_opt_out.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${onboarding_opt_out.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
...
view: onboarding_opt_out__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
...
view: onboarding_opt_out__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
...
view: onboarding_opt_out__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
...
view: suggest__onboarding_opt_out__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.firefox_desktop.onboarding_opt_out as t,
...
view: onboarding_opt_out__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: onboarding_opt_out__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
