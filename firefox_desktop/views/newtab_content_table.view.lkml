...
"
  ...
  dimension: metrics__string_list__newtab_content_followed_sections {
    ...
    hidden: yes
    description: "Optional metric: section ids followed by user in alphabetical order, if possible, ordered by most recently followed. Max 2 sections
"
  }
  ...
  sql_table_name: `mozdata.firefox_desktop.newtab_content` ;;
}

view: newtab_content_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: newtab_content_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
