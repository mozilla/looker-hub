...
view: quick_suggest_table {
  ...
  dimension: metrics__string__quick_suggest_suggestion_id {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Quick Suggest Suggestion ID"
  }
...
view: quick_suggest_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: quick_suggest_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
