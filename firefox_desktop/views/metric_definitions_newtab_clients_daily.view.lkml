  ...
  measure: any_content_engagement_visits_rolling_average_ratio_28_day {
    ...
    sql: {% if metric_definitions_newtab_clients_daily.submission_date._is_selected or
                                                    ...
                                                    AVG(${any_content_engagement_visits_ratio}) OVER (
                                                        PARTITION BY {% if metric_definitions_newtab_clients_daily.ads_value_tier._is_selected %}${TABLE}.countries_ads_value_tier,{% endif %}{% if metric_definitions_newtab_clients_daily.code._is_selected %}${TABLE}.countries_code,{% endif %}{% if metric_definitions_newtab_clients_daily.code_3._is_selected %}${TABLE}.countries_code_3,{% endif %}{% if metric_definitions_newtab_clients_daily.mozilla_vpn_available._is_selected %}${TABLE}.countries_mozilla_vpn_available,{% endif %}{% if metric_definitions_newtab_clients_daily.name._is_selected %}${TABLE}.countries_name,{% endif %}{% if metric_definitions_newtab_clients_daily.pocket_available_on_newtab._is_selected %}${TABLE}.countries_pocket_available_on_newtab,{% endif %}{% if metric_definitions_newtab_clients_daily.region_name._is_selected %}${TABLE}.countries_region_name,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_tiles_available_on_newtab._is_selected %}${TABLE}.countries_sponsored_tiles_available_on_newtab,{% endif %}{% if metric_definitions_newtab_clients_daily.subregion_name._is_selected %}${TABLE}.countries_subregion_name,{% endif %}{% if metric_definitions_newtab_clients_daily.all_visits._is_selected %}${TABLE}.newtab_clients_daily_all_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.any_content_click_count._is_selected %}${TABLE}.newtab_clients_daily_any_content_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.any_content_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_any_content_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.any_content_impression_count._is_selected %}${TABLE}.newtab_clients_daily_any_content_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.any_content_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_any_content_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.any_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_any_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.any_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_any_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.any_topsite_click_count._is_selected %}${TABLE}.newtab_clients_daily_any_topsite_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.any_topsite_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_any_topsite_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.any_topsite_impression_count._is_selected %}${TABLE}.newtab_clients_daily_any_topsite_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.any_topsite_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_any_topsite_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.app_name._is_selected %}${TABLE}.newtab_clients_daily_app_name,{% endif %}{% if metric_definitions_newtab_clients_daily.app_version._is_selected %}${TABLE}.newtab_clients_daily_app_version,{% endif %}{% if metric_definitions_newtab_clients_daily.avg_newtab_visit_duration._is_selected %}${TABLE}.newtab_clients_daily_avg_newtab_visit_duration,{% endif %}{% if metric_definitions_newtab_clients_daily.channel._is_selected %}${TABLE}.newtab_clients_daily_channel,{% endif %}{% if metric_definitions_newtab_clients_daily.content_thumbs_down_count._is_selected %}${TABLE}.newtab_clients_daily_content_thumbs_down_count,{% endif %}{% if metric_definitions_newtab_clients_daily.content_thumbs_down_visits._is_selected %}${TABLE}.newtab_clients_daily_content_thumbs_down_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.content_thumbs_up_count._is_selected %}${TABLE}.newtab_clients_daily_content_thumbs_up_count,{% endif %}{% if metric_definitions_newtab_clients_daily.content_thumbs_up_visits._is_selected %}${TABLE}.newtab_clients_daily_content_thumbs_up_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.country._is_selected %}${TABLE}.newtab_clients_daily_country,{% endif %}{% if metric_definitions_newtab_clients_daily.cumulative_newtab_visit_duration._is_selected %}${TABLE}.newtab_clients_daily_cumulative_newtab_visit_duration,{% endif %}{% if metric_definitions_newtab_clients_daily.default_private_search_engine._is_selected %}${TABLE}.newtab_clients_daily_default_private_search_engine,{% endif %}{% if metric_definitions_newtab_clients_daily.default_search_engine._is_selected %}${TABLE}.newtab_clients_daily_default_search_engine,{% endif %}{% if metric_definitions_newtab_clients_daily.default_ui_visits._is_selected %}${TABLE}.newtab_clients_daily_default_ui_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.experiments._is_selected %}${TABLE}.newtab_clients_daily_experiments,{% endif %}{% if metric_definitions_newtab_clients_daily.geo_subdivision._is_selected %}${TABLE}.newtab_clients_daily_geo_subdivision,{% endif %}{% if metric_definitions_newtab_clients_daily.homepage_category._is_selected %}${TABLE}.newtab_clients_daily_homepage_category,{% endif %}{% if metric_definitions_newtab_clients_daily.locale._is_selected %}${TABLE}.newtab_clients_daily_locale,{% endif %}{% if metric_definitions_newtab_clients_daily.newtab_blocked_sponsors._is_selected %}${TABLE}.newtab_clients_daily_newtab_blocked_sponsors,{% endif %}{% if metric_definitions_newtab_clients_daily.newtab_category._is_selected %}${TABLE}.newtab_clients_daily_newtab_category,{% endif %}{% if metric_definitions_newtab_clients_daily.newtab_content_surface_id._is_selected %}${TABLE}.newtab_clients_daily_newtab_content_surface_id,{% endif %}{% if metric_definitions_newtab_clients_daily.newtab_search_enabled._is_selected %}${TABLE}.newtab_clients_daily_newtab_search_enabled,{% endif %}{% if metric_definitions_newtab_clients_daily.newtab_weather_enabled._is_selected %}${TABLE}.newtab_clients_daily_newtab_weather_enabled,{% endif %}{% if metric_definitions_newtab_clients_daily.nonsearch_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_nonsearch_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.nonsearch_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_nonsearch_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_click_count._is_selected %}${TABLE}.newtab_clients_daily_organic_content_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_dismissal_count._is_selected %}${TABLE}.newtab_clients_daily_organic_content_dismissal_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_dismissal_visits._is_selected %}${TABLE}.newtab_clients_daily_organic_content_dismissal_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_enabled._is_selected %}${TABLE}.newtab_clients_daily_organic_content_enabled,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_organic_content_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_impression_count._is_selected %}${TABLE}.newtab_clients_daily_organic_content_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_content_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_organic_content_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsite_click_count._is_selected %}${TABLE}.newtab_clients_daily_organic_topsite_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsite_dismissal_count._is_selected %}${TABLE}.newtab_clients_daily_organic_topsite_dismissal_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsite_dismissal_visits._is_selected %}${TABLE}.newtab_clients_daily_organic_topsite_dismissal_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsite_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_organic_topsite_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsite_impression_count._is_selected %}${TABLE}.newtab_clients_daily_organic_topsite_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsite_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_organic_topsite_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.organic_topsites_enabled._is_selected %}${TABLE}.newtab_clients_daily_organic_topsites_enabled,{% endif %}{% if metric_definitions_newtab_clients_daily.os._is_selected %}${TABLE}.newtab_clients_daily_os,{% endif %}{% if metric_definitions_newtab_clients_daily.other_impression_count._is_selected %}${TABLE}.newtab_clients_daily_other_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.other_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_other_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.others_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_others_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.profile_group_id._is_selected %}${TABLE}.newtab_clients_daily_profile_group_id,{% endif %}{% if metric_definitions_newtab_clients_daily.sample_id._is_selected %}${TABLE}.newtab_clients_daily_sample_id,{% endif %}{% if metric_definitions_newtab_clients_daily.search_ad_click_count._is_selected %}${TABLE}.newtab_clients_daily_search_ad_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.search_ad_click_visits._is_selected %}${TABLE}.newtab_clients_daily_search_ad_click_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.search_ad_impression_count._is_selected %}${TABLE}.newtab_clients_daily_search_ad_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.search_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_search_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.search_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_search_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_click_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_dismissal_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_dismissal_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_dismissal_visits._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_dismissal_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_enabled._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_enabled,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_impression_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_content_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_content_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsite_click_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsite_click_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsite_dismissal_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsite_dismissal_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsite_dismissal_visits._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsite_dismissal_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsite_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsite_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsite_impression_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsite_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsite_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsite_interaction_count,{% endif %}{% if metric_definitions_newtab_clients_daily.sponsored_topsites_enabled._is_selected %}${TABLE}.newtab_clients_daily_sponsored_topsites_enabled,{% endif %}{% if metric_definitions_newtab_clients_daily.topsite_rows._is_selected %}${TABLE}.newtab_clients_daily_topsite_rows,{% endif %}{% if metric_definitions_newtab_clients_daily.topsite_sponsored_tiles_configured._is_selected %}${TABLE}.newtab_clients_daily_topsite_sponsored_tiles_configured,{% endif %}{% if metric_definitions_newtab_clients_daily.widget_engagement_visits._is_selected %}${TABLE}.newtab_clients_daily_widget_engagement_visits,{% endif %}{% if metric_definitions_newtab_clients_daily.widget_impression_count._is_selected %}${TABLE}.newtab_clients_daily_widget_impression_count,{% endif %}{% if metric_definitions_newtab_clients_daily.widget_interaction_count._is_selected %}${TABLE}.newtab_clients_daily_widget_interaction_count,{% endif %} 1
