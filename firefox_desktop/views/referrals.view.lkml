...
view: referrals {
  dimension: metrics__string__browser_referral_code {
    label: "Browser: Referral Code"
    hidden: no
    sql: ${TABLE}.metrics.string.browser_referral_code ;;
    type: string
    group_label: "Browser"
    group_item_label: "Referral Code"

    link: {
      label: "Glean Dictionary reference for Browser: Referral Code"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop/metrics/browser_referral_code"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "The referral code extracted from attribution data on first run. Recorded
...
"
  ...
  sql_table_name: `mozdata.firefox_desktop.referrals` ;;
}

view: referrals__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error: Invalid Label"

  dimension: document_id {
    type: string
    sql: ${referrals.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${referrals.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${referrals.client_info__client_id} end ;;
    hidden: no
  }
}

view: referrals__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error: Invalid Overflow"
...
view: referrals__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error: Invalid State"
...
view: referrals__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error: Invalid Value"
...
view: referrals__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: referrals__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: referrals__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
