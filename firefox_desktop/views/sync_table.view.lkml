...
"
  ...
  dimension: metrics__object__syncs_migrations {
    ...
    hidden: yes
    description: "The application-services developers are in the process of oxidizing parts
...
```text
  [{
    ...
    openFailure: A boolean flag that is true if we hit a read error prior to . This likely indicates complete corruptio"
  }

  dimension: metrics__object__syncs_syncs {
    sql: ${TABLE}.metrics.object.syncs_syncs ;;
    hidden: yes
    description: "Recorded syncs.
