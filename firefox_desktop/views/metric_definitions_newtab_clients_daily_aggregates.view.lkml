...
newtab_clients_daily_aggregates_base_fields_sponsored_topsites_enabled,
  ...
  measure: any_content_engagement_visits_28_day_rolling_average {
    type: number
    label: "Any Content Engagement Visits 28 Day Rolling Average"
    sql: AVG(sum(${TABLE}.any_content_engagement_visits * 1)) OVER (
                                                ROWS 28 PRECEDING
                                        ) ;;
    group_label: "Statistics"
  ...
  measure: any_content_engagement_clients_28_day_rolling_average {
    type: number
    label: "Any Content Engagement clients 28 Day Rolling Average"
    sql: AVG(sum(${TABLE}.any_content_engagement_clients * 1)) OVER (
                                                ROWS 28 PRECEDING
                                        ) ;;
    group_label: "Statistics"
  ...
  set: metrics {
    fields: [
      ...
      any_content_engagement_visits_28_day_rolling_average,
      ...
      any_content_engagement_clients_28_day_rolling_average,
