...
"
  ...
  dimension: metrics__object__browser_backup_restored_profile_data {
    ...
    hidden: yes
    description: "Describes the backup that was restored to make the current profile. If This is not a restored profile, `is_restored` will be set to `false` and no other values will be set.
"
  }
