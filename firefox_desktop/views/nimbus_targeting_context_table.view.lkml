...
"
  ...
  dimension: metrics__object__nimbus_targeting_context_default_pdf_handler {
    ...
    hidden: yes
    description: "Information about the system's default PDF handler.
"
  }
...
"
  ...
  dimension: metrics__object__nimbus_targeting_context_is_default_handler {
    ...
    hidden: yes
    description: "Whether the current browser is registered as the default handler for various filetypes.
"
  }
