...
datagroup: baseline_clients_last_seen_table_last_updated {
  ...
  description: "Updates for baseline_clients_last_seen_table when moz-fx-data-shared-prod.firefox_desktop_derived.baseline_clients_last_seen_v1 is modified."
