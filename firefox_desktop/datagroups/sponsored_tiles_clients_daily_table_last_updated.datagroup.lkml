...
datagroup: sponsored_tiles_clients_daily_table_last_updated {
  ...
  description: "Updates for sponsored_tiles_clients_daily_table when moz-fx-data-shared-prod.telemetry_derived.sponsored_tiles_clients_daily_v1 is modified."
