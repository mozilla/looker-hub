...
datagroup: composite_active_users_aggregates_table_last_updated {
  ...
  sql_trigger: SELECT MAX(storage_last_modified_time)
    ...
    WHERE (table_schema = 'firefox_ios' AND table_name = 'active_users_aggregates') OR (table_schema = 'firefox_ios' AND table_name = 'usage_reporting_active_users_aggregates') ;;
