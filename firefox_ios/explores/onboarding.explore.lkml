...
include: "/looker-hub/firefox_ios/views/onboarding.view.lkml"
include: "/looker-hub/firefox_ios/datagroups/onboarding_last_updated.datagroup.lkml"

explore: onboarding {
  sql_always_where: ${onboarding.submission_date} >= '2010-01-01' ;;
  view_label: " Onboarding"
  description: "Explore for the onboarding ping. A ping representing events in the onboarding flow. Sent when the user first sees onboarding (after ToS), when the user advances a card, and when the user finishes onboarding (skip or complete)."
