...
explore: temp_baseline {
  ...
  join: temp_baseline__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${temp_baseline.ping_info__server_knobs_config__metrics_enabled}) AS temp_baseline__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: temp_baseline__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${temp_baseline.ping_info__server_knobs_config__pings_enabled}) AS temp_baseline__ping_info__server_knobs_config__pings_enabled ;;
  }
