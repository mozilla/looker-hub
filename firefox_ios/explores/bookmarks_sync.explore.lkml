...
explore: bookmarks_sync {
  ...
  join: bookmarks_sync__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${bookmarks_sync.ping_info__server_knobs_config__metrics_enabled}) AS bookmarks_sync__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: bookmarks_sync__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${bookmarks_sync.ping_info__server_knobs_config__pings_enabled}) AS bookmarks_sync__ping_info__server_knobs_config__pings_enabled ;;
  }
