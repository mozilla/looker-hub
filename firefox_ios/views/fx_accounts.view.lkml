...
view: fx_accounts {
  dimension: metrics__string__user_client_association_uid {
    label: "User Client Association: Uid"
    hidden: no
    sql: ${TABLE}.metrics.string.user_client_association_uid ;;
    type: string
    group_label: "User Client Association"
    group_item_label: "Uid"

    link: {
      label: "Glean Dictionary reference for User Client Association: Uid"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/user_client_association_uid"
...
"
  ...
  sql_table_name: `mozdata.firefox_ios.fx_accounts` ;;
}
