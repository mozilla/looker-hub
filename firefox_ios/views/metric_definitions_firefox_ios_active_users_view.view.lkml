...
COALESCE(MIN(days_since_active), 30) < 3 AS active_in_last_3_days,
...
looker_base_fields.user_agent.version AS looker_base_fields_user_agent__version,
  ...
  FROM
    ...
    ON 
    firefox_ios_active_users_view.client_id =
...
"
  ...
  set: metrics {
    fields: [client_level_daily_active_users_v3, active_in_last_3_days]
  }
