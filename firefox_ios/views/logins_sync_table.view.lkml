...
view: logins_sync_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.logins_sync"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.logins_sync"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.logins_sync"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.logins_sync"
    }
  }
