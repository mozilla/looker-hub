...
view: active_users_aggregates_table {
  ...
  dimension: app_version_is_major_release {
    ...
    type: yesno
    suggest_persist_for: "24 hours"
    description: "Flag to indicate whether the browser version is a major release."
  }
  ...
  dimension: app_version_patch_revision {
    ...
    type: number
    suggest_persist_for: "24 hours"
    description: "The patch revision for the installed version of the browser."
  }
  ...
  dimension: os_grouped {
    ...
    type: string
    suggest_persist_for: "24 hours"
    description: "Grouping of operating system into families (Windows, Linux, Mac, iOS, Android, other)."
  }
  ...
  sql_table_name: `mozdata.firefox_ios.active_users_aggregates` ;;
}