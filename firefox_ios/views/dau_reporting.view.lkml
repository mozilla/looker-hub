...
"
  ...
  sql_table_name: `mozdata.org_mozilla_ios_firefoxbeta.dau_reporting` ;;
}
...
view: dau_reporting__metrics__labeled_counter__search_counts {
  label: "Search - Counts"
...
view: dau_reporting__metrics__labeled_counter__search_in_content {
  label: "Search - In Content"
...
view: suggest__dau_reporting__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.org_mozilla_ios_firefoxbeta.dau_reporting as t,
