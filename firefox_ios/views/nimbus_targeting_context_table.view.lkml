...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.nimbus_targeting_context"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.nimbus_targeting_context"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.nimbus_targeting_context"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.nimbus_targeting_context"
    }
  }
