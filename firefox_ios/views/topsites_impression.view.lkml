...
view: topsites_impression {
  dimension: metrics__uuid__top_site_context_id {
    ...
    link: {
      label: "Glean Dictionary reference for Top Site Context Id"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/top_site_context_id"
...
"
  ...
  dimension: metrics__string__top_site_contile_advertiser {
    ...
    link: {
      label: "Glean Dictionary reference for Top Site Contile Advertiser"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/top_site_contile_advertiser"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__top_site_contile_tile_id {
    ...
    link: {
      label: "Glean Dictionary reference for Top Site Contile Tile Id"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/top_site_contile_tile_id"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  sql_table_name: `mozdata.firefox_ios.topsites_impression` ;;
}
...
view: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.firefox_ios.topsites_impression as t,
...
view: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_overflow {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_state {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_value {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: topsites_impression__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${topsites_impression.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${topsites_impression.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_label.key
    hidden: no
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${topsites_impression.client_info__client_id} end ;;
    hidden: no
  }
}

view: topsites_impression__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_overflow
    suggest_dimension: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_overflow.key
    hidden: no
  }
...
view: topsites_impression__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_state
    suggest_dimension: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_state.key
    hidden: no
  }
...
view: topsites_impression__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_value
    suggest_dimension: suggest__topsites_impression__metrics__labeled_counter__glean_error_invalid_value.key
    hidden: no
  }
...
view: topsites_impression__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
  }
...
view: topsites_impression__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: topsites_impression__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
