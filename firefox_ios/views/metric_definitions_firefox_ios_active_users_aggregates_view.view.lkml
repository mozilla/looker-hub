...
view: metric_definitions_firefox_ios_active_users_aggregates_view {
  derived_table: {
    sql: SELECT
...
firefox_ios_active_users_aggregates_view_adjust_network,
firefox_ios_active_users_aggregates_view_app_name,
firefox_ios_active_users_aggregates_view_app_version,
firefox_ios_active_users_aggregates_view_app_version_is_major_release,
firefox_ios_active_users_aggregates_view_app_version_major,
firefox_ios_active_users_aggregates_view_app_version_minor,
firefox_ios_active_users_aggregates_view_app_version_patch_revision,
firefox_ios_active_users_aggregates_view_attributed,
firefox_ios_active_users_aggregates_view_attribution_medium,
firefox_ios_active_users_aggregates_view_attribution_source,
firefox_ios_active_users_aggregates_view_channel,
firefox_ios_active_users_aggregates_view_city,
firefox_ios_active_users_aggregates_view_country,
firefox_ios_active_users_aggregates_view_daily_users,
firefox_ios_active_users_aggregates_view_dau,
firefox_ios_active_users_aggregates_view_distribution_id,
firefox_ios_active_users_aggregates_view_first_seen_year,
firefox_ios_active_users_aggregates_view_install_source,
firefox_ios_active_users_aggregates_view_is_default_browser,
firefox_ios_active_users_aggregates_view_locale,
firefox_ios_active_users_aggregates_view_mau,
firefox_ios_active_users_aggregates_view_monthly_users,
firefox_ios_active_users_aggregates_view_os,
firefox_ios_active_users_aggregates_view_os_grouped,
...
firefox_ios_active_users_aggregates_view.adjust_network AS firefox_ios_active_users_aggregates_view_adjust_network,
firefox_ios_active_users_aggregates_view.app_name AS firefox_ios_active_users_aggregates_view_app_name,
firefox_ios_active_users_aggregates_view.app_version AS firefox_ios_active_users_aggregates_view_app_version,
firefox_ios_active_users_aggregates_view.app_version_is_major_release AS firefox_ios_active_users_aggregates_view_app_version_is_major_release,
firefox_ios_active_users_aggregates_view.app_version_major AS firefox_ios_active_users_aggregates_view_app_version_major,
firefox_ios_active_users_aggregates_view.app_version_minor AS firefox_ios_active_users_aggregates_view_app_version_minor,
firefox_ios_active_users_aggregates_view.app_version_patch_revision AS firefox_ios_active_users_aggregates_view_app_version_patch_revision,
firefox_ios_active_users_aggregates_view.attributed AS firefox_ios_active_users_aggregates_view_attributed,
firefox_ios_active_users_aggregates_view.attribution_medium AS firefox_ios_active_users_aggregates_view_attribution_medium,
firefox_ios_active_users_aggregates_view.attribution_source AS firefox_ios_active_users_aggregates_view_attribution_source,
firefox_ios_active_users_aggregates_view.channel AS firefox_ios_active_users_aggregates_view_channel,
firefox_ios_active_users_aggregates_view.city AS firefox_ios_active_users_aggregates_view_city,
firefox_ios_active_users_aggregates_view.country AS firefox_ios_active_users_aggregates_view_country,
firefox_ios_active_users_aggregates_view.daily_users AS firefox_ios_active_users_aggregates_view_daily_users,
firefox_ios_active_users_aggregates_view.dau AS firefox_ios_active_users_aggregates_view_dau,
firefox_ios_active_users_aggregates_view.distribution_id AS firefox_ios_active_users_aggregates_view_distribution_id,
firefox_ios_active_users_aggregates_view.first_seen_year AS firefox_ios_active_users_aggregates_view_first_seen_year,
firefox_ios_active_users_aggregates_view.install_source AS firefox_ios_active_users_aggregates_view_install_source,
firefox_ios_active_users_aggregates_view.is_default_browser AS firefox_ios_active_users_aggregates_view_is_default_browser,
firefox_ios_active_users_aggregates_view.locale AS firefox_ios_active_users_aggregates_view_locale,
firefox_ios_active_users_aggregates_view.mau AS firefox_ios_active_users_aggregates_view_mau,
firefox_ios_active_users_aggregates_view.monthly_users AS firefox_ios_active_users_aggregates_view_monthly_users,
firefox_ios_active_users_aggregates_view.os AS firefox_ios_active_users_aggregates_view_os,
firefox_ios_active_users_aggregates_view.os_grouped AS firefox_ios_active_users_aggregates_view_os_grouped,
...
firefox_ios_active_users_aggregates_view.weekly_users AS firefox_ios_active_users_aggregates_view_weekly_users,
    ...
    WHERE app_name = 'Firefox iOS'
            ...
            ) AS firefox_ios_active_users_aggregates_view
        
                    WHERE 
                    firefox_ios_active_users_aggregates_view.submission_date
                    BETWEEN
                    COALESCE(
                        SAFE_CAST(
...
"
  ...
  dimension: adjust_network {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_adjust_network ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: app_name {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_app_name ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: app_version {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_app_version ;;
    type: string
    group_label: "Base Fields"
  }
  ...
  dimension: app_version_patch_revision {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_app_version_patch_revision ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: attributed {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_attributed ;;
    type: yesno
    group_label: "Base Fields"
  }

  dimension: attribution_medium {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_attribution_medium ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: attribution_source {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_attribution_source ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: channel {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_channel ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: city {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_city ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: country {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_country ;;
    type: string
  ...
  dimension: daily_users {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_daily_users ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: dau {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_dau ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: distribution_id {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_distribution_id ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: first_seen_year {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_first_seen_year ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: install_source {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_install_source ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: is_default_browser {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_is_default_browser ;;
    type: yesno
    group_label: "Base Fields"
  }

  dimension: locale {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_locale ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: mau {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_mau ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: monthly_users {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_monthly_users ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: os {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_os ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: os_grouped {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_os_grouped ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: os_version {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_os_version ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: os_version_major {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_os_version_major ;;
    type: number
    group_label: "Base Fields"
  }
  ...
  dimension: segment {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_segment ;;
    type: string
    group_label: "Base Fields"
  }

  dimension: wau {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_wau ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: weekly_users {
    sql: ${TABLE}.firefox_ios_active_users_aggregates_view_weekly_users ;;
    type: number
    group_label: "Base Fields"
  }
