...
"
  ...
  dimension: metrics__quantity__fx_suggest_block_id {
    ...
    group_item_label: "Fx Suggest Block ID"
  }
  ...
  dimension: metrics__quantity__fx_suggest_position {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Quantity"
    group_item_label: "Fx Suggest Position"
  }
  ...
  dimension: metrics__string__fx_suggest_iab_category {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Fx Suggest Iab Category"
  }
...
"
  ...
  dimension: metrics__url__fx_suggest_reporting_url {
    ...
    group_item_label: "Fx Suggest Reporting URL"
  }
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.fx_suggest"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.fx_suggest"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.fx_suggest"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.fx_suggest"
    }
  }
...
view: fx_suggest_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_suggest_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_suggest_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_suggest_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
