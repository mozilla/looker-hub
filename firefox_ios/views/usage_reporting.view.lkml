...
view: usage_reporting {
  dimension: metrics__uuid__usage_profile_id {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/usage_profile_id"
...
"
  ...
  sql_table_name: `mozdata.firefox_ios.usage_reporting` ;;
}
...
view: suggest__usage_reporting__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.firefox_ios.usage_reporting as t,
...
view: usage_reporting__metrics__timing_distribution__usage_duration__values {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
