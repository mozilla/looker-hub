...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.first_session"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.first_session"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.first_session"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.first_session"
    }
  }
