...
"
  ...
  dimension: metrics__labeled_string__sync_v2_failure_reason {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_ios/metrics/sync_v2_failure_reason"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  sql_table_name: `mozdata.firefox_ios.sync` ;;
}
...
view: suggest__sync__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.firefox_ios.sync as t,
