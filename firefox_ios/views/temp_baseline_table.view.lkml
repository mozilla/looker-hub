...
"
  ...
  dimension: metrics__timespan__baseline_validation_baseline_duration__time_unit {
    sql: ${TABLE}.metrics.timespan.baseline_validation_baseline_duration.time_unit ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Timespan: Baseline Validation Baseline Duration"
  ...
  dimension: metrics__timespan__baseline_validation_startup_duration__time_unit {
    sql: ${TABLE}.metrics.timespan.baseline_validation_startup_duration.time_unit ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Timespan: Baseline Validation Startup Duration"
    group_item_label: "Time Unit"
  }
  ...
  dimension: metrics__timespan__baseline_validation_visible_duration__time_unit {
    sql: ${TABLE}.metrics.timespan.baseline_validation_visible_duration.time_unit ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Timespan: Baseline Validation Visible Duration"
    group_item_label: "Time Unit"
  }
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.temp_baseline"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.temp_baseline"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.temp_baseline"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.temp_baseline"
    }
  }
...
view: temp_baseline_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_baseline_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_baseline_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_baseline_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_baseline_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
