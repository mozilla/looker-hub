...
view: topsites_impression_table {
...
view: topsites_impression_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
  }
...
view: topsites_impression_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: topsites_impression_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
