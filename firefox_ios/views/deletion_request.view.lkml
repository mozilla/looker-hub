view: deletion_request {
  sql_table_name: `moz-fx-data-shared-prod.org_mozilla_ios_firefox.deletion_request`
    ;;
...
view: deletion_request__client_info {
...
view: deletion_request__metadata__geo {
  dimension: city {
    type: string
    sql: ${TABLE}.city ;;
  }
...
view: deletion_request__metadata__isp {
  dimension: db_version {
    type: string
    sql: ${TABLE}.db_version ;;
  }
...
view: deletion_request__metadata__header {
  dimension: date {
    type: string
    sql: ${TABLE}.date ;;
  }
...
view: deletion_request__metadata__user_agent {
  dimension: browser {
    type: string
    sql: ${TABLE}.browser ;;
  }
...
view: deletion_request__ping_info {
  dimension: end_time {
    type: string
    sql: ${TABLE}.end_time ;;
  }
...
view: deletion_request__ping_info__experiments__value__extra {
  dimension: type {
    type: string
    sql: ${TABLE}.type ;;
  }
...
view: deletion_request__ping_info__experiments__value {
  dimension: branch {
    type: string
    sql: ${TABLE}.branch ;;
  }
...
view: deletion_request__metrics__string {
  dimension: deletion_sync_device_id {
    type: string
    sql: ${TABLE}.deletion_sync_device_id ;;
  }
}

view: deletion_request__metrics__jwe {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: deletion_request__metrics__uuid {
  dimension: deletion_fxa_device_id {
    type: string
    sql: ${TABLE}.deletion_fxa_device_id ;;
  }

  dimension: legacy_ids_client_id {
    type: string
    sql: ${TABLE}.legacy_ids_client_id ;;
  }
}
...
view: deletion_request__metadata {
  dimension: geo {
    hidden: yes
    sql: ${TABLE}.geo ;;
  }
...
view: deletion_request__metrics__labeled_counter {
...
view: deletion_request__metrics {
  dimension: jwe {
    hidden: yes
    sql: ${TABLE}.jwe ;;
  }
