...
view: creditcards_sync_table {
  ...
  dimension: metrics__datetime__raw_creditcards_sync_finished_at {
    ...
    group_item_label: "Raw Creditcards Sync Finished At"
  }

  dimension: metrics__datetime__raw_creditcards_sync_started_at {
    sql: ${TABLE}.metrics.datetime.raw_creditcards_sync_started_at ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Datetime"
  ...
  dimension_group: metrics__datetime__creditcards_sync_finished_at {
    ...
    label: "Metrics: Datetime: Creditcards Sync Finished At"
  }
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.creditcards_sync"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.creditcards_sync"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.creditcards_sync"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.creditcards_sync"
    }
  }
...
view: creditcards_sync_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: creditcards_sync_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: creditcards_sync_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: creditcards_sync_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: creditcards_sync_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
