...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.firefox_ios.broken_site_report"

    allowed_value: {
      label: "Release"
      value: "mozdata.firefox_ios.broken_site_report"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_ios_firefoxbeta.broken_site_report"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_ios_fennec.broken_site_report"
    }
  }
