...
"
  ...
  sql_table_name: `mozdata.firefox_ios.temp_logins_sync` ;;
}
...
view: temp_logins_sync__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_logins_sync__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
