...
"
  ...
  sql_table_name: `mozdata.firefox_ios.temp_rust_tabs_sync` ;;
}
...
view: temp_rust_tabs_sync__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
  }
...
view: temp_rust_tabs_sync__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: temp_rust_tabs_sync__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
