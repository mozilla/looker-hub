...
view: mr_2022_weekly_statistics_desktop_existing_users {
  ...
  sql_table_name: `moz-fx-data-experiments.mozanalysis.statistics_106_major_release_firefox_existing_user_experience_weekly` ;;
}