...
include: "/looker-hub/mozphab/views/usage.view.lkml"

explore: usage {
  sql_always_where: ${usage.submission_date} >= '2010-01-01' ;;
  view_label: " Usage"
  description: "Explore for the usage ping. This ping is intended to provide a measure of the usage of MozPhab. It's generated after a command is finished."
  view_name: usage
