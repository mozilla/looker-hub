...
"
  ...
  dimension: metrics__string__event_outcome {
    ...
    link: {
      label: "Glean Dictionary reference for Event: Outcome"
      url: "https://dictionary.telemetry.mozilla.org/apps/accounts_frontend/metrics/event_outcome"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "Context-dependent (on event.name) result of an operation, e.g. \"success\"
...
view: accounts_events__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: accounts_events__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
