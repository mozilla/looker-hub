...
view: events_stream_table {
  ...
  dimension: extras__quantity__time_saved {
    sql: ${TABLE}.extras.quantity.time_saved ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Extras: Quantity"
    group_item_label: "Time Saved"
  }

  dimension: extras__string__entity_ref {
    sql: ${TABLE}.extras.string.entity_ref ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Extras: String"
    group_item_label: "Entity Ref"
  }
  ...
  sql_table_name: `mozdata.moz_backstage.events_stream` ;;
}