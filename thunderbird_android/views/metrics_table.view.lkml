...
view: metrics_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.thunderbird_android.metrics"

    allowed_value: {
      label: "Release"
      value: "mozdata.thunderbird_android.metrics"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.net_thunderbird_android_beta.metrics"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.net_thunderbird_android_daily.metrics"
    }
  }
