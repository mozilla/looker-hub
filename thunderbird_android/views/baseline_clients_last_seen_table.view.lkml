...
view: baseline_clients_last_seen_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.thunderbird_android.baseline_clients_last_seen"

    allowed_value: {
      label: "Release"
      value: "mozdata.thunderbird_android.baseline_clients_last_seen"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.net_thunderbird_android_beta.baseline_clients_last_seen"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.net_thunderbird_android_daily.baseline_clients_last_seen"
    }
  }
