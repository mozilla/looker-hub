...
view: campaigns_monthly {
  dimension: advertiser_id {
    ...
    description: "A foreign key value that provides the unique identification of an advertiser"
  }
  ...
  dimension: advertiser_name {
    ...
    type: string
    suggest_persist_for: "24 hours"
    description: "Readable business name of the advertising company or organization"
  }
  ...
  dimension: campaign_id {
    ...
    type: number
    suggest_persist_for: "24 hours"
    description: "A value that provides the unique identification of an advertising campaign, used to link to line items"
  }
  ...
  dimension: campaign_name {
    ...
    type: string
    suggest_persist_for: "24 hours"
    description: "Human-readable campaign name, typically including advertiser and time period for easy identification"
  }
  ...
  dimension_group: campaign_end {
    ...
    convert_tz: no
    datatype: date
    description: "Scheduled end date for the overall campaign period"
  }
  ...
  dimension_group: campaign_start {
    ...
    convert_tz: no
    datatype: date
    description: "Scheduled start date for the overall campaign period"
  }
