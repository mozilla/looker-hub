...
datagroup: captcha_detection_table_last_updated {
  ...
  description: "Updates for captcha_detection_table when moz-fx-data-shared-prod.firefox_desktop_background_update_stable.captcha_detection_v1 is modified."
