...
datagroup: baseline_clients_first_seen_table_last_updated {
  ...
  description: "Updates for baseline_clients_first_seen_table when moz-fx-data-shared-prod.firefox_desktop_background_update_derived.baseline_clients_daily_v1 is modified."
