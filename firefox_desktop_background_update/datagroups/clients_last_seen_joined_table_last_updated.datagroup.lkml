...
datagroup: clients_last_seen_joined_table_last_updated {
  ...
  description: "Updates for clients_last_seen_joined_table when moz-fx-data-shared-prod.firefox_desktop_background_update_derived.clients_last_seen_joined_v1 is modified."
