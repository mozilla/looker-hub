...
"
  ...
  dimension: metrics__string__deletion_request_sync_device_id {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_desktop_background_update/metrics/deletion_request_sync_device_id"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: suggest__deletion_request__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.firefox_desktop_background_update.deletion_request as t,
