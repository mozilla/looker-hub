...
view: daily_active_service_subscriptions {
  ...
  dimension: service_subscriptions_history_id {
    ...
    type: string
    suggest_persist_for: "24 hours"
    description: "ID of the `service_subscriptions_history_v1` record this daily snapshot record was derived from."
  }
...
This will be null for Google and Apple subscriptions."
  ...
  dimension_group: date {
    ...
    convert_tz: no
    datatype: date
    description: "The day during which the service subscription was active."
  }
...
This will be null for Apple subscriptions."
  ...
  sql_table_name: `mozdata.subscription_platform.daily_active_service_subscriptions` ;;
}

view: daily_active_service_subscriptions__subscription__other_services {
  dimension: id {
    sql: ${TABLE}.id ;;
    type: string
    suggest_persist_for: "24 hours"
