...
"
  ...
  dimension: metrics__string__glean_database_load_error {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_database_load_error"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__string__glean_database_rkv_load_error {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_database_rkv_load_error"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__counter__glean_migration_error {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_migration_error"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__counter__glean_migration_failed_metrics {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_migration_failed_metrics"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__counter__glean_migration_metrics_in_sqlite {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_migration_metrics_in_sqlite"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__counter__glean_migration_migrated_metrics {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_migration_migrated_metrics"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__timing_distribution__glean_migration_migration_duration__sum {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/mozilla_vpn/metrics/glean_migration_migration_duration"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: metrics__metrics__timing_distribution__performance_time_to_main_screen__values {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
