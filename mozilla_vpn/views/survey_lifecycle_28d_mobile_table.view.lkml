...
view: survey_lifecycle_28d_mobile_table {
  dimension: id {
    sql: ${TABLE}.id ;;
    type: number
...
view: survey_lifecycle_28d_mobile_table__survey_data__options {
  dimension: answer {
    sql: ${TABLE}.answer ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: survey_lifecycle_28d_mobile_table__url_variables {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
