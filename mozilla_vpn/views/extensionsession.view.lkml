...
"
  ...
  sql_table_name: `mozdata.mozilla_vpn.extensionsession` ;;
}

view: extensionsession__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${extensionsession.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${extensionsession.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__extensionsession__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__extensionsession__metrics__labeled_counter__glean_error_invalid_label.key
    hidden: no
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${extensionsession.client_info__client_id} end ;;
    hidden: no
  }
}

view: extensionsession__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
...
view: extensionsession__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
...
view: extensionsession__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
...
view: suggest__extensionsession__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.mozilla_vpn.extensionsession as t,
...
view: extensionsession__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: extensionsession__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
