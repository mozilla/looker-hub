...
view: active_users_aggregates_tou_desktop {
  ...
  dimension: tou_daily_active_users {
    ...
    type: number
    suggest_persist_for: "24 hours"
    description: "The number of daily active users who have accepted the Terms of Use, corresponding to the count of clients that reported at least one ping on the submission_date and qualify as active."
  }
  ...
  dimension: tou_monthly_active_users {
    ...
    type: number
    suggest_persist_for: "24 hours"
    description: "The number of monthly active users who have accepted the Terms of Use, corresponding to the count of clients that reported at least one ping on the previous 28 days from the submission_date and qualify as active."
  }
  ...
  dimension: tou_weekly_active_users {
    ...
    type: number
    suggest_persist_for: "24 hours"
    description: "The number of weekly active users who have accepted the Terms of Use, corresponding to the count of clients that reported at least one ping on the previous 7 days from the submission_date and qualify as active."
  }
  ...
  sql_table_name: `moz-fx-data-shared-prod.telemetry.active_users_aggregates_tou_desktop` ;;
}