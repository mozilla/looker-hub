...
view: baseline {
  dimension: metrics__timespan__glean_baseline_duration__value {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/moso_mastodon_backend/metrics/glean_baseline_duration"
...
"
  ...
  dimension: metrics__string__glean_baseline_locale {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/moso_mastodon_backend/metrics/glean_baseline_locale"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: suggest__baseline__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.moso_mastodon_backend.baseline as t,
