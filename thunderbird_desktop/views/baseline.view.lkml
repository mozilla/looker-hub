...
view: baseline {
  dimension: metrics__timespan__glean_baseline_duration__value {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/thunderbird_desktop/metrics/glean_baseline_duration"
...
"
  ...
  dimension: metrics__string__glean_baseline_locale {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/thunderbird_desktop/metrics/glean_baseline_locale"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
view: suggest__baseline__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.thunderbird_desktop.baseline as t,
