...
view: temp_fog_initial_state {
  dimension: metrics__counter__fog_inits_during_shutdown {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/thunderbird_desktop/metrics/fog_inits_during_shutdown"
...
"
  ...
  sql_table_name: `mozdata.thunderbird_desktop.temp_fog_initial_state` ;;
}

view: temp_fog_initial_state__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${temp_fog_initial_state.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${temp_fog_initial_state.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${temp_fog_initial_state.client_info__client_id} end ;;
    hidden: no
  }
}

view: temp_fog_initial_state__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
...
view: temp_fog_initial_state__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
...
view: temp_fog_initial_state__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
...
view: temp_fog_initial_state__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_fog_initial_state__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_fog_initial_state__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
