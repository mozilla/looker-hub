...
datagroup: new_profile_metrics_marketing_geo_testing_table_last_updated {
  ...
  description: "Updates for new_profile_metrics_marketing_geo_testing_table when moz-fx-data-shared-prod.fenix_derived.new_profile_metrics_marketing_geo_testing_v1 is modified."
