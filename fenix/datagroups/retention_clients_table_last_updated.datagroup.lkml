...
datagroup: retention_clients_table_last_updated {
  ...
  sql_trigger: SELECT MAX(storage_last_modified_time)
    ...
    WHERE (table_schema = 'fenix' AND table_name = 'active_users') OR (table_schema = 'fenix' AND table_name = 'attribution_clients') OR (table_schema = 'fenix' AND table_name = 'baseline_clients_daily') ;;
