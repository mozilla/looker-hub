...
view: play_store_attribution_table {
...
"
  ...
  dimension: metrics__string__play_store_attribution_response_code {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Play Store Attribution Response Code"
  }
...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.play_store_attribution"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.play_store_attribution"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.play_store_attribution"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.play_store_attribution"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.play_store_attribution"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.play_store_attribution"
    }
  }
...
view: play_store_attribution_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: play_store_attribution_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: play_store_attribution_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: play_store_attribution_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: play_store_attribution_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
