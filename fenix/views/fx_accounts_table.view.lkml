...
"
  ...
  dimension: metrics__string__metrics_client_association {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Metrics Client Association"
  }
...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.fx_accounts"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.fx_accounts"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.fx_accounts"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.fx_accounts"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.fx_accounts"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.fx_accounts"
    }
  }
...
view: fx_accounts_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
