...
view: usage_reporting_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.usage_reporting"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.usage_reporting"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.usage_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.usage_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.usage_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.usage_reporting"
    }
  }
