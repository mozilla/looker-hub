...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.gecko_trace"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.gecko_trace"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.gecko_trace"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.gecko_trace"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.gecko_trace"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.gecko_trace"
    }
  }
...
view: gecko_trace_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: gecko_trace_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
