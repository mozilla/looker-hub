...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.onboarding"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.onboarding"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.onboarding"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.onboarding"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.onboarding"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.onboarding"
    }
  }
