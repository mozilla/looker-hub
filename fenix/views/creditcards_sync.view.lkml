...
"
  ...
  measure: creditcards_sync_outgoing_batches {
    type: sum
    sql: ${metrics__counter__creditcards_sync_outgoing_batches} ;;
  ...
  measure: creditcards_sync_outgoing_batches_client_count {
    type: count_distinct
    filters: [
      metrics__counter__creditcards_sync_outgoing_batches: ">0",
    ]
    sql: ${client_info__client_id} ;;
  ...
  measure: creditcards_sync_v2_outgoing_batches {
    type: sum
    sql: ${metrics__counter__creditcards_sync_v2_outgoing_batches} ;;
  ...
  measure: creditcards_sync_v2_outgoing_batches_client_count {
    type: count_distinct
    filters: [
      metrics__counter__creditcards_sync_v2_outgoing_batches: ">0",
    ]
    sql: ${client_info__client_id} ;;
...
view: creditcards_sync__metrics__labeled_counter__creditcards_sync_incoming {
  ...
  dimension: document_id {
    type: string
    sql: ${creditcards_sync.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${creditcards_sync.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
...
view: creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_incoming {
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_incoming
    suggest_dimension: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_incoming.key
    hidden: no
  }
...
view: creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_outgoing {
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_outgoing
    suggest_dimension: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_outgoing.key
    hidden: no
  }
...
view: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_incoming {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_outgoing {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_incoming {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.fenix.creditcards_sync as t,
unnest(metrics.labeled_counter.creditcards_sync_v2_incoming) as m
where date(submission_timestamp) > date_sub(current_date, interval 30 day)
    and sample_id = 0
group by key
order by n desc ;;
...
view: suggest__creditcards_sync__metrics__labeled_counter__creditcards_sync_v2_outgoing {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.fenix.creditcards_sync as t,
unnest(metrics.labeled_counter.creditcards_sync_v2_outgoing) as m
where date(submission_timestamp) > date_sub(current_date, interval 30 day)
    and sample_id = 0
group by key
order by n desc ;;
...
view: suggest__creditcards_sync__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__creditcards_sync__metrics__labeled_counter__glean_error_invalid_overflow {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__creditcards_sync__metrics__labeled_counter__glean_error_invalid_state {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: suggest__creditcards_sync__metrics__labeled_counter__glean_error_invalid_value {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
...
view: creditcards_sync__metrics__labeled_string__creditcards_sync_v2_failure_reason {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
