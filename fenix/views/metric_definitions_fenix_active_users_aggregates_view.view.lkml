...
view: metric_definitions_fenix_active_users_aggregates_view {
  derived_table: {
    sql: SELECT
...
fenix_active_users_aggregates_view_adjust_network,
...
fenix_active_users_aggregates_view_attribution_source,
fenix_active_users_aggregates_view_channel,
fenix_active_users_aggregates_view_city,
fenix_active_users_aggregates_view_country,
fenix_active_users_aggregates_view_daily_users,
fenix_active_users_aggregates_view_dau,
fenix_active_users_aggregates_view_distribution_id,
fenix_active_users_aggregates_view_first_seen_year,
fenix_active_users_aggregates_view_install_source,
fenix_active_users_aggregates_view_is_default_browser,
fenix_active_users_aggregates_view_locale,
fenix_active_users_aggregates_view_mau,
fenix_active_users_aggregates_view_monthly_users,
fenix_active_users_aggregates_view_os,
fenix_active_users_aggregates_view_os_grouped,
...
fenix_active_users_aggregates_view.adjust_network AS fenix_active_users_aggregates_view_adjust_network,
...
fenix_active_users_aggregates_view.attribution_source AS fenix_active_users_aggregates_view_attribution_source,
fenix_active_users_aggregates_view.channel AS fenix_active_users_aggregates_view_channel,
fenix_active_users_aggregates_view.city AS fenix_active_users_aggregates_view_city,
fenix_active_users_aggregates_view.country AS fenix_active_users_aggregates_view_country,
fenix_active_users_aggregates_view.daily_users AS fenix_active_users_aggregates_view_daily_users,
fenix_active_users_aggregates_view.dau AS fenix_active_users_aggregates_view_dau,
fenix_active_users_aggregates_view.distribution_id AS fenix_active_users_aggregates_view_distribution_id,
fenix_active_users_aggregates_view.first_seen_year AS fenix_active_users_aggregates_view_first_seen_year,
fenix_active_users_aggregates_view.install_source AS fenix_active_users_aggregates_view_install_source,
fenix_active_users_aggregates_view.is_default_browser AS fenix_active_users_aggregates_view_is_default_browser,
fenix_active_users_aggregates_view.locale AS fenix_active_users_aggregates_view_locale,
fenix_active_users_aggregates_view.mau AS fenix_active_users_aggregates_view_mau,
fenix_active_users_aggregates_view.monthly_users AS fenix_active_users_aggregates_view_monthly_users,
fenix_active_users_aggregates_view.os AS fenix_active_users_aggregates_view_os,
fenix_active_users_aggregates_view.os_grouped AS fenix_active_users_aggregates_view_os_grouped,
...
fenix_active_users_aggregates_view.weekly_users AS fenix_active_users_aggregates_view_weekly_users,
    ...
    WHERE app_name = 'Fenix'
            ...
            ) AS fenix_active_users_aggregates_view
...
"
  ...
  dimension: app_version_major {
    sql: ${TABLE}.fenix_active_users_aggregates_view_app_version_major ;;
    type: number
    group_label: "Base Fields"
  }

  dimension: app_version_minor {
    sql: ${TABLE}.fenix_active_users_aggregates_view_app_version_minor ;;
    type: number
    group_label: "Base Fields"
  }
