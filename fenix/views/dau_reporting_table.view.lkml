...
view: dau_reporting_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.dau_reporting"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.dau_reporting"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.dau_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.dau_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.dau_reporting"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.dau_reporting"
    }
  }
...
view: dau_reporting_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: dau_reporting_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: dau_reporting_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
