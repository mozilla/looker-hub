...
"
  ...
  dimension: metrics__string__play_store_attribution_response_code {
    label: "Play Store Attribution Response Code"
    hidden: no
    sql: ${TABLE}.metrics.string.play_store_attribution_response_code ;;
    type: string
    group_label: "Play Store Attribution"
    group_item_label: "Response Code"

    link: {
      label: "Glean Dictionary reference for Play Store Attribution Response Code"
      url: "https://dictionary.telemetry.mozilla.org/apps/fenix/metrics/play_store_attribution_response_code"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "The response code of the install referrer API.
"
  }
...
"
  ...
  sql_table_name: `mozdata.fenix.play_store_attribution` ;;
}

view: play_store_attribution__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error - Invalid Label"

  dimension: document_id {
    type: string
    sql: ${play_store_attribution.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${play_store_attribution.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__play_store_attribution__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__play_store_attribution__metrics__labeled_counter__glean_error_invalid_label.key
    hidden: no
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${play_store_attribution.client_info__client_id} end ;;
    hidden: no
  }
}

view: play_store_attribution__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error - Invalid Overflow"
...
view: play_store_attribution__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error - Invalid State"
...
view: play_store_attribution__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error - Invalid Value"
...
view: suggest__play_store_attribution__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.fenix.play_store_attribution as t,
...
view: play_store_attribution__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: play_store_attribution__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: play_store_attribution__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
