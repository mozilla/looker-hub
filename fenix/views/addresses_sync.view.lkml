...
"
  ...
  dimension: metrics__labeled_string__addresses_sync_failure_reason {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/fenix/metrics/addresses_sync_failure_reason"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  sql_table_name: `mozdata.org_mozilla_firefox_beta.addresses_sync` ;;
}
...
view: suggest__addresses_sync__metrics__labeled_counter__addresses_sync_incoming {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.org_mozilla_firefox_beta.addresses_sync as t,
