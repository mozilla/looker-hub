...
view: referrals {
  dimension: metrics__string__referrals_code {
    ...
    link: {
      label: "Glean Dictionary reference for Referrals: Code"
      url: "https://dictionary.telemetry.mozilla.org/apps/fenix/metrics/referrals_code"
...
"
  ...
  sql_table_name: `mozdata.fenix.referrals` ;;
}
