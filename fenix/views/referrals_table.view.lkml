...
"
  ...
  dimension: metrics__string__referrals_code {
    sql: ${TABLE}.metrics.string.referrals_code ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Referrals Code"
  }
...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.referrals"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.referrals"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.referrals"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.referrals"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.referrals"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.referrals"
    }
  }
...
view: referrals_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: referrals_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: referrals_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: referrals_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
