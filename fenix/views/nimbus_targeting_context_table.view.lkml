...
"
  ...
  parameter: channel {
    ...
    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.nimbus_targeting_context"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.nimbus_targeting_context"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.nimbus_targeting_context"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.nimbus_targeting_context"
    }
  }
