...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.temp_fog_initial_state"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.temp_fog_initial_state"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.temp_fog_initial_state"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.temp_fog_initial_state"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.temp_fog_initial_state"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.temp_fog_initial_state"
    }
  }
