...
view: fx_accounts {
  dimension: metrics__string__metrics_client_association {
    ...
    type: string
    group_label: "Metrics"
    group_item_label: "Client Association"

    link: {
      label: "Glean Dictionary reference for Metrics Client Association"
      url: "https://dictionary.telemetry.mozilla.org/apps/fenix/metrics/metrics_client_association"
...
"
  ...
  sql_table_name: `mozdata.fenix.fx_accounts` ;;
}
