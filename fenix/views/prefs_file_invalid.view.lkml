...
view: prefs_file_invalid {
  dimension: metrics__text2__preferences_prefs_file_that_failed_to_parse {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/fenix/metrics/preferences_prefs_file_that_failed_to_parse"
...
"
  ...
  sql_table_name: `mozdata.fenix.prefs_file_invalid` ;;
}
