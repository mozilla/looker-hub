...
view: captcha_detection_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.captcha_detection"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.captcha_detection"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.captcha_detection"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.captcha_detection"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.captcha_detection"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.captcha_detection"
    }
  }
