...
view: fx_suggest_api {
  dimension: metrics__quantity__fx_suggest_query_count {
    label: "Fx Suggest: Query Count"
    hidden: no
    sql: ${TABLE}.metrics.quantity.fx_suggest_query_count ;;
    type: number
    group_label: "Fx Suggest"
    group_item_label: "Query Count"

    link: {
      label: "Glean Dictionary reference for Fx Suggest: Query Count"
      url: "https://dictionary.telemetry.mozilla.org/apps/fenix/metrics/fx_suggest_query_count"
...
"
  ...
  sql_table_name: `mozdata.fenix.fx_suggest_api` ;;
}

view: fx_suggest_api__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error: Invalid Label"

  dimension: document_id {
    type: string
    sql: ${fx_suggest_api.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${fx_suggest_api.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${fx_suggest_api.client_info__client_id} end ;;
    hidden: no
  }
}

view: fx_suggest_api__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error: Invalid Overflow"
...
view: fx_suggest_api__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error: Invalid State"
...
view: fx_suggest_api__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error: Invalid Value"
...
view: fx_suggest_api__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_suggest_api__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_suggest_api__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_suggest_api__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
