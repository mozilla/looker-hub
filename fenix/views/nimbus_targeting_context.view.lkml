...
"
  ...
  sql_table_name: `mozdata.fenix.nimbus_targeting_context` ;;
}
...
view: nimbus_targeting_context__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: nimbus_targeting_context__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
