...
view: deletion_request_table {
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.deletion_request"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.deletion_request"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.deletion_request"
    }
...
view: deletion_request_table__metrics__jwe {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: deletion_request_table__metrics__labeled_rate {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: deletion_request_table__metrics__labeled_rate__value {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: deletion_request_table__metrics__text {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
...
view: deletion_request_table__metrics__url {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
