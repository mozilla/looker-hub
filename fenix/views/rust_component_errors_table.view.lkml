...
view: rust_component_errors_table {
...
"
  ...
  dimension: metrics__string__rust_component_errors_details {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Rust Component Errors Details"
  }
  ...
  dimension: metrics__string__rust_component_errors_error_type {
    ...
    suggest_persist_for: "24 hours"
    group_label: "Metrics: String"
    group_item_label: "Rust Component Errors Error Type"
  }
...
"
  ...
  parameter: channel {
    type: unquoted
    default_value: "mozdata.fenix.rust_component_errors"

    allowed_value: {
      label: "Release"
      value: "mozdata.fenix.rust_component_errors"
    }

    allowed_value: {
      label: "Beta"
      value: "mozdata.org_mozilla_firefox_beta.rust_component_errors"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix.rust_component_errors"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fenix_nightly.rust_component_errors"
    }

    allowed_value: {
      label: "Nightly"
      value: "mozdata.org_mozilla_fennec_aurora.rust_component_errors"
    }
  }
...
view: rust_component_errors_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: rust_component_errors_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: rust_component_errors_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: rust_component_errors_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: rust_component_errors_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
