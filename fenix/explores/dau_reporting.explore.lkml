...
explore: dau_reporting {
  ...
  join: dau_reporting__metrics__labeled_counter__metrics_search_count {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${dau_reporting.metrics__labeled_counter__metrics_search_count}) AS dau_reporting__metrics__labeled_counter__metrics_search_count ON ${dau_reporting.document_id} = ${dau_reporting__metrics__labeled_counter__metrics_search_count.document_id} ;;
  }
