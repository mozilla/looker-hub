...
view: deletion_request {
  dimension: metrics__uuid__legacy_ids_client_id {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/focus_ios/metrics/legacy_ids_client_id"
...
"
  ...
  sql_table_name: `mozdata.org_mozilla_ios_focus.deletion_request` ;;
}
...
view: suggest__deletion_request__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    ...
    m.key,
    count(*) as n
from mozdata.org_mozilla_ios_focus.deletion_request as t,
