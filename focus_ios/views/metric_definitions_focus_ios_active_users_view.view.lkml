...
view: metric_definitions_focus_ios_active_users_view {
  derived_table: {
    sql: SELECT
...
looker_base_fields.user_agent.version AS looker_base_fields_user_agent__version,
    ...
    WHERE is_mobile
            ...
            ) AS focus_ios_active_users_view
        JOIN
    (
            SELECT
                *
  ...
  FROM
    ...
    ON 
    focus_ios_active_users_view.client_id =
        looker_base_fields.client_id AND
        focus_ios_active_users_view.submission_date =
