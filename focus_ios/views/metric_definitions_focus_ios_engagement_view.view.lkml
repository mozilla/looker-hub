...
view: metric_definitions_focus_ios_engagement_view {
  derived_table: {
    sql: SELECT
...
focus_ios_engagement_view_app_name,
focus_ios_engagement_view_app_version,
focus_ios_engagement_view_country,
...
focus_ios_engagement_view.app_name AS focus_ios_engagement_view_app_name,
focus_ios_engagement_view.app_version AS focus_ios_engagement_view_app_version,
focus_ios_engagement_view.country AS focus_ios_engagement_view_country,
...
focus_ios_engagement_view_wau,
  ...
  dimension: engagement_rate_v1 {
    group_label: "Metrics"
    label: "Focus iOS Engagement Rate"
...
"
  ...
  dimension: app_name {
    sql: ${TABLE}.focus_ios_engagement_view_app_name ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: app_version {
    sql: ${TABLE}.focus_ios_engagement_view_app_version ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: country {
    sql: ${TABLE}.focus_ios_engagement_view_country ;;
    type: string
    suggest_persist_for: "24 hours"
  ...
  dimension: dau {
    sql: ${TABLE}.focus_ios_engagement_view_dau ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: device_manufacturer {
    sql: ${TABLE}.focus_ios_engagement_view_device_manufacturer ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: device_type {
    sql: ${TABLE}.focus_ios_engagement_view_device_type ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: is_mobile {
    sql: ${TABLE}.focus_ios_engagement_view_is_mobile ;;
    type: yesno
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: lifecycle_stage {
    sql: ${TABLE}.focus_ios_engagement_view_lifecycle_stage ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: locale {
    sql: ${TABLE}.focus_ios_engagement_view_locale ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: mau {
    sql: ${TABLE}.focus_ios_engagement_view_mau ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: paid_vs_organic {
    sql: ${TABLE}.focus_ios_engagement_view_paid_vs_organic ;;
    type: string
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
  ...
  dimension: wau {
    sql: ${TABLE}.focus_ios_engagement_view_wau ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Base Fields"
  }
