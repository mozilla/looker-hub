...
"
  ...
  sql_table_name: `mozdata.org_mozilla_ios_focus.usage_reporting` ;;
}

view: suggest__usage_reporting__metrics__labeled_counter__glean_error_invalid_label {
  derived_table: {
    sql: select
    m.key,
    count(*) as n
from mozdata.org_mozilla_ios_focus.usage_reporting as t,
...
view: usage_reporting__metrics__labeled_counter__glean_error_invalid_label {
  ...
  dimension: document_id {
    type: string
    sql: ${usage_reporting.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${usage_reporting.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  dimension: label {
    type: string
    sql: ${TABLE}.key ;;
    suggest_explore: suggest__usage_reporting__metrics__labeled_counter__glean_error_invalid_label
    suggest_dimension: suggest__usage_reporting__metrics__labeled_counter__glean_error_invalid_label.key
    hidden: no
  }
...
view: usage_reporting__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
  }
