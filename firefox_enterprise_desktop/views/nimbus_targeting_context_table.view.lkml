...
view: nimbus_targeting_context_table {
  ...
  dimension: metrics__boolean__nimbus_targeting_context_launch_on_login_allowed_by_policy {
    sql: ${TABLE}.metrics.boolean.nimbus_targeting_context_launch_on_login_allowed_by_policy ;;
    type: yesno
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Boolean"
    group_item_label: "Nimbus Targeting Context Launch On Login Allowed By Policy"
  }

  dimension: metrics__boolean__nimbus_targeting_context_launch_on_login_enabled {
    sql: ${TABLE}.metrics.boolean.nimbus_targeting_context_launch_on_login_enabled ;;
    type: yesno
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Boolean"
    group_item_label: "Nimbus Targeting Context Launch On Login Enabled"
  }
...
"
  ...
  dimension: metrics__object__nimbus_targeting_context_active_experiments {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_active_experiments ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_context_active_rollouts {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_active_rollouts ;;
    hidden: yes
  }
  ...
  dimension: metrics__object__nimbus_targeting_context_browser_settings {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_browser_settings ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_context_default_pdf_handler {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_default_pdf_handler ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_context_enrollments_map {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_enrollments_map ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_context_home_page_settings {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_home_page_settings ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_context_is_default_handler {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_is_default_handler ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_context_os {
    sql: ${TABLE}.metrics.object.nimbus_targeting_context_os ;;
    hidden: yes
  }
  ...
  dimension: metrics__object__nimbus_targeting_environment_pref_values {
    sql: ${TABLE}.metrics.object.nimbus_targeting_environment_pref_values ;;
    hidden: yes
  }

  dimension: metrics__object__nimbus_targeting_environment_user_set_prefs {
    sql: ${TABLE}.metrics.object.nimbus_targeting_environment_user_set_prefs ;;
    hidden: yes
  }
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.nimbus_targeting_context` ;;
}

view: nimbus_targeting_context_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: nimbus_targeting_context_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: nimbus_targeting_context_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: nimbus_targeting_context_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: nimbus_targeting_context_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
