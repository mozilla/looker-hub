...
view: serp_categorization {
  dimension: metrics__counter__serp_categorization_no_map_found {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/serp_categorization_no_map_found"
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.serp_categorization` ;;
}
