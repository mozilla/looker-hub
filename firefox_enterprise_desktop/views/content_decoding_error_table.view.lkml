...
view: content_decoding_error_table {
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.content_decoding_error` ;;
}

view: content_decoding_error_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: content_decoding_error_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
