...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.temp_fog_initial_state` ;;
}
...
view: temp_fog_initial_state__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: temp_fog_initial_state__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
