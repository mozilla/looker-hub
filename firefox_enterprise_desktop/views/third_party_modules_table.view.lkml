...
view: third_party_modules_table {
...
"
  ...
  dimension: metrics__object__third_party_modules_modules {
    sql: ${TABLE}.metrics.object.third_party_modules_modules ;;
    hidden: yes
  }

  dimension: metrics__object__third_party_modules_processes {
    sql: ${TABLE}.metrics.object.third_party_modules_processes ;;
    hidden: yes
  }
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.third_party_modules` ;;
}

view: third_party_modules_table__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: third_party_modules_table__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: third_party_modules_table__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: third_party_modules_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: third_party_modules_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
