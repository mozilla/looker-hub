...
view: newtab_content {
  dimension: metrics__string__newtab_content_coarse_os {
    label: "Newtab Content: Coarse OS"
    hidden: no
    sql: ${TABLE}.metrics.string.newtab_content_coarse_os ;;
    type: string
    group_label: "Newtab Content"
    group_item_label: "Coarse OS"

    link: {
      label: "Glean Dictionary reference for Newtab Content: Coarse OS"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/newtab_content_coarse_os"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "The name of the operating system. Possible values: Android, iOS, Linux, Windows, or macOS
"
  }
  ...
  dimension: metrics__string__newtab_content_country {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/newtab_content_country"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__string__newtab_content_experiment_branch {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/newtab_content_experiment_branch"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__string__newtab_content_experiment_name {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/newtab_content_experiment_name"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__newtab_content_ping_version {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/newtab_content_ping_version"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__newtab_content_utc_offset {
    label: "Newtab Content: Utc Offset"
    hidden: no
    ...
    link: {
      label: "Glean Dictionary reference for Newtab Content: Utc Offset"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/newtab_content_utc_offset"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.newtab_content` ;;
}

view: newtab_content__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error: Invalid Label"

  dimension: document_id {
    type: string
    sql: ${newtab_content.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${newtab_content.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
...
view: newtab_content__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error: Invalid Overflow"
...
view: newtab_content__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error: Invalid State"
...
view: newtab_content__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error: Invalid Value"
...
view: newtab_content__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
