...
view: use_counters_table {
  ...
  dimension: metrics__counter__use_counter_css_doc_css_moz_image_decoding {
    sql: ${TABLE}.metrics.counter.use_counter_css_doc_css_moz_image_decoding ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Use Counter Css Doc Css Moz Image Decoding"
  }
  ...
  dimension: metrics__counter__use_counter_css_page_css_moz_image_decoding {
    sql: ${TABLE}.metrics.counter.use_counter_css_page_css_moz_image_decoding ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Use Counter Css Page Css Moz Image Decoding"
  }
  ...
  dimension: metrics__counter__use_counter_deprecated_ops_doc_ckeditor4_compat_hack {
    sql: ${TABLE}.metrics.counter.use_counter_deprecated_ops_doc_ckeditor4_compat_hack ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Use Counter Deprecated Ops Doc Ckeditor4 Compat Hack"
  }
  ...
  dimension: metrics__counter__use_counter_deprecated_ops_doc_gwtrich_text_area_compat_hack {
    sql: ${TABLE}.metrics.counter.use_counter_deprecated_ops_doc_gwtrich_text_area_compat_hack ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Use Counter Deprecated Ops Doc Gwtrich Text Area Compat Hack"
  }
  ...
  dimension: metrics__counter__use_counter_deprecated_ops_page_ckeditor4_compat_hack {
    sql: ${TABLE}.metrics.counter.use_counter_deprecated_ops_page_ckeditor4_compat_hack ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Use Counter Deprecated Ops Page Ckeditor4 Compat Hack"
  }
  ...
  dimension: metrics__counter__use_counter_deprecated_ops_page_gwtrich_text_area_compat_hack {
    sql: ${TABLE}.metrics.counter.use_counter_deprecated_ops_page_gwtrich_text_area_compat_hack ;;
    type: number
    suggest_persist_for: "24 hours"
    group_label: "Metrics: Counter"
    group_item_label: "Use Counter Deprecated Ops Page Gwtrich Text Area Compat Hack"
  }
...
"
  ...
  dimension: metrics__labeled_counter__use_counter_error_unknown_counter {
    ...
    hidden: yes
    description: "How many times did we try to increment a use counter we couldn't find? Labeled by what kind of use counter it is.
"
  }
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.use_counters` ;;
}
...
view: use_counters_table__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: use_counters_table__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
