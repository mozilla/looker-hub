...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.enterprise` ;;
}

view: enterprise__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error: Invalid Label"

  dimension: document_id {
    type: string
    sql: ${enterprise.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${enterprise.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${enterprise.client_info__client_id} end ;;
    hidden: no
  }
}

view: enterprise__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error: Invalid Overflow"
...
view: enterprise__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error: Invalid State"
...
view: enterprise__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error: Invalid Value"
...
view: enterprise__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: enterprise__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: enterprise__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: enterprise__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
