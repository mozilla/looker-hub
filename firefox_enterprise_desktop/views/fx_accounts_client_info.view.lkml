...
view: fx_accounts_client_info {
  dimension: metrics__labeled_counter__browser_is_user_default {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/browser_is_user_default"
...
"
  ...
  dimension: metrics__string__client_association_uid {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/client_association_uid"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.fx_accounts_client_info` ;;
}

view: fx_accounts_client_info__metrics__labeled_counter__browser_is_user_default {
  label: "Browser: Is User Default"

  dimension: document_id {
    type: string
    sql: ${fx_accounts_client_info.document_id} ;;
    hidden: yes
  }

  dimension: document_label_id {
    type: string
    sql: ${fx_accounts_client_info.document_id}-${label} ;;
    primary_key: yes
    hidden: yes
  }
  ...
  measure: client_count {
    type: count_distinct
    sql: case when ${value} > 0 then ${fx_accounts_client_info.client_info__client_id} end ;;
    hidden: no
  }
}

view: fx_accounts_client_info__metrics__labeled_counter__glean_error_invalid_label {
  label: "Glean Error: Invalid Label"
...
view: fx_accounts_client_info__metrics__labeled_counter__glean_error_invalid_overflow {
  label: "Glean Error: Invalid Overflow"
...
view: fx_accounts_client_info__metrics__labeled_counter__glean_error_invalid_state {
  label: "Glean Error: Invalid State"
...
view: fx_accounts_client_info__metrics__labeled_counter__glean_error_invalid_value {
  label: "Glean Error: Invalid Value"
...
view: fx_accounts_client_info__events {
  dimension: category {
    sql: ${TABLE}.category ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_client_info__events__extra {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_client_info__ping_info__experiments {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_client_info__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: fx_accounts_client_info__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
