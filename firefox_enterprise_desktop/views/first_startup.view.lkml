...
view: first_startup {
  dimension: metrics__quantity__first_startup_category_tasks_time {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_category_tasks_time"
...
"
  ...
  dimension: metrics__quantity__first_startup_delete_tasks_time {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_delete_tasks_time"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__first_startup_elapsed {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_elapsed"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__boolean__first_startup_new_profile {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_new_profile"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__first_startup_nimbus_init_time {
    label: "First Startup: Nimbus Init Time"
    hidden: no
    sql: ${TABLE}.metrics.quantity.first_startup_nimbus_init_time ;;
    type: number
    group_label: "First Startup"
    group_item_label: "Nimbus Init Time"

    link: {
      label: "Glean Dictionary reference for First Startup: Nimbus Init Time"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_nimbus_init_time"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "Number of milliseconds until Nimbus is fully initialized.
"
  }

  dimension: metrics__quantity__first_startup_nimbus_loader_init_time {
    label: "First Startup: Nimbus Loader Init Time"
    hidden: no
    sql: ${TABLE}.metrics.quantity.first_startup_nimbus_loader_init_time ;;
    type: number
    group_label: "First Startup"
    group_item_label: "Nimbus Loader Init Time"

    link: {
      label: "Glean Dictionary reference for First Startup: Nimbus Loader Init Time"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_nimbus_loader_init_time"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "Number of milliseconds until the Nimbus RemoteSettingsExperimentLoader is initialized (including the AFTER_REMOTE_SETTINGS_UPDATE migration phase).
"
  }

  dimension: metrics__quantity__first_startup_nimbus_manager_init_time {
    label: "First Startup: Nimbus Manager Init Time"
    hidden: no
    sql: ${TABLE}.metrics.quantity.first_startup_nimbus_manager_init_time ;;
    type: number
    group_label: "First Startup"
    group_item_label: "Nimbus Manager Init Time"

    link: {
      label: "Glean Dictionary reference for First Startup: Nimbus Manager Init Time"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_nimbus_manager_init_time"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "Number of milliseconds until the Nimbus ExperimentManager is initialized.
"
  }

  dimension: metrics__quantity__first_startup_nimbus_store_init_time {
    label: "First Startup: Nimbus Store Init Time"
    hidden: no
    sql: ${TABLE}.metrics.quantity.first_startup_nimbus_store_init_time ;;
    type: number
    group_label: "First Startup"
    group_item_label: "Nimbus Store Init Time"

    link: {
      label: "Glean Dictionary reference for First Startup: Nimbus Store Init Time"
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_nimbus_store_init_time"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }

    description: "Number of milliseconds until the Nimbus ExperimentStore is initialized.
"
  }
  ...
  dimension: metrics__quantity__first_startup_normandy_init_time {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_normandy_init_time"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  dimension: metrics__quantity__first_startup_status_code {
    ...
    link: {
      ...
      url: "https://dictionary.telemetry.mozilla.org/apps/firefox_enterprise_desktop/metrics/first_startup_status_code"
      icon_url: "https://dictionary.telemetry.mozilla.org/favicon.png"
    }
...
"
  ...
  sql_table_name: `mozdata.firefox_enterprise_desktop.first_startup` ;;
}
...
view: first_startup__ping_info__server_knobs_config__metrics_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
...
view: first_startup__ping_info__server_knobs_config__pings_enabled {
  dimension: key {
    sql: ${TABLE}.key ;;
    type: string
    suggest_persist_for: "24 hours"
