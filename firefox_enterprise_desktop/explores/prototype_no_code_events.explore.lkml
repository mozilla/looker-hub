...
include: "/looker-hub/firefox_enterprise_desktop/views/prototype_no_code_events.view.lkml"
include: "/looker-hub/firefox_enterprise_desktop/datagroups/prototype_no_code_events_last_updated.datagroup.lkml"
...
explore: prototype_no_code_events {
  ...
  join: prototype_no_code_events__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${prototype_no_code_events.ping_info__server_knobs_config__metrics_enabled}) AS prototype_no_code_events__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: prototype_no_code_events__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${prototype_no_code_events.ping_info__server_knobs_config__pings_enabled}) AS prototype_no_code_events__ping_info__server_knobs_config__pings_enabled ;;
  }
