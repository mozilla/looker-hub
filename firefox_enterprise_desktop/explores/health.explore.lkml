...
include: "/looker-hub/firefox_enterprise_desktop/views/health.view.lkml"
include: "/looker-hub/firefox_enterprise_desktop/datagroups/health_last_updated.datagroup.lkml"
...
explore: health {
  ...
  join: health__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${health.ping_info__server_knobs_config__metrics_enabled}) AS health__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: health__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${health.ping_info__server_knobs_config__pings_enabled}) AS health__ping_info__server_knobs_config__pings_enabled ;;
  }
