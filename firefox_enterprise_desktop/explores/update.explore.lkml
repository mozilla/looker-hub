...
include: "/looker-hub/firefox_enterprise_desktop/views/update.view.lkml"
include: "/looker-hub/firefox_enterprise_desktop/datagroups/update_last_updated.datagroup.lkml"
...
explore: update {
  ...
  join: update__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${update.ping_info__server_knobs_config__metrics_enabled}) AS update__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: update__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${update.ping_info__server_knobs_config__pings_enabled}) AS update__ping_info__server_knobs_config__pings_enabled ;;
  }
