...
include: "/looker-hub/firefox_enterprise_desktop/views/third_party_modules.view.lkml"
include: "/looker-hub/firefox_enterprise_desktop/datagroups/third_party_modules_last_updated.datagroup.lkml"
...
explore: third_party_modules {
  ...
  join: third_party_modules__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${third_party_modules.ping_info__server_knobs_config__metrics_enabled}) AS third_party_modules__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: third_party_modules__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${third_party_modules.ping_info__server_knobs_config__pings_enabled}) AS third_party_modules__ping_info__server_knobs_config__pings_enabled ;;
  }
