...
include: "/looker-hub/firefox_enterprise_desktop/views/profiles.view.lkml"
include: "/looker-hub/firefox_enterprise_desktop/datagroups/profiles_last_updated.datagroup.lkml"
...
explore: profiles {
  ...
  join: profiles__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${profiles.ping_info__server_knobs_config__metrics_enabled}) AS profiles__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: profiles__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${profiles.ping_info__server_knobs_config__pings_enabled}) AS profiles__ping_info__server_knobs_config__pings_enabled ;;
  }
