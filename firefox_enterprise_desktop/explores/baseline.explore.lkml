...
include: "/looker-hub/firefox_enterprise_desktop/views/baseline.view.lkml"
include: "/looker-hub/firefox_enterprise_desktop/datagroups/baseline_last_updated.datagroup.lkml"
...
explore: baseline {
  ...
  join: baseline__ping_info__server_knobs_config__metrics_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.ping_info__server_knobs_config__metrics_enabled}) AS baseline__ping_info__server_knobs_config__metrics_enabled ;;
  }

  join: baseline__ping_info__server_knobs_config__pings_enabled {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${baseline.ping_info__server_knobs_config__pings_enabled}) AS baseline__ping_info__server_knobs_config__pings_enabled ;;
  }
