...
view: usage_table {
  ...
  dimension: metrics__boolean__mach_system_ssh_connection {
    ...
    type: yesno
    group_label: "Metrics Boolean"
    group_item_label: "Mach System Ssh Connection"
  ...
  dimension: metrics__boolean__mach_system_vscode_running {
    ...
    type: yesno
    group_label: "Metrics Boolean"
    group_item_label: "Mach System Vscode Running"
  ...
  dimension: metrics__boolean__mach_system_vscode_terminal {
    ...
    type: yesno
    group_label: "Metrics Boolean"
    group_item_label: "Mach System Vscode Terminal"
...
"
  ...
  dimension: metrics__memory_distribution__mach_system_memory__count {
    sql: ${TABLE}.metrics.memory_distribution.mach_system_memory.count ;;
    type: number
