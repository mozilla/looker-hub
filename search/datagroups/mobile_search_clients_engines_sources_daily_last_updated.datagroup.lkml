...
datagroup: mobile_search_clients_engines_sources_daily_last_updated {
  ...
  sql_trigger: SELECT MAX(storage_last_modified_time)
    ...
    WHERE (table_schema = 'search_derived' AND table_name = 'mobile_search_clients_daily_historical_pre202408') OR (table_schema = 'search_derived' AND table_name = 'mobile_search_clients_daily_v2') ;;
